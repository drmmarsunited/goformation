...
type AppBlockBuilder[T any] struct {
	...
	AccessEndpoints []AppBlockBuilder_AccessEndpoint[any] `json:"AccessEndpoints,omitempty"`
	...
	AppBlockArns []T `json:"AppBlockArns,omitempty"`
	...
	VpcConfig *AppBlockBuilder_VpcConfig[any] `json:"VpcConfig"`
...
func (r *AppBlockBuilder[any]) AWSCloudFormationType() string {
	return "AWS::AppStream::AppBlockBuilder"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AppBlockBuilder[any]) MarshalJSON() ([]byte, error) {
	type Properties AppBlockBuilder[any]
...
func (r *AppBlockBuilder[any]) UnmarshalJSON(b []byte) error {
	type Properties AppBlockBuilder[any]
	...
	if res.Properties != nil {
		*r = AppBlockBuilder[any](*res.Properties)
	}
