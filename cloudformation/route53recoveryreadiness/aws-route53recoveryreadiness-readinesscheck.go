...
type ReadinessCheck[T any] struct {
...
func (r *ReadinessCheck[any]) AWSCloudFormationType() string {
	return "AWS::Route53RecoveryReadiness::ReadinessCheck"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ReadinessCheck[any]) MarshalJSON() ([]byte, error) {
	type Properties ReadinessCheck[any]
...
func (r *ReadinessCheck[any]) UnmarshalJSON(b []byte) error {
	type Properties ReadinessCheck[any]
	...
	if res.Properties != nil {
		*r = ReadinessCheck[any](*res.Properties)
	}
