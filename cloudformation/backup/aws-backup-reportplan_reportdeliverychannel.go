...
type ReportPlan_ReportDeliveryChannel[T any] struct {
	...
	Formats []T `json:"Formats,omitempty"`
...
func (r *ReportPlan_ReportDeliveryChannel[any]) AWSCloudFormationType() string {
