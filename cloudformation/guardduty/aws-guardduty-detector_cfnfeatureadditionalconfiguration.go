...
// Detector_CFNFeatureAdditionalConfiguration AWS CloudFormation Resource (AWS::GuardDuty::Detector.CFNFeatureAdditionalConfiguration)
...
type Detector_CFNFeatureAdditionalConfiguration[T any] struct {
...
func (r *Detector_CFNFeatureAdditionalConfiguration[any]) AWSCloudFormationType() string {
	return "AWS::GuardDuty::Detector.CFNFeatureAdditionalConfiguration"
}
