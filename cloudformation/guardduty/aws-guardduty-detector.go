...
type Detector[T any] struct {
	...
	Features []Detector_CFNFeatureConfiguration[any] `json:"Features,omitempty"`
	...
	FindingPublishingFrequency *T `json:"FindingPublishingFrequency,omitempty"`
	...
	Tags []Detector_TagItem[any] `json:"Tags,omitempty"`
