...
type ScheduledQuery_S3Configuration[T any] struct {
	...
	EncryptionOption *T `json:"EncryptionOption,omitempty"`
...
func (r *ScheduledQuery_S3Configuration[any]) AWSCloudFormationType() string {
