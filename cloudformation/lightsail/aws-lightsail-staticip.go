...
type StaticIp[T any] struct {
	...
	StaticIpName T `json:"StaticIpName"`
...
func (r *StaticIp[any]) AWSCloudFormationType() string {
	return "AWS::Lightsail::StaticIp"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r StaticIp[any]) MarshalJSON() ([]byte, error) {
	type Properties StaticIp[any]
...
func (r *StaticIp[any]) UnmarshalJSON(b []byte) error {
	type Properties StaticIp[any]
