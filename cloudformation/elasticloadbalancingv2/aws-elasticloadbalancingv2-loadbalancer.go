...
type LoadBalancer[T any] struct {
	...
	LoadBalancerAttributes []LoadBalancer_LoadBalancerAttribute[any] `json:"LoadBalancerAttributes,omitempty"`
	...
	SubnetMappings []LoadBalancer_SubnetMapping[any] `json:"SubnetMappings,omitempty"`
