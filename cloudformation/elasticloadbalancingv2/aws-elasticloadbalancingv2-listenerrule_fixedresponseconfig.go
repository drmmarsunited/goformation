...
type ListenerRule_FixedResponseConfig[T any] struct {
	...
	MessageBody *T `json:"MessageBody,omitempty"`
...
func (r *ListenerRule_FixedResponseConfig[any]) AWSCloudFormationType() string {
