...
type ConfiguredTable_ConfiguredTableAnalysisRulePolicy[T any] struct {
	...
	V1 *ConfiguredTable_ConfiguredTableAnalysisRulePolicyV1[any] `json:"V1"`
...
func (r *ConfiguredTable_ConfiguredTableAnalysisRulePolicy[any]) AWSCloudFormationType() string {
