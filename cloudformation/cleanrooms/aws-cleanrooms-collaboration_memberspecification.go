...
type Collaboration_MemberSpecification[T any] struct {
	...
	MemberAbilities []T `json:"MemberAbilities"`
...
func (r *Collaboration_MemberSpecification[any]) AWSCloudFormationType() string {
