...
type Membership[T any] struct {
	...
	DefaultResultConfiguration *Membership_MembershipProtectedQueryResultConfiguration[any] `json:"DefaultResultConfiguration,omitempty"`
...
func (r *Membership[any]) AWSCloudFormationType() string {
	return "AWS::CleanRooms::Membership"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Membership[any]) MarshalJSON() ([]byte, error) {
	type Properties Membership[any]
...
func (r *Membership[any]) UnmarshalJSON(b []byte) error {
	type Properties Membership[any]
	...
	if res.Properties != nil {
		*r = Membership[any](*res.Properties)
	}
