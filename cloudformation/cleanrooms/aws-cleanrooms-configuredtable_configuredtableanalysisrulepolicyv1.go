...
type ConfiguredTable_ConfiguredTableAnalysisRulePolicyV1[T any] struct {
	...
	Aggregation *ConfiguredTable_AnalysisRuleAggregation[any] `json:"Aggregation,omitempty"`
	...
	Custom *ConfiguredTable_AnalysisRuleCustom[any] `json:"Custom,omitempty"`
	...
	List *ConfiguredTable_AnalysisRuleList[any] `json:"List,omitempty"`
...
func (r *ConfiguredTable_ConfiguredTableAnalysisRulePolicyV1[any]) AWSCloudFormationType() string {
