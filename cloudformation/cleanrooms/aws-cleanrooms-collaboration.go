...
type Collaboration[T any] struct {
	...
	DataEncryptionMetadata *Collaboration_DataEncryptionMetadata[any] `json:"DataEncryptionMetadata,omitempty"`
	...
	Members []Collaboration_MemberSpecification[any] `json:"Members"`
...
func (r *Collaboration[any]) AWSCloudFormationType() string {
	return "AWS::CleanRooms::Collaboration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Collaboration[any]) MarshalJSON() ([]byte, error) {
	type Properties Collaboration[any]
...
func (r *Collaboration[any]) UnmarshalJSON(b []byte) error {
	type Properties Collaboration[any]
	...
	if res.Properties != nil {
		*r = Collaboration[any](*res.Properties)
	}
