...
// ConfiguredTableAssociation AWS CloudFormation Resource (AWS::CleanRooms::ConfiguredTableAssociation)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cleanrooms-configuredtableassociation.html
type ConfiguredTableAssociation[T any] struct {
	...
	ConfiguredTableIdentifier T `json:"ConfiguredTableIdentifier"`
...
func (r *ConfiguredTableAssociation[any]) AWSCloudFormationType() string {
	return "AWS::CleanRooms::ConfiguredTableAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ConfiguredTableAssociation[any]) MarshalJSON() ([]byte, error) {
	type Properties ConfiguredTableAssociation[any]
...
func (r *ConfiguredTableAssociation[any]) UnmarshalJSON(b []byte) error {
	type Properties ConfiguredTableAssociation[any]
	...
	if res.Properties != nil {
		*r = ConfiguredTableAssociation[any](*res.Properties)
	}
