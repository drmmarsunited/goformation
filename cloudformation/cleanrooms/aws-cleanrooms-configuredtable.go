...
type ConfiguredTable[T any] struct {
	...
	AnalysisRules []ConfiguredTable_AnalysisRule[any] `json:"AnalysisRules,omitempty"`
	...
	TableReference *ConfiguredTable_TableReference[any] `json:"TableReference"`
...
func (r *ConfiguredTable[any]) AWSCloudFormationType() string {
	return "AWS::CleanRooms::ConfiguredTable"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ConfiguredTable[any]) MarshalJSON() ([]byte, error) {
	type Properties ConfiguredTable[any]
...
func (r *ConfiguredTable[any]) UnmarshalJSON(b []byte) error {
	type Properties ConfiguredTable[any]
	...
	if res.Properties != nil {
		*r = ConfiguredTable[any](*res.Properties)
	}
