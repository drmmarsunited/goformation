...
type AnalysisTemplate[T any] struct {
	...
	AnalysisParameters []AnalysisTemplate_AnalysisParameter[any] `json:"AnalysisParameters,omitempty"`
	...
	Source *AnalysisTemplate_AnalysisSource[any] `json:"Source"`
...
func (r *AnalysisTemplate[any]) AWSCloudFormationType() string {
	return "AWS::CleanRooms::AnalysisTemplate"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AnalysisTemplate[any]) MarshalJSON() ([]byte, error) {
	type Properties AnalysisTemplate[any]
...
func (r *AnalysisTemplate[any]) UnmarshalJSON(b []byte) error {
	type Properties AnalysisTemplate[any]
	...
	if res.Properties != nil {
		*r = AnalysisTemplate[any](*res.Properties)
	}
