...
type Membership_MembershipProtectedQueryResultConfiguration[T any] struct {
	...
	OutputConfiguration *Membership_MembershipProtectedQueryOutputConfiguration[any] `json:"OutputConfiguration"`
...
func (r *Membership_MembershipProtectedQueryResultConfiguration[any]) AWSCloudFormationType() string {
