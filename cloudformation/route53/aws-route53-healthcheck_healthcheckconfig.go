...
type HealthCheck_HealthCheckConfig[T any] struct {
	...
	AlarmIdentifier *HealthCheck_AlarmIdentifier[any] `json:"AlarmIdentifier,omitempty"`
	...
	EnableSNI *T `json:"EnableSNI,omitempty"`
	...
	HealthThreshold *T `json:"HealthThreshold,omitempty"`
	...
	Inverted *T `json:"Inverted,omitempty"`
	...
	MeasureLatency *T `json:"MeasureLatency,omitempty"`
	...
	RequestInterval *T `json:"RequestInterval,omitempty"`
...
func (r *HealthCheck_HealthCheckConfig[any]) AWSCloudFormationType() string {
