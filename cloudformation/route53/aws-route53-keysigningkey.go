...
type KeySigningKey[T any] struct {
	...
	KeyManagementServiceArn T `json:"KeyManagementServiceArn"`
...
func (r *KeySigningKey[any]) AWSCloudFormationType() string {
	return "AWS::Route53::KeySigningKey"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r KeySigningKey[any]) MarshalJSON() ([]byte, error) {
	type Properties KeySigningKey[any]
...
func (r *KeySigningKey[any]) UnmarshalJSON(b []byte) error {
	type Properties KeySigningKey[any]
	...
	if res.Properties != nil {
		*r = KeySigningKey[any](*res.Properties)
	}
