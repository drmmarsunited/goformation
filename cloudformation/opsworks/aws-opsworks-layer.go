...
type Layer[T any] struct {
	...
	CustomInstanceProfileArn *T `json:"CustomInstanceProfileArn,omitempty"`
	...
	CustomSecurityGroupIds []T `json:"CustomSecurityGroupIds,omitempty"`
	...
	Packages []T `json:"Packages,omitempty"`
