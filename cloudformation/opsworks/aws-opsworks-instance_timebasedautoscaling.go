...
type Instance_TimeBasedAutoScaling[T any] struct {
	...
	Friday map[string]T `json:"Friday,omitempty"`
	...
	Monday map[string]T `json:"Monday,omitempty"`
	...
	Saturday map[string]T `json:"Saturday,omitempty"`
	...
	Sunday map[string]T `json:"Sunday,omitempty"`
	...
	Thursday map[string]T `json:"Thursday,omitempty"`
	...
	Tuesday map[string]T `json:"Tuesday,omitempty"`
	...
	Wednesday map[string]T `json:"Wednesday,omitempty"`
