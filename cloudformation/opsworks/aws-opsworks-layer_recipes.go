...
type Layer_Recipes[T any] struct {
	...
	Configure []T `json:"Configure,omitempty"`
	...
	Deploy []T `json:"Deploy,omitempty"`
	...
	Shutdown []T `json:"Shutdown,omitempty"`
	...
	Undeploy []T `json:"Undeploy,omitempty"`
