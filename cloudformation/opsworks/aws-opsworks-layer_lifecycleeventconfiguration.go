...
type Layer_LifecycleEventConfiguration[T any] struct {
	...
	ShutdownEventConfiguration *Layer_ShutdownEventConfiguration[any] `json:"ShutdownEventConfiguration,omitempty"`
...
func (r *Layer_LifecycleEventConfiguration[any]) AWSCloudFormationType() string {
