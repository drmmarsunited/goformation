...
// Sink AWS CloudFormation Resource (AWS::Oam::Sink)
...
func (r *Sink[any]) AWSCloudFormationType() string {
	return "AWS::Oam::Sink"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Sink[any]) MarshalJSON() ([]byte, error) {
	type Properties Sink[any]
...
func (r *Sink[any]) UnmarshalJSON(b []byte) error {
	type Properties Sink[any]
