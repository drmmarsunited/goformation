...
func (r *Sink) AWSCloudFormationType() string {
	return "AWS::Oam::Sink"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Sink) MarshalJSON() ([]byte, error) {
	type Properties Sink
...
func (r *Sink) UnmarshalJSON(b []byte) error {
	type Properties Sink
	res := &struct {
		Type                string
		Properties          *Properties
