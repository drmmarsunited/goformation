...
type NamedQuery[T any] struct {
	...
	WorkGroup *T `json:"WorkGroup,omitempty"`
...
func (r *NamedQuery[any]) AWSCloudFormationType() string {
	return "AWS::Athena::NamedQuery"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r NamedQuery[any]) MarshalJSON() ([]byte, error) {
	type Properties NamedQuery[any]
...
func (r *NamedQuery[any]) UnmarshalJSON(b []byte) error {
	type Properties NamedQuery[any]
	...
	if res.Properties != nil {
		*r = NamedQuery[any](*res.Properties)
	}
