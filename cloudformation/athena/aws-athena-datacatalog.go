...
func (r *DataCatalog[any]) AWSCloudFormationType() string {
	return "AWS::Athena::DataCatalog"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DataCatalog[any]) MarshalJSON() ([]byte, error) {
	type Properties DataCatalog[any]
...
func (r *DataCatalog[any]) UnmarshalJSON(b []byte) error {
	type Properties DataCatalog[any]
	...
	if res.Properties != nil {
		*r = DataCatalog[any](*res.Properties)
	}
