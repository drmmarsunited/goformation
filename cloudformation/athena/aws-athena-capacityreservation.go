...
type CapacityReservation[T any] struct {
	...
	CapacityAssignmentConfiguration *CapacityReservation_CapacityAssignmentConfiguration[any] `json:"CapacityAssignmentConfiguration,omitempty"`
