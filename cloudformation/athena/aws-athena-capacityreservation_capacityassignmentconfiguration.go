...
type CapacityReservation_CapacityAssignmentConfiguration[T any] struct {
	...
	CapacityAssignments []CapacityReservation_CapacityAssignment[any] `json:"CapacityAssignments"`
...
func (r *CapacityReservation_CapacityAssignmentConfiguration[any]) AWSCloudFormationType() string {
