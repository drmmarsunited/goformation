...
// CapacityReservation_CapacityAssignment AWS CloudFormation Resource (AWS::Athena::CapacityReservation.CapacityAssignment)
...
type CapacityReservation_CapacityAssignment[T any] struct {
...
func (r *CapacityReservation_CapacityAssignment[any]) AWSCloudFormationType() string {
	return "AWS::Athena::CapacityReservation.CapacityAssignment"
}
