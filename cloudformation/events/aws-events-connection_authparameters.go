...
type Connection_AuthParameters[T any] struct {
	...
	ApiKeyAuthParameters *Connection_ApiKeyAuthParameters[any] `json:"ApiKeyAuthParameters,omitempty"`
	...
	BasicAuthParameters *Connection_BasicAuthParameters[any] `json:"BasicAuthParameters,omitempty"`
	...
	InvocationHttpParameters *Connection_ConnectionHttpParameters[any] `json:"InvocationHttpParameters,omitempty"`
	...
	OAuthParameters *Connection_OAuthParameters[any] `json:"OAuthParameters,omitempty"`
...
func (r *Connection_AuthParameters[any]) AWSCloudFormationType() string {
