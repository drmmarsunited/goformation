...
type Workspace[T any] struct {
	...
	RootVolumeEncryptionEnabled *T `json:"RootVolumeEncryptionEnabled,omitempty"`
	...
	UserVolumeEncryptionEnabled *T `json:"UserVolumeEncryptionEnabled,omitempty"`
	...
	WorkspaceProperties *Workspace_WorkspaceProperties[any] `json:"WorkspaceProperties,omitempty"`
