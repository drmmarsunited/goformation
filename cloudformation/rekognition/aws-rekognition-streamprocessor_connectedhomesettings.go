...
type StreamProcessor_ConnectedHomeSettings[T any] struct {
	...
	MinConfidence *T `json:"MinConfidence,omitempty"`
...
func (r *StreamProcessor_ConnectedHomeSettings[any]) AWSCloudFormationType() string {
