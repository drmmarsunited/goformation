...
type Dataset[T any] struct {
	...
	FormatOptions *Dataset_FormatOptions[any] `json:"FormatOptions,omitempty"`
	...
	Input *Dataset_Input[any] `json:"Input"`
	...
	PathOptions *Dataset_PathOptions[any] `json:"PathOptions,omitempty"`
