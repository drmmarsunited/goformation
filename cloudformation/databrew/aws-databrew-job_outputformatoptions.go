...
type Job_OutputFormatOptions[T any] struct {
	...
	Csv *Job_CsvOutputOptions[any] `json:"Csv,omitempty"`
...
func (r *Job_OutputFormatOptions[any]) AWSCloudFormationType() string {
