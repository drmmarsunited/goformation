...
type Replicator[T any] struct {
	...
	KafkaClusters []Replicator_KafkaCluster[any] `json:"KafkaClusters"`
	...
	ReplicationInfoList []Replicator_ReplicationInfo[any] `json:"ReplicationInfoList"`
	...
	ReplicatorName T `json:"ReplicatorName"`
...
func (r *Replicator[any]) AWSCloudFormationType() string {
	return "AWS::MSK::Replicator"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Replicator[any]) MarshalJSON() ([]byte, error) {
	type Properties Replicator[any]
...
func (r *Replicator[any]) UnmarshalJSON(b []byte) error {
	type Properties Replicator[any]
	...
	if res.Properties != nil {
		*r = Replicator[any](*res.Properties)
	}
