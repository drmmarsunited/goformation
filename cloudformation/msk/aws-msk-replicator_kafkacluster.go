...
type Replicator_KafkaCluster[T any] struct {
	...
	AmazonMskCluster *Replicator_AmazonMskCluster[any] `json:"AmazonMskCluster"`
	...
	VpcConfig *Replicator_KafkaClusterClientVpcConfig[any] `json:"VpcConfig"`
...
func (r *Replicator_KafkaCluster[any]) AWSCloudFormationType() string {
