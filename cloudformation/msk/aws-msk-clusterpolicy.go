...
func (r *ClusterPolicy) AWSCloudFormationType() string {
	return "AWS::MSK::ClusterPolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ClusterPolicy) MarshalJSON() ([]byte, error) {
	type Properties ClusterPolicy
...
func (r *ClusterPolicy) UnmarshalJSON(b []byte) error {
	type Properties ClusterPolicy
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ClusterPolicy(*res.Properties)
	}
