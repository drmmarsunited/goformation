...
func (r *ClusterPolicy[any]) AWSCloudFormationType() string {
	return "AWS::MSK::ClusterPolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ClusterPolicy[any]) MarshalJSON() ([]byte, error) {
	type Properties ClusterPolicy[any]
...
func (r *ClusterPolicy[any]) UnmarshalJSON(b []byte) error {
	type Properties ClusterPolicy[any]
	...
	if res.Properties != nil {
		*r = ClusterPolicy[any](*res.Properties)
	}
