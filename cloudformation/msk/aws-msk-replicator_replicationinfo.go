...
type Replicator_ReplicationInfo[T any] struct {
	...
	ConsumerGroupReplication *Replicator_ConsumerGroupReplication[any] `json:"ConsumerGroupReplication"`
	...
	SourceKafkaClusterArn T `json:"SourceKafkaClusterArn"`
	...
	TargetCompressionType T `json:"TargetCompressionType"`
	...
	TargetKafkaClusterArn T `json:"TargetKafkaClusterArn"`
	...
	TopicReplication *Replicator_TopicReplication[any] `json:"TopicReplication"`
...
func (r *Replicator_ReplicationInfo[any]) AWSCloudFormationType() string {
