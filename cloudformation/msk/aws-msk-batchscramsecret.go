...
func (r *BatchScramSecret) AWSCloudFormationType() string {
	return "AWS::MSK::BatchScramSecret"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r BatchScramSecret) MarshalJSON() ([]byte, error) {
	type Properties BatchScramSecret
...
func (r *BatchScramSecret) UnmarshalJSON(b []byte) error {
	type Properties BatchScramSecret
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = BatchScramSecret(*res.Properties)
	}
