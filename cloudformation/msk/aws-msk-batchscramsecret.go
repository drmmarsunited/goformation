...
// BatchScramSecret AWS CloudFormation Resource (AWS::MSK::BatchScramSecret)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-msk-batchscramsecret.html
type BatchScramSecret[T any] struct {
...
func (r *BatchScramSecret[any]) AWSCloudFormationType() string {
	return "AWS::MSK::BatchScramSecret"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r BatchScramSecret[any]) MarshalJSON() ([]byte, error) {
	type Properties BatchScramSecret[any]
...
func (r *BatchScramSecret[any]) UnmarshalJSON(b []byte) error {
	type Properties BatchScramSecret[any]
	...
	if res.Properties != nil {
		*r = BatchScramSecret[any](*res.Properties)
	}
