...
type Configuration[T any] struct {
	...
	KafkaVersionsList []T `json:"KafkaVersionsList,omitempty"`

	// LatestRevision AWS CloudFormation Property
	// Required: false
	...
	LatestRevision *Configuration_LatestRevision[any] `json:"LatestRevision,omitempty"`
	...
	ServerProperties T `json:"ServerProperties"`
...
func (r *Configuration[any]) AWSCloudFormationType() string {
	return "AWS::MSK::Configuration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Configuration[any]) MarshalJSON() ([]byte, error) {
	type Properties Configuration[any]
...
func (r *Configuration[any]) UnmarshalJSON(b []byte) error {
	type Properties Configuration[any]
	...
	if res.Properties != nil {
		*r = Configuration[any](*res.Properties)
	}
