...
type Cluster_EncryptionInfo[T any] struct {
	...
	EncryptionAtRest *Cluster_EncryptionAtRest[any] `json:"EncryptionAtRest,omitempty"`
	...
	EncryptionInTransit *Cluster_EncryptionInTransit[any] `json:"EncryptionInTransit,omitempty"`
...
func (r *Cluster_EncryptionInfo[any]) AWSCloudFormationType() string {
