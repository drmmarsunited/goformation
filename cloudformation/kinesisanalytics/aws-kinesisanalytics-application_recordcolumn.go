...
type Application_RecordColumn[T any] struct {
	...
	Mapping *T `json:"Mapping,omitempty"`
...
func (r *Application_RecordColumn[any]) AWSCloudFormationType() string {
