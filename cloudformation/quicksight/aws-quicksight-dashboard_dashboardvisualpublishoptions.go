...
type Dashboard_DashboardVisualPublishOptions[T any] struct {
	...
	ExportHiddenFieldsOption *Dashboard_ExportHiddenFieldsOption[any] `json:"ExportHiddenFieldsOption,omitempty"`
...
func (r *Dashboard_DashboardVisualPublishOptions[any]) AWSCloudFormationType() string {
