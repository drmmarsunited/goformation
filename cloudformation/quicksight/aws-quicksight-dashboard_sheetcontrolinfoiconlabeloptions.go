...
type Dashboard_SheetControlInfoIconLabelOptions[T any] struct {
	...
	InfoIconText *T `json:"InfoIconText,omitempty"`
...
func (r *Dashboard_SheetControlInfoIconLabelOptions[any]) AWSCloudFormationType() string {
