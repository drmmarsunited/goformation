...
type Analysis_ConditionalFormattingIconDisplayConfiguration[T any] struct {
...
func (r *Analysis_ConditionalFormattingIconDisplayConfiguration[any]) AWSCloudFormationType() string {
