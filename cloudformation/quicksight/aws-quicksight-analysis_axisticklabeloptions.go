...
// Analysis_AxisTickLabelOptions AWS CloudFormation Resource (AWS::QuickSight::Analysis.AxisTickLabelOptions)
...
type Analysis_AxisTickLabelOptions[T any] struct {
	...
	LabelOptions *Analysis_LabelOptions[any] `json:"LabelOptions,omitempty"`
...
func (r *Analysis_AxisTickLabelOptions[any]) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.AxisTickLabelOptions"
}
