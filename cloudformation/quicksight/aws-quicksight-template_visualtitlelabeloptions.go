...
type Template_VisualTitleLabelOptions[T any] struct {
	...
	FormatText *Template_ShortFormatText[any] `json:"FormatText,omitempty"`
...
func (r *Template_VisualTitleLabelOptions[any]) AWSCloudFormationType() string {
