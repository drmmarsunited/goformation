...
// Template_AttributeAggregationFunction AWS CloudFormation Resource (AWS::QuickSight::Template.AttributeAggregationFunction)
...
type Template_AttributeAggregationFunction[T any] struct {
...
func (r *Template_AttributeAggregationFunction[any]) AWSCloudFormationType() string {
	return "AWS::QuickSight::Template.AttributeAggregationFunction"
}
