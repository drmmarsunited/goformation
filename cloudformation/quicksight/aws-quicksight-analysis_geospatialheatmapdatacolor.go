...
// Analysis_GeospatialHeatmapDataColor AWS CloudFormation Resource (AWS::QuickSight::Analysis.GeospatialHeatmapDataColor)
...
type Analysis_GeospatialHeatmapDataColor[T any] struct {
...
func (r *Analysis_GeospatialHeatmapDataColor[any]) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.GeospatialHeatmapDataColor"
}
