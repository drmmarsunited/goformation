...
// Topic_NamedEntityDefinition AWS CloudFormation Resource (AWS::QuickSight::Topic.NamedEntityDefinition)
...
type Topic_NamedEntityDefinition[T any] struct {
	...
	Metric *Topic_NamedEntityDefinitionMetric[any] `json:"Metric,omitempty"`
...
func (r *Topic_NamedEntityDefinition[any]) AWSCloudFormationType() string {
	return "AWS::QuickSight::Topic.NamedEntityDefinition"
}
