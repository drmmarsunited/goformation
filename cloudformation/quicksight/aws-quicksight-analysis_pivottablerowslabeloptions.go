...
// Analysis_PivotTableRowsLabelOptions AWS CloudFormation Resource (AWS::QuickSight::Analysis.PivotTableRowsLabelOptions)
...
type Analysis_PivotTableRowsLabelOptions[T any] struct {
...
func (r *Analysis_PivotTableRowsLabelOptions[any]) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.PivotTableRowsLabelOptions"
}
