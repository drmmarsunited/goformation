...
type Dashboard_DashboardSourceTemplate[T any] struct {
	...
	DataSetReferences []Dashboard_DataSetReference[any] `json:"DataSetReferences"`
...
func (r *Dashboard_DashboardSourceTemplate[any]) AWSCloudFormationType() string {
