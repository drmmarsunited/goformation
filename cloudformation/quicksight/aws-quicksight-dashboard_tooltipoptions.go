...
type Dashboard_TooltipOptions[T any] struct {
	...
	FieldBasedTooltip *Dashboard_FieldBasedTooltip[any] `json:"FieldBasedTooltip,omitempty"`
...
func (r *Dashboard_TooltipOptions[any]) AWSCloudFormationType() string {
