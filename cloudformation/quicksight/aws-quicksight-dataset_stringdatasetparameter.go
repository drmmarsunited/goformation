...
type DataSet_StringDatasetParameter[T any] struct {
	...
	DefaultValues *DataSet_StringDatasetParameterDefaultValues[any] `json:"DefaultValues,omitempty"`
...
func (r *DataSet_StringDatasetParameter[any]) AWSCloudFormationType() string {
