...
// Analysis_RadarChartSortConfiguration AWS CloudFormation Resource (AWS::QuickSight::Analysis.RadarChartSortConfiguration)
...
type Analysis_RadarChartSortConfiguration[T any] struct {
...
func (r *Analysis_RadarChartSortConfiguration[any]) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.RadarChartSortConfiguration"
}
