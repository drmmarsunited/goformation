...
type Template_TableSortConfiguration[T any] struct {
	...
	RowSort []Template_FieldSortOptions[any] `json:"RowSort,omitempty"`
...
func (r *Template_TableSortConfiguration[any]) AWSCloudFormationType() string {
