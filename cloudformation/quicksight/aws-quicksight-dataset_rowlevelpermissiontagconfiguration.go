...
type DataSet_RowLevelPermissionTagConfiguration[T any] struct {
	...
	TagRules []DataSet_RowLevelPermissionTagRule[any] `json:"TagRules"`
...
func (r *DataSet_RowLevelPermissionTagConfiguration[any]) AWSCloudFormationType() string {
