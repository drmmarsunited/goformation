...
type Analysis_LineChartVisual[T any] struct {
	...
	ChartConfiguration *Analysis_LineChartConfiguration[any] `json:"ChartConfiguration,omitempty"`
...
func (r *Analysis_LineChartVisual[any]) AWSCloudFormationType() string {
