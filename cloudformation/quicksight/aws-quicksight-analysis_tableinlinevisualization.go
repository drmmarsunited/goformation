...
type Analysis_TableInlineVisualization[T any] struct {
	...
	DataBars *Analysis_DataBarsOptions[any] `json:"DataBars,omitempty"`
...
func (r *Analysis_TableInlineVisualization[any]) AWSCloudFormationType() string {
