...
type Dashboard_HeatMapVisual[T any] struct {
	...
	ChartConfiguration *Dashboard_HeatMapConfiguration[any] `json:"ChartConfiguration,omitempty"`
...
func (r *Dashboard_HeatMapVisual[any]) AWSCloudFormationType() string {
