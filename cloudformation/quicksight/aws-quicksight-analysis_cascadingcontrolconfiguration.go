...
type Analysis_CascadingControlConfiguration[T any] struct {
	...
	SourceControls []Analysis_CascadingControlSource[any] `json:"SourceControls,omitempty"`
...
func (r *Analysis_CascadingControlConfiguration[any]) AWSCloudFormationType() string {
