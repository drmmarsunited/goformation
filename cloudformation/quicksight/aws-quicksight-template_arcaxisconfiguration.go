...
type Template_ArcAxisConfiguration[T any] struct {
	...
	Range *Template_ArcAxisDisplayRange[any] `json:"Range,omitempty"`
...
func (r *Template_ArcAxisConfiguration[any]) AWSCloudFormationType() string {
