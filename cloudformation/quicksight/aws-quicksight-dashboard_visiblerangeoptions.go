...
type Dashboard_VisibleRangeOptions[T any] struct {
	...
	PercentRange *Dashboard_PercentVisibleRange[any] `json:"PercentRange,omitempty"`
...
func (r *Dashboard_VisibleRangeOptions[any]) AWSCloudFormationType() string {
