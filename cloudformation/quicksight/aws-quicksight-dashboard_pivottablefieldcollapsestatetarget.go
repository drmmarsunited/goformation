...
type Dashboard_PivotTableFieldCollapseStateTarget[T any] struct {
	...
	FieldDataPathValues []Dashboard_DataPathValue[any] `json:"FieldDataPathValues,omitempty"`
...
func (r *Dashboard_PivotTableFieldCollapseStateTarget[any]) AWSCloudFormationType() string {
