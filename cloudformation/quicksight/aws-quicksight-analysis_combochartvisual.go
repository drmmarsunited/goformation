...
type Analysis_ComboChartVisual[T any] struct {
	...
	ChartConfiguration *Analysis_ComboChartConfiguration[any] `json:"ChartConfiguration,omitempty"`
...
func (r *Analysis_ComboChartVisual[any]) AWSCloudFormationType() string {
