...
type Template_AxisDisplayRange[T any] struct {
	...
	MinMax *Template_AxisDisplayMinMaxRange[any] `json:"MinMax,omitempty"`
...
func (r *Template_AxisDisplayRange[any]) AWSCloudFormationType() string {
