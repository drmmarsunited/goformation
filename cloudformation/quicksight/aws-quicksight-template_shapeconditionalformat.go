...
type Template_ShapeConditionalFormat[T any] struct {
	...
	BackgroundColor *Template_ConditionalFormattingColor[any] `json:"BackgroundColor"`
...
func (r *Template_ShapeConditionalFormat[any]) AWSCloudFormationType() string {
