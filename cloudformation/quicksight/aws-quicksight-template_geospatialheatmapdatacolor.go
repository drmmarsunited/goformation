...
// Template_GeospatialHeatmapDataColor AWS CloudFormation Resource (AWS::QuickSight::Template.GeospatialHeatmapDataColor)
...
type Template_GeospatialHeatmapDataColor[T any] struct {
...
func (r *Template_GeospatialHeatmapDataColor[any]) AWSCloudFormationType() string {
	return "AWS::QuickSight::Template.GeospatialHeatmapDataColor"
}
