...
// Analysis_PivotTableFieldCollapseStateOption AWS CloudFormation Resource (AWS::QuickSight::Analysis.PivotTableFieldCollapseStateOption)
...
type Analysis_PivotTableFieldCollapseStateOption[T any] struct {
	...
	Target *Analysis_PivotTableFieldCollapseStateTarget[any] `json:"Target"`
...
func (r *Analysis_PivotTableFieldCollapseStateOption[any]) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.PivotTableFieldCollapseStateOption"
}
