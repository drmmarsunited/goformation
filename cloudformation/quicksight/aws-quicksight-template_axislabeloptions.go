...
type Template_AxisLabelOptions[T any] struct {
	...
	ApplyTo *Template_AxisLabelReferenceOptions[any] `json:"ApplyTo,omitempty"`
...
func (r *Template_AxisLabelOptions[any]) AWSCloudFormationType() string {
