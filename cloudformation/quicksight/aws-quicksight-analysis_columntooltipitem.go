...
type Analysis_ColumnTooltipItem[T any] struct {
	...
	Aggregation *Analysis_AggregationFunction[any] `json:"Aggregation,omitempty"`
...
func (r *Analysis_ColumnTooltipItem[any]) AWSCloudFormationType() string {
