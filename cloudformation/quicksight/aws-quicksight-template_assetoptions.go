...
// Template_AssetOptions AWS CloudFormation Resource (AWS::QuickSight::Template.AssetOptions)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-template-assetoptions.html
type Template_AssetOptions[T any] struct {
	...
	WeekStart *T `json:"WeekStart,omitempty"`
...
func (r *Template_AssetOptions[any]) AWSCloudFormationType() string {
	return "AWS::QuickSight::Template.AssetOptions"
}
