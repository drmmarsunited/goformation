...
type Topic_TopicCategoryFilter[T any] struct {
	...
	Constant *Topic_TopicCategoryFilterConstant[any] `json:"Constant,omitempty"`
	...
	Inverse *T `json:"Inverse,omitempty"`
...
func (r *Topic_TopicCategoryFilter[any]) AWSCloudFormationType() string {
