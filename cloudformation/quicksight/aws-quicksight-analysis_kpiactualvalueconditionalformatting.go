...
// Analysis_KPIActualValueConditionalFormatting AWS CloudFormation Resource (AWS::QuickSight::Analysis.KPIActualValueConditionalFormatting)
...
type Analysis_KPIActualValueConditionalFormatting[T any] struct {
...
func (r *Analysis_KPIActualValueConditionalFormatting[any]) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.KPIActualValueConditionalFormatting"
}
