...
type Analysis_FilterControl[T any] struct {
	...
	DateTimePicker *Analysis_FilterDateTimePickerControl[any] `json:"DateTimePicker,omitempty"`
	...
	Dropdown *Analysis_FilterDropDownControl[any] `json:"Dropdown,omitempty"`
	...
	List *Analysis_FilterListControl[any] `json:"List,omitempty"`
	...
	RelativeDateTime *Analysis_FilterRelativeDateTimeControl[any] `json:"RelativeDateTime,omitempty"`
	...
	Slider *Analysis_FilterSliderControl[any] `json:"Slider,omitempty"`
	...
	TextArea *Analysis_FilterTextAreaControl[any] `json:"TextArea,omitempty"`
	...
	TextField *Analysis_FilterTextFieldControl[any] `json:"TextField,omitempty"`
...
func (r *Analysis_FilterControl[any]) AWSCloudFormationType() string {
