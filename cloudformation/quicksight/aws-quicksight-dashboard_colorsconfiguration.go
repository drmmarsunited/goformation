...
type Dashboard_ColorsConfiguration[T any] struct {
	...
	CustomColors []Dashboard_CustomColor[any] `json:"CustomColors,omitempty"`
...
func (r *Dashboard_ColorsConfiguration[any]) AWSCloudFormationType() string {
