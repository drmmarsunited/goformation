...
type DataSet_IncrementalRefresh[T any] struct {
	...
	LookbackWindow *DataSet_LookbackWindow[any] `json:"LookbackWindow,omitempty"`
...
func (r *DataSet_IncrementalRefresh[any]) AWSCloudFormationType() string {
