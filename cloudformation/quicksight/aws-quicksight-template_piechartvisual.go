...
type Template_PieChartVisual[T any] struct {
	...
	ChartConfiguration *Template_PieChartConfiguration[any] `json:"ChartConfiguration,omitempty"`
...
func (r *Template_PieChartVisual[any]) AWSCloudFormationType() string {
