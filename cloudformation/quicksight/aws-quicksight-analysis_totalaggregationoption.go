...
// Analysis_TotalAggregationOption AWS CloudFormation Resource (AWS::QuickSight::Analysis.TotalAggregationOption)
...
type Analysis_TotalAggregationOption[T any] struct {
	...
	TotalAggregationFunction *Analysis_TotalAggregationFunction[any] `json:"TotalAggregationFunction"`
...
func (r *Analysis_TotalAggregationOption[any]) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.TotalAggregationOption"
}
