...
type Dashboard_TreeMapAggregatedFieldWells[T any] struct {
	...
	Colors []Dashboard_MeasureField[any] `json:"Colors,omitempty"`
	...
	Groups []Dashboard_DimensionField[any] `json:"Groups,omitempty"`
	...
	Sizes []Dashboard_MeasureField[any] `json:"Sizes,omitempty"`
...
func (r *Dashboard_TreeMapAggregatedFieldWells[any]) AWSCloudFormationType() string {
