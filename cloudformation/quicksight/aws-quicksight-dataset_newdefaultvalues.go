...
type DataSet_NewDefaultValues[T any] struct {
	...
	DecimalStaticValues []T `json:"DecimalStaticValues,omitempty"`
	...
	IntegerStaticValues []T `json:"IntegerStaticValues,omitempty"`
...
func (r *DataSet_NewDefaultValues[any]) AWSCloudFormationType() string {
