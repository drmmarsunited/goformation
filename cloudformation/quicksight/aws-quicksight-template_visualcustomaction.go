...
type Template_VisualCustomAction[T any] struct {
	...
	ActionOperations []Template_VisualCustomActionOperation[any] `json:"ActionOperations"`
...
func (r *Template_VisualCustomAction[any]) AWSCloudFormationType() string {
