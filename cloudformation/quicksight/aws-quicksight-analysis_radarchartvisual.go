...
type Analysis_RadarChartVisual[T any] struct {
	...
	ChartConfiguration *Analysis_RadarChartConfiguration[any] `json:"ChartConfiguration,omitempty"`
...
func (r *Analysis_RadarChartVisual[any]) AWSCloudFormationType() string {
