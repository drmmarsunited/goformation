...
// Dashboard_LineChartLineStyleSettings AWS CloudFormation Resource (AWS::QuickSight::Dashboard.LineChartLineStyleSettings)
...
type Dashboard_LineChartLineStyleSettings[T any] struct {
...
func (r *Dashboard_LineChartLineStyleSettings[any]) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.LineChartLineStyleSettings"
}
