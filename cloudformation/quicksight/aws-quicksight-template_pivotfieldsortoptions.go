...
type Template_PivotFieldSortOptions[T any] struct {
	...
	SortBy *Template_PivotTableSortBy[any] `json:"SortBy"`
...
func (r *Template_PivotFieldSortOptions[any]) AWSCloudFormationType() string {
