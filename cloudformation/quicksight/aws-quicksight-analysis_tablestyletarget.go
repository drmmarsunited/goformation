...
// Analysis_TableStyleTarget AWS CloudFormation Resource (AWS::QuickSight::Analysis.TableStyleTarget)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-analysis-tablestyletarget.html
type Analysis_TableStyleTarget[T any] struct {
...
func (r *Analysis_TableStyleTarget[any]) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.TableStyleTarget"
}
