...
// Template_ValidationStrategy AWS CloudFormation Resource (AWS::QuickSight::Template.ValidationStrategy)
...
type Template_ValidationStrategy[T any] struct {
...
func (r *Template_ValidationStrategy[any]) AWSCloudFormationType() string {
	return "AWS::QuickSight::Template.ValidationStrategy"
}
