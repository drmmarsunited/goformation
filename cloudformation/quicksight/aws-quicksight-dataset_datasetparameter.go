...
type DataSet_DatasetParameter[T any] struct {
	...
	DateTimeDatasetParameter *DataSet_DateTimeDatasetParameter[any] `json:"DateTimeDatasetParameter,omitempty"`
	...
	DecimalDatasetParameter *DataSet_DecimalDatasetParameter[any] `json:"DecimalDatasetParameter,omitempty"`
	...
	IntegerDatasetParameter *DataSet_IntegerDatasetParameter[any] `json:"IntegerDatasetParameter,omitempty"`
	...
	StringDatasetParameter *DataSet_StringDatasetParameter[any] `json:"StringDatasetParameter,omitempty"`
