...
type Analysis_TooltipOptions[T any] struct {
	...
	FieldBasedTooltip *Analysis_FieldBasedTooltip[any] `json:"FieldBasedTooltip,omitempty"`
...
func (r *Analysis_TooltipOptions[any]) AWSCloudFormationType() string {
