...
type Dashboard_FunnelChartConfiguration[T any] struct {
	...
	DataLabelOptions *Dashboard_FunnelChartDataLabelOptions[any] `json:"DataLabelOptions,omitempty"`
	...
	FieldWells *Dashboard_FunnelChartFieldWells[any] `json:"FieldWells,omitempty"`
	...
	SortConfiguration *Dashboard_FunnelChartSortConfiguration[any] `json:"SortConfiguration,omitempty"`
...
func (r *Dashboard_FunnelChartConfiguration[any]) AWSCloudFormationType() string {
