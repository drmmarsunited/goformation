...
type Dashboard_PieChartVisual[T any] struct {
	...
	ChartConfiguration *Dashboard_PieChartConfiguration[any] `json:"ChartConfiguration,omitempty"`
...
func (r *Dashboard_PieChartVisual[any]) AWSCloudFormationType() string {
