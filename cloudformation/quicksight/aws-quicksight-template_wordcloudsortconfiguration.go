...
// Template_WordCloudSortConfiguration AWS CloudFormation Resource (AWS::QuickSight::Template.WordCloudSortConfiguration)
...
type Template_WordCloudSortConfiguration[T any] struct {
	...
	CategoryItemsLimit *Template_ItemsLimitConfiguration[any] `json:"CategoryItemsLimit,omitempty"`
...
func (r *Template_WordCloudSortConfiguration[any]) AWSCloudFormationType() string {
	return "AWS::QuickSight::Template.WordCloudSortConfiguration"
}
