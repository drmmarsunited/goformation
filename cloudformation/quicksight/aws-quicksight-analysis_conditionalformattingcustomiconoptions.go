...
type Analysis_ConditionalFormattingCustomIconOptions[T any] struct {
...
func (r *Analysis_ConditionalFormattingCustomIconOptions[any]) AWSCloudFormationType() string {
