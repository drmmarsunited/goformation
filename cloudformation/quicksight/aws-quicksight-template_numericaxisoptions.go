...
type Template_NumericAxisOptions struct {
	...
	Range *Template_AxisDisplayRange `json:"Range,omitempty"`
	...
	Scale *Template_AxisScale `json:"Scale,omitempty"`
...
func (r *Template_NumericAxisOptions) AWSCloudFormationType() string {
