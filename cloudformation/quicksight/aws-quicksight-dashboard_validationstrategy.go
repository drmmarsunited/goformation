...
// Dashboard_ValidationStrategy AWS CloudFormation Resource (AWS::QuickSight::Dashboard.ValidationStrategy)
...
type Dashboard_ValidationStrategy[T any] struct {
...
func (r *Dashboard_ValidationStrategy[any]) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.ValidationStrategy"
}
