...
type Topic_TopicCategoryFilterConstant[T any] struct {
	...
	CollectiveConstant *Topic_CollectiveConstant[any] `json:"CollectiveConstant,omitempty"`
...
func (r *Topic_TopicCategoryFilterConstant[any]) AWSCloudFormationType() string {
