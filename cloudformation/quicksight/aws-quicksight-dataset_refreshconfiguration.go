...
type DataSet_RefreshConfiguration[T any] struct {
	...
	IncrementalRefresh *DataSet_IncrementalRefresh[any] `json:"IncrementalRefresh,omitempty"`
...
func (r *DataSet_RefreshConfiguration[any]) AWSCloudFormationType() string {
