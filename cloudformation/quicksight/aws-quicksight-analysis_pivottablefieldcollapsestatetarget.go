...
// Analysis_PivotTableFieldCollapseStateTarget AWS CloudFormation Resource (AWS::QuickSight::Analysis.PivotTableFieldCollapseStateTarget)
...
type Analysis_PivotTableFieldCollapseStateTarget[T any] struct {
	...
	FieldDataPathValues []Analysis_DataPathValue[any] `json:"FieldDataPathValues,omitempty"`
...
func (r *Analysis_PivotTableFieldCollapseStateTarget[any]) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.PivotTableFieldCollapseStateTarget"
}
