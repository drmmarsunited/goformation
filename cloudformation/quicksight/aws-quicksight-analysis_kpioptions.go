...
type Analysis_KPIOptions[T any] struct {
	...
	Sparkline *Analysis_KPISparklineOptions[any] `json:"Sparkline,omitempty"`
	...
	VisualLayoutOptions *Analysis_KPIVisualLayoutOptions[any] `json:"VisualLayoutOptions,omitempty"`
