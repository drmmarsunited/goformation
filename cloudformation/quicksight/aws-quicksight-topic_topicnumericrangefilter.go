...
type Topic_TopicNumericRangeFilter[T any] struct {
	...
	Constant *Topic_TopicRangeFilterConstant[any] `json:"Constant,omitempty"`
	...
	Inclusive *T `json:"Inclusive,omitempty"`
...
func (r *Topic_TopicNumericRangeFilter[any]) AWSCloudFormationType() string {
