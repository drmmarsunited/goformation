...
type Topic_TopicNamedEntity[T any] struct {
	...
	Definition []Topic_NamedEntityDefinition[any] `json:"Definition,omitempty"`
	...
	SemanticEntityType *Topic_SemanticEntityType[any] `json:"SemanticEntityType,omitempty"`
...
func (r *Topic_TopicNamedEntity[any]) AWSCloudFormationType() string {
