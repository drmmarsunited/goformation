...
type DataSet_DecimalDatasetParameter[T any] struct {
	...
	DefaultValues *DataSet_DecimalDatasetParameterDefaultValues[any] `json:"DefaultValues,omitempty"`
...
func (r *DataSet_DecimalDatasetParameter[any]) AWSCloudFormationType() string {
