...
type Template_TreeMapVisual[T any] struct {
	...
	ChartConfiguration *Template_TreeMapConfiguration[any] `json:"ChartConfiguration,omitempty"`
...
func (r *Template_TreeMapVisual[any]) AWSCloudFormationType() string {
