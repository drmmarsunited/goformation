...
type Template_TotalAggregationOption[T any] struct {
	...
	TotalAggregationFunction *Template_TotalAggregationFunction[any] `json:"TotalAggregationFunction"`
...
func (r *Template_TotalAggregationOption[any]) AWSCloudFormationType() string {
