...
type Dashboard_SankeyDiagramVisual[T any] struct {
	...
	ChartConfiguration *Dashboard_SankeyDiagramChartConfiguration[any] `json:"ChartConfiguration,omitempty"`
...
func (r *Dashboard_SankeyDiagramVisual[any]) AWSCloudFormationType() string {
