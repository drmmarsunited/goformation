...
type Template_ComparisonConfiguration struct {
	...
	ComparisonFormat *Template_ComparisonFormatConfiguration `json:"ComparisonFormat,omitempty"`
...
func (r *Template_ComparisonConfiguration) AWSCloudFormationType() string {
