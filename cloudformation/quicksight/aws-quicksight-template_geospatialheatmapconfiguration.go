...
type Template_GeospatialHeatmapConfiguration[T any] struct {
	...
	HeatmapColor *Template_GeospatialHeatmapColorScale[any] `json:"HeatmapColor,omitempty"`
...
func (r *Template_GeospatialHeatmapConfiguration[any]) AWSCloudFormationType() string {
