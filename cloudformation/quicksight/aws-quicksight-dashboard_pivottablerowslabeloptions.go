...
// Dashboard_PivotTableRowsLabelOptions AWS CloudFormation Resource (AWS::QuickSight::Dashboard.PivotTableRowsLabelOptions)
...
type Dashboard_PivotTableRowsLabelOptions[T any] struct {
...
func (r *Dashboard_PivotTableRowsLabelOptions[any]) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.PivotTableRowsLabelOptions"
}
