...
type Analysis_KPIComparisonValueConditionalFormatting[T any] struct {
...
func (r *Analysis_KPIComparisonValueConditionalFormatting[any]) AWSCloudFormationType() string {
