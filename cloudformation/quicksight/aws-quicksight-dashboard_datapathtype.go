...
// Dashboard_DataPathType AWS CloudFormation Resource (AWS::QuickSight::Dashboard.DataPathType)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-dashboard-datapathtype.html
type Dashboard_DataPathType[T any] struct {
	...
	PivotTableDataPathType *T `json:"PivotTableDataPathType,omitempty"`
...
func (r *Dashboard_DataPathType[any]) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.DataPathType"
}
