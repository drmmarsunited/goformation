...
type Theme_TileLayoutStyle[T any] struct {
	...
	Gutter *Theme_GutterStyle[any] `json:"Gutter,omitempty"`
	...
	Margin *Theme_MarginStyle[any] `json:"Margin,omitempty"`
...
func (r *Theme_TileLayoutStyle[any]) AWSCloudFormationType() string {
