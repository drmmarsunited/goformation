...
type Dashboard_ClusterMarker[T any] struct {
	...
	SimpleClusterMarker *Dashboard_SimpleClusterMarker[any] `json:"SimpleClusterMarker,omitempty"`
...
func (r *Dashboard_ClusterMarker[any]) AWSCloudFormationType() string {
