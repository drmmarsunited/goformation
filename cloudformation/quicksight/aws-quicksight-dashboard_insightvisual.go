...
type Dashboard_InsightVisual[T any] struct {
	...
	InsightConfiguration *Dashboard_InsightConfiguration[any] `json:"InsightConfiguration,omitempty"`
...
func (r *Dashboard_InsightVisual[any]) AWSCloudFormationType() string {
