...
type Dashboard_GradientColor[T any] struct {
	...
	Stops []Dashboard_GradientStop[any] `json:"Stops,omitempty"`
...
func (r *Dashboard_GradientColor[any]) AWSCloudFormationType() string {
