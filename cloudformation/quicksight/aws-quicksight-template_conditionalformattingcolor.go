...
type Template_ConditionalFormattingColor[T any] struct {
	...
	Gradient *Template_ConditionalFormattingGradientColor[any] `json:"Gradient,omitempty"`
	...
	Solid *Template_ConditionalFormattingSolidColor[any] `json:"Solid,omitempty"`
...
func (r *Template_ConditionalFormattingColor[any]) AWSCloudFormationType() string {
