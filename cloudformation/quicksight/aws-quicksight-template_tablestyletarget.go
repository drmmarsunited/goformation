...
// Template_TableStyleTarget AWS CloudFormation Resource (AWS::QuickSight::Template.TableStyleTarget)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-template-tablestyletarget.html
type Template_TableStyleTarget[T any] struct {
...
func (r *Template_TableStyleTarget[any]) AWSCloudFormationType() string {
	return "AWS::QuickSight::Template.TableStyleTarget"
}
