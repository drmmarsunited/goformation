...
type Template_TableInlineVisualization[T any] struct {
	...
	DataBars *Template_DataBarsOptions[any] `json:"DataBars,omitempty"`
...
func (r *Template_TableInlineVisualization[any]) AWSCloudFormationType() string {
