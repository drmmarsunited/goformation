...
type Template_AnalysisDefaults struct {
	...
	DefaultNewSheetConfiguration *Template_DefaultNewSheetConfiguration `json:"DefaultNewSheetConfiguration"`
...
func (r *Template_AnalysisDefaults) AWSCloudFormationType() string {
