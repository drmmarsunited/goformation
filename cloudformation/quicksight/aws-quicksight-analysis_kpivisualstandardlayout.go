...
// Analysis_KPIVisualStandardLayout AWS CloudFormation Resource (AWS::QuickSight::Analysis.KPIVisualStandardLayout)
...
type Analysis_KPIVisualStandardLayout[T any] struct {
...
func (r *Analysis_KPIVisualStandardLayout[any]) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.KPIVisualStandardLayout"
}
