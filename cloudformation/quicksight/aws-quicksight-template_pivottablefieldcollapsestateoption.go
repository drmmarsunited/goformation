...
type Template_PivotTableFieldCollapseStateOption[T any] struct {
	...
	Target *Template_PivotTableFieldCollapseStateTarget[any] `json:"Target"`
...
func (r *Template_PivotTableFieldCollapseStateOption[any]) AWSCloudFormationType() string {
