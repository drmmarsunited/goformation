...
type Analysis_TreeMapVisual[T any] struct {
	...
	ChartConfiguration *Analysis_TreeMapConfiguration[any] `json:"ChartConfiguration,omitempty"`
...
func (r *Analysis_TreeMapVisual[any]) AWSCloudFormationType() string {
