...
type Template_CustomValuesConfiguration[T any] struct {
	...
	CustomValues *Template_CustomParameterValues[any] `json:"CustomValues"`
...
func (r *Template_CustomValuesConfiguration[any]) AWSCloudFormationType() string {
