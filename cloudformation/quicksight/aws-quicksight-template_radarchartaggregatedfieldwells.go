...
type Template_RadarChartAggregatedFieldWells[T any] struct {
	...
	Color []Template_DimensionField[any] `json:"Color,omitempty"`
...
func (r *Template_RadarChartAggregatedFieldWells[any]) AWSCloudFormationType() string {
