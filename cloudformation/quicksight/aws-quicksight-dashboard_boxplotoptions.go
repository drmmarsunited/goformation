...
type Dashboard_BoxPlotOptions[T any] struct {
	...
	StyleOptions *Dashboard_BoxPlotStyleOptions[any] `json:"StyleOptions,omitempty"`
...
func (r *Dashboard_BoxPlotOptions[any]) AWSCloudFormationType() string {
