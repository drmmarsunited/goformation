...
// Analysis_DataPathType AWS CloudFormation Resource (AWS::QuickSight::Analysis.DataPathType)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-analysis-datapathtype.html
type Analysis_DataPathType[T any] struct {
...
func (r *Analysis_DataPathType[any]) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.DataPathType"
}
