...
// AutomationRule_RelatedFinding AWS CloudFormation Resource (AWS::SecurityHub::AutomationRule.RelatedFinding)
...
type AutomationRule_RelatedFinding[T any] struct {
...
func (r *AutomationRule_RelatedFinding[any]) AWSCloudFormationType() string {
	return "AWS::SecurityHub::AutomationRule.RelatedFinding"
}
