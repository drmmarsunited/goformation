...
// AutomationRule_DateRange AWS CloudFormation Resource (AWS::SecurityHub::AutomationRule.DateRange)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-securityhub-automationrule-daterange.html
type AutomationRule_DateRange[T any] struct {
...
func (r *AutomationRule_DateRange[any]) AWSCloudFormationType() string {
	return "AWS::SecurityHub::AutomationRule.DateRange"
}
