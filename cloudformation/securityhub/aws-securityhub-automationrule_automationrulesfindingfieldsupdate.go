...
type AutomationRule_AutomationRulesFindingFieldsUpdate[T any] struct {
	...
	Confidence *T `json:"Confidence,omitempty"`
	...
	Criticality *T `json:"Criticality,omitempty"`
	...
	Note *AutomationRule_NoteUpdate[any] `json:"Note,omitempty"`
	...
	RelatedFindings []AutomationRule_RelatedFinding[any] `json:"RelatedFindings,omitempty"`
	...
	Severity *AutomationRule_SeverityUpdate[any] `json:"Severity,omitempty"`
	...
	Workflow *AutomationRule_WorkflowUpdate[any] `json:"Workflow,omitempty"`
...
func (r *AutomationRule_AutomationRulesFindingFieldsUpdate[any]) AWSCloudFormationType() string {
