...
type Hub[T any] struct {
	...
	// AutoEnableControls AWS CloudFormation Property
	// Required: false
	...
	AutoEnableControls *T `json:"AutoEnableControls,omitempty"`
	...
	EnableDefaultStandards *T `json:"EnableDefaultStandards,omitempty"`
