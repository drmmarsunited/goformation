...
type LoggerDefinitionVersion[T any] struct {
	...
	Loggers []LoggerDefinitionVersion_Logger[any] `json:"Loggers"`
...
func (r *LoggerDefinitionVersion[any]) AWSCloudFormationType() string {
	return "AWS::Greengrass::LoggerDefinitionVersion"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LoggerDefinitionVersion[any]) MarshalJSON() ([]byte, error) {
	type Properties LoggerDefinitionVersion[any]
...
func (r *LoggerDefinitionVersion[any]) UnmarshalJSON(b []byte) error {
	type Properties LoggerDefinitionVersion[any]
	...
	if res.Properties != nil {
		*r = LoggerDefinitionVersion[any](*res.Properties)
	}
