...
type FunctionDefinitionVersion_ResourceAccessPolicy[T any] struct {
...
func (r *FunctionDefinitionVersion_ResourceAccessPolicy[any]) AWSCloudFormationType() string {
