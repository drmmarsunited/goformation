...
type DeviceDefinition_DeviceDefinitionVersion[T any] struct {
	...
	Devices []DeviceDefinition_Device[any] `json:"Devices"`
...
func (r *DeviceDefinition_DeviceDefinitionVersion[any]) AWSCloudFormationType() string {
