...
type FunctionDefinition[T any] struct {
	...
	InitialVersion *FunctionDefinition_FunctionDefinitionVersion[any] `json:"InitialVersion,omitempty"`
...
func (r *FunctionDefinition[any]) AWSCloudFormationType() string {
	return "AWS::Greengrass::FunctionDefinition"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r FunctionDefinition[any]) MarshalJSON() ([]byte, error) {
	type Properties FunctionDefinition[any]
...
func (r *FunctionDefinition[any]) UnmarshalJSON(b []byte) error {
	type Properties FunctionDefinition[any]
	...
	if res.Properties != nil {
		*r = FunctionDefinition[any](*res.Properties)
	}
