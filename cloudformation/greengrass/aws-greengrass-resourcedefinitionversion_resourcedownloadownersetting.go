...
type ResourceDefinitionVersion_ResourceDownloadOwnerSetting[T any] struct {
...
func (r *ResourceDefinitionVersion_ResourceDownloadOwnerSetting[any]) AWSCloudFormationType() string {
