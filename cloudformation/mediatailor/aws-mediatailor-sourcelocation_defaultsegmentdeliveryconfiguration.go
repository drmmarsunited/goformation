...
type SourceLocation_DefaultSegmentDeliveryConfiguration[T any] struct {
...
func (r *SourceLocation_DefaultSegmentDeliveryConfiguration[any]) AWSCloudFormationType() string {
