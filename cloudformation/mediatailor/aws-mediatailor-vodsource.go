...
// VodSource AWS CloudFormation Resource (AWS::MediaTailor::VodSource)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-mediatailor-vodsource.html
type VodSource[T any] struct {

	// HttpPackageConfigurations AWS CloudFormation Property
	// Required: true
	...
	HttpPackageConfigurations []VodSource_HttpPackageConfiguration[any] `json:"HttpPackageConfigurations"`
	...
	VodSourceName T `json:"VodSourceName"`
...
func (r *VodSource[any]) AWSCloudFormationType() string {
	return "AWS::MediaTailor::VodSource"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r VodSource[any]) MarshalJSON() ([]byte, error) {
	type Properties VodSource[any]
...
func (r *VodSource[any]) UnmarshalJSON(b []byte) error {
	type Properties VodSource[any]
	...
	if res.Properties != nil {
		*r = VodSource[any](*res.Properties)
	}
