...
type SourceLocation_AccessConfiguration[T any] struct {
	...
	SecretsManagerAccessTokenConfiguration *SourceLocation_SecretsManagerAccessTokenConfiguration[any] `json:"SecretsManagerAccessTokenConfiguration,omitempty"`
...
func (r *SourceLocation_AccessConfiguration[any]) AWSCloudFormationType() string {
