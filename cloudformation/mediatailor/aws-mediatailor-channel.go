...
type Channel[T any] struct {
	...
	FillerSlate *Channel_SlateSource[any] `json:"FillerSlate,omitempty"`
	...
	LogConfiguration *Channel_LogConfigurationForChannel[any] `json:"LogConfiguration,omitempty"`
	...
	Outputs []Channel_RequestOutputItem[any] `json:"Outputs"`
