...
type LiveSource[T any] struct {
	...
	HttpPackageConfigurations []LiveSource_HttpPackageConfiguration[any] `json:"HttpPackageConfigurations"`
...
func (r *LiveSource[any]) AWSCloudFormationType() string {
	return "AWS::MediaTailor::LiveSource"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LiveSource[any]) MarshalJSON() ([]byte, error) {
	type Properties LiveSource[any]
...
func (r *LiveSource[any]) UnmarshalJSON(b []byte) error {
	type Properties LiveSource[any]
	...
	if res.Properties != nil {
		*r = LiveSource[any](*res.Properties)
	}
