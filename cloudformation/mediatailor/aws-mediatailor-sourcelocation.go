...
type SourceLocation[T any] struct {
	...
	AccessConfiguration *SourceLocation_AccessConfiguration[any] `json:"AccessConfiguration,omitempty"`
	...
	DefaultSegmentDeliveryConfiguration *SourceLocation_DefaultSegmentDeliveryConfiguration[any] `json:"DefaultSegmentDeliveryConfiguration,omitempty"`
	...
	HttpConfiguration *SourceLocation_HttpConfiguration[any] `json:"HttpConfiguration"`
	...
	SegmentDeliveryConfigurations []SourceLocation_SegmentDeliveryConfiguration[any] `json:"SegmentDeliveryConfigurations,omitempty"`
...
func (r *SourceLocation[any]) AWSCloudFormationType() string {
	return "AWS::MediaTailor::SourceLocation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r SourceLocation[any]) MarshalJSON() ([]byte, error) {
	type Properties SourceLocation[any]
...
func (r *SourceLocation[any]) UnmarshalJSON(b []byte) error {
	type Properties SourceLocation[any]
	...
	if res.Properties != nil {
		*r = SourceLocation[any](*res.Properties)
	}
