...
type TrustAnchor_Source[T any] struct {
	...
	SourceData *TrustAnchor_SourceData[any] `json:"SourceData,omitempty"`
	...
	SourceType *T `json:"SourceType,omitempty"`
...
func (r *TrustAnchor_Source[any]) AWSCloudFormationType() string {
