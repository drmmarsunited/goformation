...
type Campaign_OutboundCallConfig[T any] struct {
	...
	ConnectContactFlowArn T `json:"ConnectContactFlowArn"`
	...
	ConnectQueueArn *T `json:"ConnectQueueArn,omitempty"`
	...
	ConnectSourcePhoneNumber *T `json:"ConnectSourcePhoneNumber,omitempty"`
