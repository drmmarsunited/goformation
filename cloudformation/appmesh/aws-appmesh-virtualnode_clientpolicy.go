...
type VirtualNode_ClientPolicy[T any] struct {
	...
	TLS *VirtualNode_ClientPolicyTls[any] `json:"TLS,omitempty"`
...
func (r *VirtualNode_ClientPolicy[any]) AWSCloudFormationType() string {
