...
type VirtualNode_AccessLog[T any] struct {
	...
	File *VirtualNode_FileAccessLog[any] `json:"File,omitempty"`
...
func (r *VirtualNode_AccessLog[any]) AWSCloudFormationType() string {
