...
type Route_HttpRouteHeader[T any] struct {
	...
	Match *Route_HeaderMatchMethod[any] `json:"Match,omitempty"`
...
func (r *Route_HttpRouteHeader[any]) AWSCloudFormationType() string {
