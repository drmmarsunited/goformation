...
type VirtualGateway_VirtualGatewayListenerTlsAcmCertificate[T any] struct {
...
func (r *VirtualGateway_VirtualGatewayListenerTlsAcmCertificate[any]) AWSCloudFormationType() string {
