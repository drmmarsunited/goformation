...
type VirtualGateway_VirtualGatewayBackendDefaults[T any] struct {
	...
	ClientPolicy *VirtualGateway_VirtualGatewayClientPolicy[any] `json:"ClientPolicy,omitempty"`
...
func (r *VirtualGateway_VirtualGatewayBackendDefaults[any]) AWSCloudFormationType() string {
