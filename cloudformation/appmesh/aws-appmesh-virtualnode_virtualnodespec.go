...
type VirtualNode_VirtualNodeSpec[T any] struct {
	...
	BackendDefaults *VirtualNode_BackendDefaults[any] `json:"BackendDefaults,omitempty"`
	...
	Backends []VirtualNode_Backend[any] `json:"Backends,omitempty"`
	...
	Listeners []VirtualNode_Listener[any] `json:"Listeners,omitempty"`
	...
	Logging *VirtualNode_Logging[any] `json:"Logging,omitempty"`
	...
	ServiceDiscovery *VirtualNode_ServiceDiscovery[any] `json:"ServiceDiscovery,omitempty"`
...
func (r *VirtualNode_VirtualNodeSpec[any]) AWSCloudFormationType() string {
