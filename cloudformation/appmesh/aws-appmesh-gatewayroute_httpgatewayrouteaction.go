...
type GatewayRoute_HttpGatewayRouteAction[T any] struct {
	...
	Rewrite *GatewayRoute_HttpGatewayRouteRewrite[any] `json:"Rewrite,omitempty"`
...
func (r *GatewayRoute_HttpGatewayRouteAction[any]) AWSCloudFormationType() string {
