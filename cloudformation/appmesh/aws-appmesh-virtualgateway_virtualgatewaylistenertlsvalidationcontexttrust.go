...
type VirtualGateway_VirtualGatewayListenerTlsValidationContextTrust[T any] struct {
...
func (r *VirtualGateway_VirtualGatewayListenerTlsValidationContextTrust[any]) AWSCloudFormationType() string {
