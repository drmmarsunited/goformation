...
type Route_GrpcRouteMetadata[T any] struct {
	...
	Match *Route_GrpcRouteMetadataMatchMethod[any] `json:"Match,omitempty"`
...
func (r *Route_GrpcRouteMetadata[any]) AWSCloudFormationType() string {
