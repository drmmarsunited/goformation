...
type VirtualGateway_VirtualGatewayClientTlsCertificate[T any] struct {
...
func (r *VirtualGateway_VirtualGatewayClientTlsCertificate[any]) AWSCloudFormationType() string {
