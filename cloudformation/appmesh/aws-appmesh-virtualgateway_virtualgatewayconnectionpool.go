...
type VirtualGateway_VirtualGatewayConnectionPool[T any] struct {
	...
	GRPC *VirtualGateway_VirtualGatewayGrpcConnectionPool[any] `json:"GRPC,omitempty"`
	...
	HTTP *VirtualGateway_VirtualGatewayHttpConnectionPool[any] `json:"HTTP,omitempty"`
	...
	HTTP2 *VirtualGateway_VirtualGatewayHttp2ConnectionPool[any] `json:"HTTP2,omitempty"`
...
func (r *VirtualGateway_VirtualGatewayConnectionPool[any]) AWSCloudFormationType() string {
