...
type OriginEndpoint_MssPackage[T any] struct {
	...
	Encryption *OriginEndpoint_MssEncryption[any] `json:"Encryption,omitempty"`
...
func (r *OriginEndpoint_MssPackage[any]) AWSCloudFormationType() string {
