...
type PackagingGroup[T any] struct {
	...
	Authorization *PackagingGroup_Authorization[any] `json:"Authorization,omitempty"`
	...
	EgressAccessLogs *PackagingGroup_LogConfiguration[any] `json:"EgressAccessLogs,omitempty"`
...
func (r *PackagingGroup[any]) AWSCloudFormationType() string {
	return "AWS::MediaPackage::PackagingGroup"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r PackagingGroup[any]) MarshalJSON() ([]byte, error) {
	type Properties PackagingGroup[any]
...
func (r *PackagingGroup[any]) UnmarshalJSON(b []byte) error {
	type Properties PackagingGroup[any]
	...
	if res.Properties != nil {
		*r = PackagingGroup[any](*res.Properties)
	}
