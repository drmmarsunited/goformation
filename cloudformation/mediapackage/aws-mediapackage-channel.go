...
type Channel[T any] struct {
	...
	EgressAccessLogs *Channel_LogConfiguration[any] `json:"EgressAccessLogs,omitempty"`

	// HlsIngest AWS CloudFormation Property
	// Required: false
	...
	HlsIngest *Channel_HlsIngest[any] `json:"HlsIngest,omitempty"`
	...
	IngressAccessLogs *Channel_LogConfiguration[any] `json:"IngressAccessLogs,omitempty"`
