...
type OriginEndpoint_CmafPackage[T any] struct {
	...
	Encryption *OriginEndpoint_CmafEncryption[any] `json:"Encryption,omitempty"`
	...
	HlsManifests []OriginEndpoint_HlsManifest[any] `json:"HlsManifests,omitempty"`
...
func (r *OriginEndpoint_CmafPackage[any]) AWSCloudFormationType() string {
