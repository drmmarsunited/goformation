...
type ModelExplainabilityJobDefinition_ConstraintsResource[T any] struct {
...
func (r *ModelExplainabilityJobDefinition_ConstraintsResource[any]) AWSCloudFormationType() string {
