...
type MonitoringSchedule_MonitoringOutput[T any] struct {
	...
	S3Output *MonitoringSchedule_S3Output[any] `json:"S3Output"`
...
func (r *MonitoringSchedule_MonitoringOutput[any]) AWSCloudFormationType() string {
