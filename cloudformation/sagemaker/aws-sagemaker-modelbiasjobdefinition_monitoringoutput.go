...
type ModelBiasJobDefinition_MonitoringOutput[T any] struct {
	...
	S3Output *ModelBiasJobDefinition_S3Output[any] `json:"S3Output"`
...
func (r *ModelBiasJobDefinition_MonitoringOutput[any]) AWSCloudFormationType() string {
