...
type ModelExplainabilityJobDefinition_MonitoringResources[T any] struct {
	...
	ClusterConfig *ModelExplainabilityJobDefinition_ClusterConfig[any] `json:"ClusterConfig"`
...
func (r *ModelExplainabilityJobDefinition_MonitoringResources[any]) AWSCloudFormationType() string {
