...
type MonitoringSchedule_NetworkConfig[T any] struct {
	...
	VpcConfig *MonitoringSchedule_VpcConfig[any] `json:"VpcConfig,omitempty"`
...
func (r *MonitoringSchedule_NetworkConfig[any]) AWSCloudFormationType() string {
