...
type Budget_NotificationWithSubscribers[T any] struct {
	...
	Notification *Budget_Notification[any] `json:"Notification"`
	...
	Subscribers []Budget_Subscriber[any] `json:"Subscribers"`
...
func (r *Budget_NotificationWithSubscribers[any]) AWSCloudFormationType() string {
