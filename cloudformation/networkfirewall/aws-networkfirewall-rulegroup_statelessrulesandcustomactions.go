...
type RuleGroup_StatelessRulesAndCustomActions[T any] struct {
	...
	CustomActions []RuleGroup_CustomAction[any] `json:"CustomActions,omitempty"`
	...
	StatelessRules []RuleGroup_StatelessRule[any] `json:"StatelessRules"`
...
func (r *RuleGroup_StatelessRulesAndCustomActions[any]) AWSCloudFormationType() string {
