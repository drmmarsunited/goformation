...
type FirewallPolicy_PublishMetricAction[T any] struct {
	...
	Dimensions []FirewallPolicy_Dimension[any] `json:"Dimensions"`
...
func (r *FirewallPolicy_PublishMetricAction[any]) AWSCloudFormationType() string {
