...
type RuleGroup_ActionDefinition[T any] struct {
	...
	PublishMetricAction *RuleGroup_PublishMetricAction[any] `json:"PublishMetricAction,omitempty"`
...
func (r *RuleGroup_ActionDefinition[any]) AWSCloudFormationType() string {
