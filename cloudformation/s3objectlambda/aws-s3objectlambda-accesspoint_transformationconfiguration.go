...
type AccessPoint_TransformationConfiguration[T any] struct {
	...
	ContentTransformation *AccessPoint_ContentTransformation[any] `json:"ContentTransformation"`
...
func (r *AccessPoint_TransformationConfiguration[any]) AWSCloudFormationType() string {
