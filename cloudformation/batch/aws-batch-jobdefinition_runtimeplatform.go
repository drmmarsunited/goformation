...
type JobDefinition_RuntimePlatform[T any] struct {
...
func (r *JobDefinition_RuntimePlatform[any]) AWSCloudFormationType() string {
	return "AWS::Batch::JobDefinition.RuntimePlatform"
}
