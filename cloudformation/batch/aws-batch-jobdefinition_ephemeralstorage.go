...
type JobDefinition_EphemeralStorage[T any] struct {
...
func (r *JobDefinition_EphemeralStorage[any]) AWSCloudFormationType() string {
	return "AWS::Batch::JobDefinition.EphemeralStorage"
}
