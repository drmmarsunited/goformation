...
// JobDefinition_HostPath AWS CloudFormation Resource (AWS::Batch::JobDefinition.HostPath)
...
type JobDefinition_HostPath struct {
...
func (r *JobDefinition_HostPath) AWSCloudFormationType() string {
	return "AWS::Batch::JobDefinition.HostPath"
}
