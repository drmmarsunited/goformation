...
type Certificate[T any] struct {
	...
	CACertificatePem *T `json:"CACertificatePem,omitempty"`
	...
	CertificatePem *T `json:"CertificatePem,omitempty"`
	...
	CertificateSigningRequest *T `json:"CertificateSigningRequest,omitempty"`
