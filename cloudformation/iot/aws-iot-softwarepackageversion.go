...
type SoftwarePackageVersion[T any] struct {
...
func (r *SoftwarePackageVersion[any]) AWSCloudFormationType() string {
	return "AWS::IoT::SoftwarePackageVersion"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r SoftwarePackageVersion[any]) MarshalJSON() ([]byte, error) {
	type Properties SoftwarePackageVersion[any]
...
func (r *SoftwarePackageVersion[any]) UnmarshalJSON(b []byte) error {
	type Properties SoftwarePackageVersion[any]
	...
	if res.Properties != nil {
		*r = SoftwarePackageVersion[any](*res.Properties)
	}
