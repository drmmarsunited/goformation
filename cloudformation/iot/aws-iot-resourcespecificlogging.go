...
type ResourceSpecificLogging[T any] struct {
...
func (r *ResourceSpecificLogging[any]) AWSCloudFormationType() string {
	return "AWS::IoT::ResourceSpecificLogging"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ResourceSpecificLogging[any]) MarshalJSON() ([]byte, error) {
	type Properties ResourceSpecificLogging[any]
...
func (r *ResourceSpecificLogging[any]) UnmarshalJSON(b []byte) error {
	type Properties ResourceSpecificLogging[any]
	...
	if res.Properties != nil {
		*r = ResourceSpecificLogging[any](*res.Properties)
	}
