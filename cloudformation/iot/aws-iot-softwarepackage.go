...
type SoftwarePackage[T any] struct {
	...
	PackageName *T `json:"PackageName,omitempty"`
...
func (r *SoftwarePackage[any]) AWSCloudFormationType() string {
	return "AWS::IoT::SoftwarePackage"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r SoftwarePackage[any]) MarshalJSON() ([]byte, error) {
	type Properties SoftwarePackage[any]
...
func (r *SoftwarePackage[any]) UnmarshalJSON(b []byte) error {
	type Properties SoftwarePackage[any]
	...
	if res.Properties != nil {
		*r = SoftwarePackage[any](*res.Properties)
	}
