...
type JobTemplate_RetryCriteria[T any] struct {
	...
	NumberOfRetries *T `json:"NumberOfRetries,omitempty"`
...
func (r *JobTemplate_RetryCriteria[any]) AWSCloudFormationType() string {
