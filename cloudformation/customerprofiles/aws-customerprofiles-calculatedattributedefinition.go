...
type CalculatedAttributeDefinition[T any] struct {
	...
	AttributeDetails *CalculatedAttributeDefinition_AttributeDetails[any] `json:"AttributeDetails"`
	...
	CalculatedAttributeName T `json:"CalculatedAttributeName"`
	...
	Conditions *CalculatedAttributeDefinition_Conditions[any] `json:"Conditions,omitempty"`
...
func (r *CalculatedAttributeDefinition[any]) AWSCloudFormationType() string {
	return "AWS::CustomerProfiles::CalculatedAttributeDefinition"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r CalculatedAttributeDefinition[any]) MarshalJSON() ([]byte, error) {
	type Properties CalculatedAttributeDefinition[any]
...
func (r *CalculatedAttributeDefinition[any]) UnmarshalJSON(b []byte) error {
	type Properties CalculatedAttributeDefinition[any]
	...
	if res.Properties != nil {
		*r = CalculatedAttributeDefinition[any](*res.Properties)
	}
