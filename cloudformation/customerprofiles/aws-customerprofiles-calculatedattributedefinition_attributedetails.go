...
type CalculatedAttributeDefinition_AttributeDetails[T any] struct {
	...
	Attributes []CalculatedAttributeDefinition_AttributeItem[any] `json:"Attributes"`
...
func (r *CalculatedAttributeDefinition_AttributeDetails[any]) AWSCloudFormationType() string {
