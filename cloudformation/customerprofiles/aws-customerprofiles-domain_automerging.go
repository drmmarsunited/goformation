...
type Domain_AutoMerging[T any] struct {
	...
	Consolidation *Domain_Consolidation[any] `json:"Consolidation,omitempty"`
	...
	MinAllowedConfidenceScoreForMerging *T `json:"MinAllowedConfidenceScoreForMerging,omitempty"`
...
func (r *Domain_AutoMerging[any]) AWSCloudFormationType() string {
