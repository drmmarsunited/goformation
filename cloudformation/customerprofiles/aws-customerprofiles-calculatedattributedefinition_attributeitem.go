...
// CalculatedAttributeDefinition_AttributeItem AWS CloudFormation Resource (AWS::CustomerProfiles::CalculatedAttributeDefinition.AttributeItem)
...
type CalculatedAttributeDefinition_AttributeItem[T any] struct {
...
func (r *CalculatedAttributeDefinition_AttributeItem[any]) AWSCloudFormationType() string {
	return "AWS::CustomerProfiles::CalculatedAttributeDefinition.AttributeItem"
}
