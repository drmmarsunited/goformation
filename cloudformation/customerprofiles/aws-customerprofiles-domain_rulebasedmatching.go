...
type Domain_RuleBasedMatching[T any] struct {
	...
	AttributeTypesSelector *Domain_AttributeTypesSelector[any] `json:"AttributeTypesSelector,omitempty"`
	...
	ConflictResolution *Domain_ConflictResolution[any] `json:"ConflictResolution,omitempty"`
	...
	MatchingRules []Domain_MatchingRule[any] `json:"MatchingRules,omitempty"`
	...
	MaxAllowedRuleLevelForMatching *T `json:"MaxAllowedRuleLevelForMatching,omitempty"`
	...
	MaxAllowedRuleLevelForMerging *T `json:"MaxAllowedRuleLevelForMerging,omitempty"`
...
func (r *Domain_RuleBasedMatching[any]) AWSCloudFormationType() string {
