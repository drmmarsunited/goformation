...
// EventStream AWS CloudFormation Resource (AWS::CustomerProfiles::EventStream)
...
func (r *EventStream[any]) AWSCloudFormationType() string {
	return "AWS::CustomerProfiles::EventStream"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r EventStream[any]) MarshalJSON() ([]byte, error) {
	type Properties EventStream[any]
...
func (r *EventStream[any]) UnmarshalJSON(b []byte) error {
	type Properties EventStream[any]
	...
	if res.Properties != nil {
		*r = EventStream[any](*res.Properties)
	}
