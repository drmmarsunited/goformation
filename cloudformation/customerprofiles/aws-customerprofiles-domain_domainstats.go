...
type Domain_DomainStats[T any] struct {
	...
	MeteringProfileCount *T `json:"MeteringProfileCount,omitempty"`
	...
	ProfileCount *T `json:"ProfileCount,omitempty"`
	...
	TotalSize *T `json:"TotalSize,omitempty"`
...
func (r *Domain_DomainStats[any]) AWSCloudFormationType() string {
