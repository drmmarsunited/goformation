...
// Domain_MatchingRule AWS CloudFormation Resource (AWS::CustomerProfiles::Domain.MatchingRule)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-customerprofiles-domain-matchingrule.html
type Domain_MatchingRule[T any] struct {
...
func (r *Domain_MatchingRule[any]) AWSCloudFormationType() string {
	return "AWS::CustomerProfiles::Domain.MatchingRule"
}
