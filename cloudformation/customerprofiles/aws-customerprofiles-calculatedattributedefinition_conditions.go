...
type CalculatedAttributeDefinition_Conditions[T any] struct {
	...
	ObjectCount *T `json:"ObjectCount,omitempty"`
	...
	Range *CalculatedAttributeDefinition_Range[any] `json:"Range,omitempty"`
	...
	Threshold *CalculatedAttributeDefinition_Threshold[any] `json:"Threshold,omitempty"`
...
func (r *CalculatedAttributeDefinition_Conditions[any]) AWSCloudFormationType() string {
