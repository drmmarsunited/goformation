...
// Domain_ConflictResolution AWS CloudFormation Resource (AWS::CustomerProfiles::Domain.ConflictResolution)
...
type Domain_ConflictResolution[T any] struct {

	// ConflictResolvingModel AWS CloudFormation Property
	// Required: true
	...
	ConflictResolvingModel T `json:"ConflictResolvingModel"`
	...
	SourceName *T `json:"SourceName,omitempty"`
...
func (r *Domain_ConflictResolution[any]) AWSCloudFormationType() string {
	return "AWS::CustomerProfiles::Domain.ConflictResolution"
}
