...
type DeploymentGroup_DeploymentReadyOption[T any] struct {
	...
	WaitTimeInMinutes *T `json:"WaitTimeInMinutes,omitempty"`
...
func (r *DeploymentGroup_DeploymentReadyOption[any]) AWSCloudFormationType() string {
