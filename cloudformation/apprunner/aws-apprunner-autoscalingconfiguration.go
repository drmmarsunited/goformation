...
// AutoScalingConfiguration AWS CloudFormation Resource (AWS::AppRunner::AutoScalingConfiguration)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apprunner-autoscalingconfiguration.html
type AutoScalingConfiguration[T any] struct {
...
func (r *AutoScalingConfiguration[any]) AWSCloudFormationType() string {
	return "AWS::AppRunner::AutoScalingConfiguration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AutoScalingConfiguration[any]) MarshalJSON() ([]byte, error) {
	type Properties AutoScalingConfiguration[any]
...
func (r *AutoScalingConfiguration[any]) UnmarshalJSON(b []byte) error {
	type Properties AutoScalingConfiguration[any]
	...
	if res.Properties != nil {
		*r = AutoScalingConfiguration[any](*res.Properties)
	}
