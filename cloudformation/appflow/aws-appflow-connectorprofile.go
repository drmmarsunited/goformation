...
type ConnectorProfile[T any] struct {
	...
	ConnectorProfileConfig *ConnectorProfile_ConnectorProfileConfig[any] `json:"ConnectorProfileConfig,omitempty"`
...
func (r *ConnectorProfile[any]) AWSCloudFormationType() string {
	return "AWS::AppFlow::ConnectorProfile"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ConnectorProfile[any]) MarshalJSON() ([]byte, error) {
	type Properties ConnectorProfile[any]
...
func (r *ConnectorProfile[any]) UnmarshalJSON(b []byte) error {
	type Properties ConnectorProfile[any]
	...
	if res.Properties != nil {
		*r = ConnectorProfile[any](*res.Properties)
	}
