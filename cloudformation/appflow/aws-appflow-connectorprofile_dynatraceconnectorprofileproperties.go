...
type ConnectorProfile_DynatraceConnectorProfileProperties[T any] struct {
...
func (r *ConnectorProfile_DynatraceConnectorProfileProperties[any]) AWSCloudFormationType() string {
