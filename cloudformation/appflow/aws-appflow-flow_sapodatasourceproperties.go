...
type Flow_SAPODataSourceProperties[T any] struct {
	...
	paginationConfig *Flow_SAPODataPaginationConfig[any] `json:"paginationConfig,omitempty"`
	...
	parallelismConfig *Flow_SAPODataParallelismConfig[any] `json:"parallelismConfig,omitempty"`
