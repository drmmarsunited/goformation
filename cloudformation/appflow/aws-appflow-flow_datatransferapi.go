...
// Flow_DataTransferApi AWS CloudFormation Resource (AWS::AppFlow::Flow.DataTransferApi)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appflow-flow-datatransferapi.html
type Flow_DataTransferApi[T any] struct {
...
func (r *Flow_DataTransferApi[any]) AWSCloudFormationType() string {
	return "AWS::AppFlow::Flow.DataTransferApi"
}
