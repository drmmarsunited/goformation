...
type ConnectorProfile_DatadogConnectorProfileProperties[T any] struct {
...
func (r *ConnectorProfile_DatadogConnectorProfileProperties[any]) AWSCloudFormationType() string {
