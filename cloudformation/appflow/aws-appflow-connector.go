...
// Connector AWS CloudFormation Resource (AWS::AppFlow::Connector)
...
type Connector[T any] struct {
	...
	ConnectorProvisioningConfig *Connector_ConnectorProvisioningConfig[any] `json:"ConnectorProvisioningConfig"`
