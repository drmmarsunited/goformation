...
type ClusterSubnetGroup[T any] struct {
...
func (r *ClusterSubnetGroup[any]) AWSCloudFormationType() string {
	return "AWS::Redshift::ClusterSubnetGroup"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ClusterSubnetGroup[any]) MarshalJSON() ([]byte, error) {
	type Properties ClusterSubnetGroup[any]
...
func (r *ClusterSubnetGroup[any]) UnmarshalJSON(b []byte) error {
	type Properties ClusterSubnetGroup[any]
	...
	if res.Properties != nil {
		*r = ClusterSubnetGroup[any](*res.Properties)
	}
