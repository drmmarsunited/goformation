...
type ScheduledAction_ScheduledActionType[T any] struct {
	...
	PauseCluster *ScheduledAction_PauseClusterMessage[any] `json:"PauseCluster,omitempty"`
	...
	ResizeCluster *ScheduledAction_ResizeClusterMessage[any] `json:"ResizeCluster,omitempty"`
	...
	ResumeCluster *ScheduledAction_ResumeClusterMessage[any] `json:"ResumeCluster,omitempty"`
...
func (r *ScheduledAction_ScheduledActionType[any]) AWSCloudFormationType() string {
