...
type Workspace[T any] struct {
	...
	NetworkAccessControl *Workspace_NetworkAccessControl[any] `json:"NetworkAccessControl,omitempty"`
	...
	SamlConfiguration *Workspace_SamlConfiguration[any] `json:"SamlConfiguration,omitempty"`
	...
	VpcConfiguration *Workspace_VpcConfiguration[any] `json:"VpcConfiguration,omitempty"`
