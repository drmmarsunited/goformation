...
// Domain AWS CloudFormation Resource (AWS::VoiceID::Domain)
...
type Domain[T any] struct {
	...
	ServerSideEncryptionConfiguration *Domain_ServerSideEncryptionConfiguration[any] `json:"ServerSideEncryptionConfiguration"`
