...
type AutoScalingGroup_NotificationConfiguration[T any] struct {
	...
	NotificationTypes []T `json:"NotificationTypes,omitempty"`
...
func (r *AutoScalingGroup_NotificationConfiguration[any]) AWSCloudFormationType() string {
