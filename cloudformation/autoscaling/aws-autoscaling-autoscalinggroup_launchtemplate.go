...
type AutoScalingGroup_LaunchTemplate[T any] struct {
	...
	LaunchTemplateSpecification *AutoScalingGroup_LaunchTemplateSpecification[any] `json:"LaunchTemplateSpecification"`
	...
	Overrides []AutoScalingGroup_LaunchTemplateOverrides[any] `json:"Overrides,omitempty"`
...
func (r *AutoScalingGroup_LaunchTemplate[any]) AWSCloudFormationType() string {
