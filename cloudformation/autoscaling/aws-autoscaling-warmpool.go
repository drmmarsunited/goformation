...
type WarmPool[T any] struct {
	...
	InstanceReusePolicy *WarmPool_InstanceReusePolicy[any] `json:"InstanceReusePolicy,omitempty"`
	...
	MaxGroupPreparedCapacity *T `json:"MaxGroupPreparedCapacity,omitempty"`
...
func (r *WarmPool[any]) AWSCloudFormationType() string {
	return "AWS::AutoScaling::WarmPool"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r WarmPool[any]) MarshalJSON() ([]byte, error) {
	type Properties WarmPool[any]
...
func (r *WarmPool[any]) UnmarshalJSON(b []byte) error {
	type Properties WarmPool[any]
