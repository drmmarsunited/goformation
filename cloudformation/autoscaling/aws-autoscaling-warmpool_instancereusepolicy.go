...
type WarmPool_InstanceReusePolicy[T any] struct {
	...
	ReuseOnScaleIn *T `json:"ReuseOnScaleIn,omitempty"`
...
func (r *WarmPool_InstanceReusePolicy[any]) AWSCloudFormationType() string {
