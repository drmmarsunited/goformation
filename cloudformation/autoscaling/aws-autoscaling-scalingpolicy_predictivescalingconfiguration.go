...
type ScalingPolicy_PredictiveScalingConfiguration[T any] struct {
	...
	MaxCapacityBuffer *T `json:"MaxCapacityBuffer,omitempty"`
	...
	MetricSpecifications []ScalingPolicy_PredictiveScalingMetricSpecification[any] `json:"MetricSpecifications"`
	...
	SchedulingBufferTime *T `json:"SchedulingBufferTime,omitempty"`
...
func (r *ScalingPolicy_PredictiveScalingConfiguration[any]) AWSCloudFormationType() string {
