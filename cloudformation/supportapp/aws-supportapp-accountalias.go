...
func (r *AccountAlias[any]) AWSCloudFormationType() string {
	return "AWS::SupportApp::AccountAlias"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AccountAlias[any]) MarshalJSON() ([]byte, error) {
	type Properties AccountAlias[any]
...
func (r *AccountAlias[any]) UnmarshalJSON(b []byte) error {
	type Properties AccountAlias[any]
	...
	if res.Properties != nil {
		*r = AccountAlias[any](*res.Properties)
	}
