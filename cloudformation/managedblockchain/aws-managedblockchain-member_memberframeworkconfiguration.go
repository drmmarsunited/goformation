...
type Member_MemberFrameworkConfiguration[T any] struct {
	...
	MemberFabricConfiguration *Member_MemberFabricConfiguration[any] `json:"MemberFabricConfiguration,omitempty"`
...
func (r *Member_MemberFrameworkConfiguration[any]) AWSCloudFormationType() string {
