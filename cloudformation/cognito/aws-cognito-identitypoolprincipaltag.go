...
// IdentityPoolPrincipalTag AWS CloudFormation Resource (AWS::Cognito::IdentityPoolPrincipalTag)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cognito-identitypoolprincipaltag.html
type IdentityPoolPrincipalTag[T any] struct {
	...
	PrincipalTags interface{} `json:"PrincipalTags,omitempty"`

	// UseDefaults AWS CloudFormation Property
	// Required: false
	...
	UseDefaults *T `json:"UseDefaults,omitempty"`
...
func (r *IdentityPoolPrincipalTag[any]) AWSCloudFormationType() string {
	return "AWS::Cognito::IdentityPoolPrincipalTag"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r IdentityPoolPrincipalTag[any]) MarshalJSON() ([]byte, error) {
	type Properties IdentityPoolPrincipalTag[any]
...
func (r *IdentityPoolPrincipalTag[any]) UnmarshalJSON(b []byte) error {
	type Properties IdentityPoolPrincipalTag[any]
	...
	if res.Properties != nil {
		*r = IdentityPoolPrincipalTag[any](*res.Properties)
	}
