...
type UserPoolUser[T any] struct {
	...
	ClientMetadata map[string]T `json:"ClientMetadata,omitempty"`
	...
	DesiredDeliveryMediums []T `json:"DesiredDeliveryMediums,omitempty"`
	...
	MessageAction *T `json:"MessageAction,omitempty"`
