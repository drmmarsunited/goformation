...
type UserPool_PasswordPolicy[T any] struct {
	...
	MinimumLength *T `json:"MinimumLength,omitempty"`
	...
	RequireLowercase *T `json:"RequireLowercase,omitempty"`
	...
	RequireNumbers *T `json:"RequireNumbers,omitempty"`
	...
	RequireSymbols *T `json:"RequireSymbols,omitempty"`
	...
	RequireUppercase *T `json:"RequireUppercase,omitempty"`
	...
	TemporaryPasswordValidityDays *T `json:"TemporaryPasswordValidityDays,omitempty"`
...
func (r *UserPool_PasswordPolicy[any]) AWSCloudFormationType() string {
