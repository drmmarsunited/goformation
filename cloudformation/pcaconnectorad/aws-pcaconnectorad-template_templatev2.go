...
type Template_TemplateV2[T any] struct {
	...
	EnrollmentFlags *Template_EnrollmentFlagsV2[any] `json:"EnrollmentFlags"`
	...
	Extensions *Template_ExtensionsV2[any] `json:"Extensions"`
	...
	GeneralFlags *Template_GeneralFlagsV2[any] `json:"GeneralFlags"`
	...
	PrivateKeyAttributes *Template_PrivateKeyAttributesV2[any] `json:"PrivateKeyAttributes"`
	...
	PrivateKeyFlags *Template_PrivateKeyFlagsV2[any] `json:"PrivateKeyFlags"`
	...
	SubjectNameFlags *Template_SubjectNameFlagsV2[any] `json:"SubjectNameFlags"`
...
func (r *Template_TemplateV2[any]) AWSCloudFormationType() string {
