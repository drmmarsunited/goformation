...
// Template_CertificateValidity AWS CloudFormation Resource (AWS::PCAConnectorAD::Template.CertificateValidity)
...
type Template_CertificateValidity[T any] struct {

	// RenewalPeriod AWS CloudFormation Property
	// Required: true
	...
	RenewalPeriod *Template_ValidityPeriod[any] `json:"RenewalPeriod"`

	// ValidityPeriod AWS CloudFormation Property
	// Required: true
	...
	ValidityPeriod *Template_ValidityPeriod[any] `json:"ValidityPeriod"`
...
func (r *Template_CertificateValidity[any]) AWSCloudFormationType() string {
	return "AWS::PCAConnectorAD::Template.CertificateValidity"
}
