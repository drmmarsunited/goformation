...
type Template_ApplicationPolicies[T any] struct {
	...
	Policies []Template_ApplicationPolicy[any] `json:"Policies"`
...
func (r *Template_ApplicationPolicies[any]) AWSCloudFormationType() string {
