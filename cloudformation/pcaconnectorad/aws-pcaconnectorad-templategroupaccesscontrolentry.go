...
type TemplateGroupAccessControlEntry[T any] struct {
	...
	AccessRights *TemplateGroupAccessControlEntry_AccessRights[any] `json:"AccessRights"`
	...
	GroupDisplayName T `json:"GroupDisplayName"`
	...
	GroupSecurityIdentifier *T `json:"GroupSecurityIdentifier,omitempty"`
...
func (r *TemplateGroupAccessControlEntry[any]) AWSCloudFormationType() string {
	return "AWS::PCAConnectorAD::TemplateGroupAccessControlEntry"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r TemplateGroupAccessControlEntry[any]) MarshalJSON() ([]byte, error) {
	type Properties TemplateGroupAccessControlEntry[any]
...
func (r *TemplateGroupAccessControlEntry[any]) UnmarshalJSON(b []byte) error {
	type Properties TemplateGroupAccessControlEntry[any]
	...
	if res.Properties != nil {
		*r = TemplateGroupAccessControlEntry[any](*res.Properties)
	}
