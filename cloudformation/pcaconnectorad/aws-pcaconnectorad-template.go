...
// Template AWS CloudFormation Resource (AWS::PCAConnectorAD::Template)
...
type Template[T any] struct {
	...
	Definition *Template_TemplateDefinition[any] `json:"Definition"`
	...
	// ReenrollAllCertificateHolders AWS CloudFormation Property
	// Required: false
	...
	ReenrollAllCertificateHolders *T `json:"ReenrollAllCertificateHolders,omitempty"`
