...
type ServicePrincipalName[T any] struct {
...
func (r *ServicePrincipalName[any]) AWSCloudFormationType() string {
	return "AWS::PCAConnectorAD::ServicePrincipalName"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ServicePrincipalName[any]) MarshalJSON() ([]byte, error) {
	type Properties ServicePrincipalName[any]
...
func (r *ServicePrincipalName[any]) UnmarshalJSON(b []byte) error {
	type Properties ServicePrincipalName[any]
	...
	if res.Properties != nil {
		*r = ServicePrincipalName[any](*res.Properties)
	}
