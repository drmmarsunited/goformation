...
// DirectoryRegistration AWS CloudFormation Resource (AWS::PCAConnectorAD::DirectoryRegistration)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pcaconnectorad-directoryregistration.html
type DirectoryRegistration[T any] struct {
...
func (r *DirectoryRegistration[any]) AWSCloudFormationType() string {
	return "AWS::PCAConnectorAD::DirectoryRegistration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DirectoryRegistration[any]) MarshalJSON() ([]byte, error) {
	type Properties DirectoryRegistration[any]
...
func (r *DirectoryRegistration[any]) UnmarshalJSON(b []byte) error {
	type Properties DirectoryRegistration[any]
	...
	if res.Properties != nil {
		*r = DirectoryRegistration[any](*res.Properties)
	}
