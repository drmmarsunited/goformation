...
type Template_GeneralFlagsV4[T any] struct {
	...
	AutoEnrollment *T `json:"AutoEnrollment,omitempty"`
	...
	MachineType *T `json:"MachineType,omitempty"`
...
func (r *Template_GeneralFlagsV4[any]) AWSCloudFormationType() string {
