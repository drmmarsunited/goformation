...
// Template_ExtensionsV3 AWS CloudFormation Resource (AWS::PCAConnectorAD::Template.ExtensionsV3)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pcaconnectorad-template-extensionsv3.html
type Template_ExtensionsV3[T any] struct {
	...
	ApplicationPolicies *Template_ApplicationPolicies[any] `json:"ApplicationPolicies,omitempty"`
	...
	KeyUsage *Template_KeyUsage[any] `json:"KeyUsage"`
...
func (r *Template_ExtensionsV3[any]) AWSCloudFormationType() string {
	return "AWS::PCAConnectorAD::Template.ExtensionsV3"
}
