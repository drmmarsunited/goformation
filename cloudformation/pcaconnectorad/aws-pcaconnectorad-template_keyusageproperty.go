...
type Template_KeyUsageProperty[T any] struct {
	...
	PropertyFlags *Template_KeyUsagePropertyFlags[any] `json:"PropertyFlags,omitempty"`
...
func (r *Template_KeyUsageProperty[any]) AWSCloudFormationType() string {
