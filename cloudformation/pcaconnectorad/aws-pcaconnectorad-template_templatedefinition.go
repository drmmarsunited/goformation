...
type Template_TemplateDefinition[T any] struct {
	...
	TemplateV2 *Template_TemplateV2[any] `json:"TemplateV2,omitempty"`
	...
	TemplateV3 *Template_TemplateV3[any] `json:"TemplateV3,omitempty"`
	...
	TemplateV4 *Template_TemplateV4[any] `json:"TemplateV4,omitempty"`
...
func (r *Template_TemplateDefinition[any]) AWSCloudFormationType() string {
