...
func (r *IntegrationResponse[any]) AWSCloudFormationType() string {
	return "AWS::ApiGatewayV2::IntegrationResponse"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r IntegrationResponse[any]) MarshalJSON() ([]byte, error) {
	type Properties IntegrationResponse[any]
...
func (r *IntegrationResponse[any]) UnmarshalJSON(b []byte) error {
	type Properties IntegrationResponse[any]
	...
	if res.Properties != nil {
		*r = IntegrationResponse[any](*res.Properties)
	}
