...
type DocumentClassifier_AugmentedManifestsListItem[T any] struct {
	...
	AttributeNames []T `json:"AttributeNames"`
...
func (r *DocumentClassifier_AugmentedManifestsListItem[any]) AWSCloudFormationType() string {
