...
type DocumentClassifier[T any] struct {
	...
	InputDataConfig *DocumentClassifier_DocumentClassifierInputDataConfig[any] `json:"InputDataConfig"`
	...
	OutputDataConfig *DocumentClassifier_DocumentClassifierOutputDataConfig[any] `json:"OutputDataConfig,omitempty"`
	...
	VpcConfig *DocumentClassifier_VpcConfig[any] `json:"VpcConfig,omitempty"`
...
func (r *DocumentClassifier[any]) AWSCloudFormationType() string {
	return "AWS::Comprehend::DocumentClassifier"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DocumentClassifier[any]) MarshalJSON() ([]byte, error) {
	type Properties DocumentClassifier[any]
...
func (r *DocumentClassifier[any]) UnmarshalJSON(b []byte) error {
	type Properties DocumentClassifier[any]
	...
	if res.Properties != nil {
		*r = DocumentClassifier[any](*res.Properties)
	}
