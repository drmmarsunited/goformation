...
type DocumentClassifier_DocumentClassifierOutputDataConfig[T any] struct {
...
func (r *DocumentClassifier_DocumentClassifierOutputDataConfig[any]) AWSCloudFormationType() string {
