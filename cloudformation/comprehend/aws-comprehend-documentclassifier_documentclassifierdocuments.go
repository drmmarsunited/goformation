...
type DocumentClassifier_DocumentClassifierDocuments[T any] struct {
...
func (r *DocumentClassifier_DocumentClassifierDocuments[any]) AWSCloudFormationType() string {
