...
type Channel_HlsSettings[T any] struct {
	...
	AudioOnlyHlsSettings *Channel_AudioOnlyHlsSettings[any] `json:"AudioOnlyHlsSettings,omitempty"`
	...
	Fmp4HlsSettings *Channel_Fmp4HlsSettings[any] `json:"Fmp4HlsSettings,omitempty"`
	...
	FrameCaptureHlsSettings *Channel_FrameCaptureHlsSettings[any] `json:"FrameCaptureHlsSettings,omitempty"`
	...
	StandardHlsSettings *Channel_StandardHlsSettings[any] `json:"StandardHlsSettings,omitempty"`
...
func (r *Channel_HlsSettings[any]) AWSCloudFormationType() string {
