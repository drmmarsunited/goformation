...
type Channel_AudioLanguageSelection[T any] struct {
	...
	LanguageSelectionPolicy *T `json:"LanguageSelectionPolicy,omitempty"`
...
func (r *Channel_AudioLanguageSelection[any]) AWSCloudFormationType() string {
