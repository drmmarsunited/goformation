...
// Multiplex AWS CloudFormation Resource (AWS::MediaLive::Multiplex)
...
type Multiplex[T any] struct {
	...
	AvailabilityZones []T `json:"AvailabilityZones"`
	...
	Destinations []Multiplex_MultiplexOutputDestination[any] `json:"Destinations,omitempty"`
	...
	MultiplexSettings *Multiplex_MultiplexSettings[any] `json:"MultiplexSettings"`
	...
	Tags []Multiplex_Tags[any] `json:"Tags,omitempty"`
...
func (r *Multiplex[any]) AWSCloudFormationType() string {
	return "AWS::MediaLive::Multiplex"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Multiplex[any]) MarshalJSON() ([]byte, error) {
	type Properties Multiplex[any]
...
func (r *Multiplex[any]) UnmarshalJSON(b []byte) error {
	type Properties Multiplex[any]
	...
	if res.Properties != nil {
		*r = Multiplex[any](*res.Properties)
	}
