...
type Multiplex_MultiplexMediaConnectOutputDestinationSettings[T any] struct {
...
func (r *Multiplex_MultiplexMediaConnectOutputDestinationSettings[any]) AWSCloudFormationType() string {
