...
type Channel_VideoSelectorProgramId[T any] struct {
	...
	ProgramId *T `json:"ProgramId,omitempty"`
...
func (r *Channel_VideoSelectorProgramId[any]) AWSCloudFormationType() string {
