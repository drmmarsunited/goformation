...
type Multiplexprogram_MultiplexProgramServiceDescriptor[T any] struct {
...
func (r *Multiplexprogram_MultiplexProgramServiceDescriptor[any]) AWSCloudFormationType() string {
