...
type Channel_AvailBlanking[T any] struct {
	...
	AvailBlankingImage *Channel_InputLocation[any] `json:"AvailBlankingImage,omitempty"`
...
func (r *Channel_AvailBlanking[any]) AWSCloudFormationType() string {
