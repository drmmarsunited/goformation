...
type Multiplexprogram[T any] struct {
	...
	MultiplexId *T `json:"MultiplexId,omitempty"`
	...
	MultiplexProgramSettings *Multiplexprogram_MultiplexProgramSettings[any] `json:"MultiplexProgramSettings,omitempty"`
	...
	PacketIdentifiersMap *Multiplexprogram_MultiplexProgramPacketIdentifiersMap[any] `json:"PacketIdentifiersMap,omitempty"`
	...
	PipelineDetails []Multiplexprogram_MultiplexProgramPipelineDetail[any] `json:"PipelineDetails,omitempty"`
	...
	ProgramName *T `json:"ProgramName,omitempty"`
...
func (r *Multiplexprogram[any]) AWSCloudFormationType() string {
	return "AWS::MediaLive::Multiplexprogram"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Multiplexprogram[any]) MarshalJSON() ([]byte, error) {
	type Properties Multiplexprogram[any]
...
func (r *Multiplexprogram[any]) UnmarshalJSON(b []byte) error {
	type Properties Multiplexprogram[any]
	...
	if res.Properties != nil {
		*r = Multiplexprogram[any](*res.Properties)
	}
