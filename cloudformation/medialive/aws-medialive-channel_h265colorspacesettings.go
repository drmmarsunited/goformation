...
type Channel_H265ColorSpaceSettings[T any] struct {
	...
	DolbyVision81Settings *Channel_DolbyVision81Settings[any] `json:"DolbyVision81Settings,omitempty"`
...
func (r *Channel_H265ColorSpaceSettings[any]) AWSCloudFormationType() string {
