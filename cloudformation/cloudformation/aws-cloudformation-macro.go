...
type Macro[T any] struct {
	...
	LogRoleARN *T `json:"LogRoleARN,omitempty"`
...
func (r *Macro[any]) AWSCloudFormationType() string {
	return "AWS::CloudFormation::Macro"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Macro[any]) MarshalJSON() ([]byte, error) {
	type Properties Macro[any]
...
func (r *Macro[any]) UnmarshalJSON(b []byte) error {
	type Properties Macro[any]
