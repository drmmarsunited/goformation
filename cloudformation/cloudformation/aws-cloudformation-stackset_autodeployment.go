...
type StackSet_AutoDeployment[T any] struct {
	...
	RetainStacksOnAccountRemoval *T `json:"RetainStacksOnAccountRemoval,omitempty"`
...
func (r *StackSet_AutoDeployment[any]) AWSCloudFormationType() string {
