...
type LaunchRoleConstraint[T any] struct {
	...
	LocalRoleName *T `json:"LocalRoleName,omitempty"`
...
func (r *LaunchRoleConstraint[any]) AWSCloudFormationType() string {
	return "AWS::ServiceCatalog::LaunchRoleConstraint"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LaunchRoleConstraint[any]) MarshalJSON() ([]byte, error) {
	type Properties LaunchRoleConstraint[any]
...
func (r *LaunchRoleConstraint[any]) UnmarshalJSON(b []byte) error {
	type Properties LaunchRoleConstraint[any]
	...
	if res.Properties != nil {
		*r = LaunchRoleConstraint[any](*res.Properties)
	}
