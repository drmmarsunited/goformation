...
type ServiceActionAssociation[T any] struct {
	...
	ProvisioningArtifactId T `json:"ProvisioningArtifactId"`
	...
	ServiceActionId T `json:"ServiceActionId"`
...
func (r *ServiceActionAssociation[any]) AWSCloudFormationType() string {
	return "AWS::ServiceCatalog::ServiceActionAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ServiceActionAssociation[any]) MarshalJSON() ([]byte, error) {
	type Properties ServiceActionAssociation[any]
...
func (r *ServiceActionAssociation[any]) UnmarshalJSON(b []byte) error {
	type Properties ServiceActionAssociation[any]
	...
	if res.Properties != nil {
		*r = ServiceActionAssociation[any](*res.Properties)
	}
