...
type PortfolioProductAssociation[T any] struct {
	...
	SourcePortfolioId *T `json:"SourcePortfolioId,omitempty"`
...
func (r *PortfolioProductAssociation[any]) AWSCloudFormationType() string {
	return "AWS::ServiceCatalog::PortfolioProductAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r PortfolioProductAssociation[any]) MarshalJSON() ([]byte, error) {
	type Properties PortfolioProductAssociation[any]
...
func (r *PortfolioProductAssociation[any]) UnmarshalJSON(b []byte) error {
	type Properties PortfolioProductAssociation[any]
	...
	if res.Properties != nil {
		*r = PortfolioProductAssociation[any](*res.Properties)
	}
