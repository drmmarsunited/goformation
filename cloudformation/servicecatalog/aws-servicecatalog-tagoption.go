...
func (r *TagOption[any]) AWSCloudFormationType() string {
	return "AWS::ServiceCatalog::TagOption"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r TagOption[any]) MarshalJSON() ([]byte, error) {
	type Properties TagOption[any]
...
func (r *TagOption[any]) UnmarshalJSON(b []byte) error {
	type Properties TagOption[any]
	...
	if res.Properties != nil {
		*r = TagOption[any](*res.Properties)
	}
