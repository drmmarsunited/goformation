...
type PortfolioPrincipalAssociation[T any] struct {
	...
	AcceptLanguage *T `json:"AcceptLanguage,omitempty"`
	...
	PortfolioId T `json:"PortfolioId"`
	...
	PrincipalARN T `json:"PrincipalARN"`
	...
	PrincipalType T `json:"PrincipalType"`
...
func (r *PortfolioPrincipalAssociation[any]) AWSCloudFormationType() string {
	return "AWS::ServiceCatalog::PortfolioPrincipalAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r PortfolioPrincipalAssociation[any]) MarshalJSON() ([]byte, error) {
	type Properties PortfolioPrincipalAssociation[any]
...
func (r *PortfolioPrincipalAssociation[any]) UnmarshalJSON(b []byte) error {
	type Properties PortfolioPrincipalAssociation[any]
	...
	if res.Properties != nil {
		*r = PortfolioPrincipalAssociation[any](*res.Properties)
	}
