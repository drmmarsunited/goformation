...
func (r *ExecutionPlan) AWSCloudFormationType() string {
...
func (r *ExecutionPlan) UnmarshalJSON(b []byte) error {
	type Properties ExecutionPlan
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ExecutionPlan(*res.Properties)
	}
