...
type OptionGroup[T any] struct {
	...
	MajorEngineVersion T `json:"MajorEngineVersion"`
	...
	OptionConfigurations []OptionGroup_OptionConfiguration[any] `json:"OptionConfigurations,omitempty"`
	...
	OptionGroupDescription T `json:"OptionGroupDescription"`
...
func (r *OptionGroup[any]) AWSCloudFormationType() string {
	return "AWS::RDS::OptionGroup"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r OptionGroup[any]) MarshalJSON() ([]byte, error) {
	type Properties OptionGroup[any]
...
func (r *OptionGroup[any]) UnmarshalJSON(b []byte) error {
	type Properties OptionGroup[any]
	...
	if res.Properties != nil {
		*r = OptionGroup[any](*res.Properties)
	}
