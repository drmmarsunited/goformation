...
type DBParameterGroup[T any] struct {
...
func (r *DBParameterGroup[any]) AWSCloudFormationType() string {
	return "AWS::RDS::DBParameterGroup"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DBParameterGroup[any]) MarshalJSON() ([]byte, error) {
	type Properties DBParameterGroup[any]
...
func (r *DBParameterGroup[any]) UnmarshalJSON(b []byte) error {
	type Properties DBParameterGroup[any]
	...
	if res.Properties != nil {
		*r = DBParameterGroup[any](*res.Properties)
	}
