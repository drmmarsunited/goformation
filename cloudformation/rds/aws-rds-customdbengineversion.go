...
type CustomDBEngineVersion[T any] struct {
...
func (r *CustomDBEngineVersion[any]) AWSCloudFormationType() string {
	return "AWS::RDS::CustomDBEngineVersion"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r CustomDBEngineVersion[any]) MarshalJSON() ([]byte, error) {
	type Properties CustomDBEngineVersion[any]
...
func (r *CustomDBEngineVersion[any]) UnmarshalJSON(b []byte) error {
	type Properties CustomDBEngineVersion[any]
	...
	if res.Properties != nil {
		*r = CustomDBEngineVersion[any](*res.Properties)
	}
