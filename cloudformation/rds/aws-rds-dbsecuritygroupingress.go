...
type DBSecurityGroupIngress[T any] struct {
	...
	CIDRIP *T `json:"CIDRIP,omitempty"`
	...
	DBSecurityGroupName T `json:"DBSecurityGroupName"`
	...
	EC2SecurityGroupId *T `json:"EC2SecurityGroupId,omitempty"`
	...
	EC2SecurityGroupName *T `json:"EC2SecurityGroupName,omitempty"`
	...
	EC2SecurityGroupOwnerId *T `json:"EC2SecurityGroupOwnerId,omitempty"`
...
func (r *DBSecurityGroupIngress[any]) AWSCloudFormationType() string {
	return "AWS::RDS::DBSecurityGroupIngress"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DBSecurityGroupIngress[any]) MarshalJSON() ([]byte, error) {
	type Properties DBSecurityGroupIngress[any]
...
func (r *DBSecurityGroupIngress[any]) UnmarshalJSON(b []byte) error {
	type Properties DBSecurityGroupIngress[any]
	...
	if res.Properties != nil {
		*r = DBSecurityGroupIngress[any](*res.Properties)
	}
