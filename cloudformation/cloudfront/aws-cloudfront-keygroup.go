...
type KeyGroup[T any] struct {
	...
	KeyGroupConfig *KeyGroup_KeyGroupConfig[any] `json:"KeyGroupConfig"`
...
func (r *KeyGroup[any]) AWSCloudFormationType() string {
	return "AWS::CloudFront::KeyGroup"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r KeyGroup[any]) MarshalJSON() ([]byte, error) {
	type Properties KeyGroup[any]
...
func (r *KeyGroup[any]) UnmarshalJSON(b []byte) error {
	type Properties KeyGroup[any]
