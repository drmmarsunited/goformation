...
type MonitoringSubscription struct {
	...
	MonitoringSubscription *MonitoringSubscription_MonitoringSubscription `json:"MonitoringSubscription"`
...
func (r *MonitoringSubscription) AWSCloudFormationType() string {
	return "AWS::CloudFront::MonitoringSubscription"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r MonitoringSubscription) MarshalJSON() ([]byte, error) {
	type Properties MonitoringSubscription
...
func (r *MonitoringSubscription) UnmarshalJSON(b []byte) error {
	type Properties MonitoringSubscription
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = MonitoringSubscription(*res.Properties)
	}
