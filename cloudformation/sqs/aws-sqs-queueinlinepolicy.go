...
// QueueInlinePolicy AWS CloudFormation Resource (AWS::SQS::QueueInlinePolicy)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sqs-queueinlinepolicy.html
type QueueInlinePolicy[T any] struct {
...
func (r *QueueInlinePolicy[any]) AWSCloudFormationType() string {
	return "AWS::SQS::QueueInlinePolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r QueueInlinePolicy[any]) MarshalJSON() ([]byte, error) {
	type Properties QueueInlinePolicy[any]
...
func (r *QueueInlinePolicy[any]) UnmarshalJSON(b []byte) error {
	type Properties QueueInlinePolicy[any]
	...
	if res.Properties != nil {
		*r = QueueInlinePolicy[any](*res.Properties)
	}
