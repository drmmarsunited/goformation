...
type IdMappingWorkflow_ProviderProperties[T any] struct {
	...
	IntermediateSourceConfiguration *IdMappingWorkflow_IntermediateSourceConfiguration[any] `json:"IntermediateSourceConfiguration,omitempty"`
...
func (r *IdMappingWorkflow_ProviderProperties[any]) AWSCloudFormationType() string {
