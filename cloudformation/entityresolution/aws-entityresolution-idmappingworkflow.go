...
type IdMappingWorkflow[T any] struct {
	...
	IdMappingTechniques *IdMappingWorkflow_IdMappingTechniques[any] `json:"IdMappingTechniques"`
	...
	InputSourceConfig []IdMappingWorkflow_IdMappingWorkflowInputSource[any] `json:"InputSourceConfig"`
	...
	OutputSourceConfig []IdMappingWorkflow_IdMappingWorkflowOutputSource[any] `json:"OutputSourceConfig"`
	...
	WorkflowName T `json:"WorkflowName"`
...
func (r *IdMappingWorkflow[any]) AWSCloudFormationType() string {
	return "AWS::EntityResolution::IdMappingWorkflow"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r IdMappingWorkflow[any]) MarshalJSON() ([]byte, error) {
	type Properties IdMappingWorkflow[any]
...
func (r *IdMappingWorkflow[any]) UnmarshalJSON(b []byte) error {
	type Properties IdMappingWorkflow[any]
	...
	if res.Properties != nil {
		*r = IdMappingWorkflow[any](*res.Properties)
	}
