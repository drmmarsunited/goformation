...
type SchemaMapping[T any] struct {
	...
	MappedInputFields []SchemaMapping_SchemaInputAttribute[any] `json:"MappedInputFields"`
...
func (r *SchemaMapping[any]) AWSCloudFormationType() string {
	return "AWS::EntityResolution::SchemaMapping"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r SchemaMapping[any]) MarshalJSON() ([]byte, error) {
	type Properties SchemaMapping[any]
...
func (r *SchemaMapping[any]) UnmarshalJSON(b []byte) error {
	type Properties SchemaMapping[any]
	...
	if res.Properties != nil {
		*r = SchemaMapping[any](*res.Properties)
	}
