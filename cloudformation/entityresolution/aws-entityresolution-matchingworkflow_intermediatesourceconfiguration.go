...
type MatchingWorkflow_IntermediateSourceConfiguration[T any] struct {
...
func (r *MatchingWorkflow_IntermediateSourceConfiguration[any]) AWSCloudFormationType() string {
