...
type SchemaMapping_SchemaInputAttribute[T any] struct {
	...
	MatchKey *T `json:"MatchKey,omitempty"`
	...
	SubType *T `json:"SubType,omitempty"`
...
func (r *SchemaMapping_SchemaInputAttribute[any]) AWSCloudFormationType() string {
