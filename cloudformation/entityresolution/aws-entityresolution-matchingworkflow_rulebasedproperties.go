...
type MatchingWorkflow_RuleBasedProperties[T any] struct {
	...
	Rules []MatchingWorkflow_Rule[any] `json:"Rules"`
...
func (r *MatchingWorkflow_RuleBasedProperties[any]) AWSCloudFormationType() string {
