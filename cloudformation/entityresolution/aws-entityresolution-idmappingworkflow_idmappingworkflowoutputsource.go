...
type IdMappingWorkflow_IdMappingWorkflowOutputSource[T any] struct {
...
func (r *IdMappingWorkflow_IdMappingWorkflowOutputSource[any]) AWSCloudFormationType() string {
