...
type IdMappingWorkflow_IntermediateSourceConfiguration[T any] struct {
	...
	IntermediateS3Path T `json:"IntermediateS3Path"`
...
func (r *IdMappingWorkflow_IntermediateSourceConfiguration[any]) AWSCloudFormationType() string {
