...
type MatchingWorkflow_OutputAttribute[T any] struct {
	...
	Hashed *T `json:"Hashed,omitempty"`
...
func (r *MatchingWorkflow_OutputAttribute[any]) AWSCloudFormationType() string {
