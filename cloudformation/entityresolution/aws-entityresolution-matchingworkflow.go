...
type MatchingWorkflow[T any] struct {
	...
	InputSourceConfig []MatchingWorkflow_InputSource[any] `json:"InputSourceConfig"`
	...
	OutputSourceConfig []MatchingWorkflow_OutputSource[any] `json:"OutputSourceConfig"`
	...
	ResolutionTechniques *MatchingWorkflow_ResolutionTechniques[any] `json:"ResolutionTechniques"`
...
func (r *MatchingWorkflow[any]) AWSCloudFormationType() string {
	return "AWS::EntityResolution::MatchingWorkflow"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r MatchingWorkflow[any]) MarshalJSON() ([]byte, error) {
	type Properties MatchingWorkflow[any]
...
func (r *MatchingWorkflow[any]) UnmarshalJSON(b []byte) error {
	type Properties MatchingWorkflow[any]
	...
	if res.Properties != nil {
		*r = MatchingWorkflow[any](*res.Properties)
	}
