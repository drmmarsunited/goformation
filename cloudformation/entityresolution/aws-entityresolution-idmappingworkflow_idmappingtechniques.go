...
type IdMappingWorkflow_IdMappingTechniques[T any] struct {
	...
	IdMappingType *T `json:"IdMappingType,omitempty"`
	...
	ProviderProperties *IdMappingWorkflow_ProviderProperties[any] `json:"ProviderProperties,omitempty"`
...
func (r *IdMappingWorkflow_IdMappingTechniques[any]) AWSCloudFormationType() string {
