...
type Analyzer[T any] struct {
	...
	ArchiveRules []Analyzer_ArchiveRule[any] `json:"ArchiveRules,omitempty"`
...
func (r *Analyzer[any]) AWSCloudFormationType() string {
	return "AWS::AccessAnalyzer::Analyzer"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Analyzer[any]) MarshalJSON() ([]byte, error) {
	type Properties Analyzer[any]
...
func (r *Analyzer[any]) UnmarshalJSON(b []byte) error {
	type Properties Analyzer[any]
