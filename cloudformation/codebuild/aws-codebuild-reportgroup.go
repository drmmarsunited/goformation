...
type ReportGroup[T any] struct {
	...
	DeleteReports *T `json:"DeleteReports,omitempty"`
	...
	ExportConfig *ReportGroup_ReportExportConfig[any] `json:"ExportConfig"`
...
func (r *ReportGroup[any]) AWSCloudFormationType() string {
	return "AWS::CodeBuild::ReportGroup"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ReportGroup[any]) MarshalJSON() ([]byte, error) {
	type Properties ReportGroup[any]
...
func (r *ReportGroup[any]) UnmarshalJSON(b []byte) error {
	type Properties ReportGroup[any]
	...
	if res.Properties != nil {
		*r = ReportGroup[any](*res.Properties)
	}
