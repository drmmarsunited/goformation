...
type App[T any] struct {
	...
	EventSubscriptions []App_EventSubscription[any] `json:"EventSubscriptions,omitempty"`
	...
	PermissionModel *App_PermissionModel[any] `json:"PermissionModel,omitempty"`
	...
	ResourceMappings []App_ResourceMapping[any] `json:"ResourceMappings"`
