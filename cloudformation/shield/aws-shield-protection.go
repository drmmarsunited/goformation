...
// Protection AWS CloudFormation Resource (AWS::Shield::Protection)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-shield-protection.html
type Protection[T any] struct {

	// ApplicationLayerAutomaticResponseConfiguration AWS CloudFormation Property
	// Required: false
	...
	ApplicationLayerAutomaticResponseConfiguration *Protection_ApplicationLayerAutomaticResponseConfiguration[any] `json:"ApplicationLayerAutomaticResponseConfiguration,omitempty"`
...
func (r *Protection[any]) AWSCloudFormationType() string {
	return "AWS::Shield::Protection"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Protection[any]) MarshalJSON() ([]byte, error) {
	type Properties Protection[any]
...
func (r *Protection[any]) UnmarshalJSON(b []byte) error {
	type Properties Protection[any]
	...
	if res.Properties != nil {
		*r = Protection[any](*res.Properties)
	}
