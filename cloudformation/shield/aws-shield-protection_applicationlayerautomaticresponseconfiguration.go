...
type Protection_ApplicationLayerAutomaticResponseConfiguration[T any] struct {
	...
	Action *Protection_Action[any] `json:"Action"`
...
func (r *Protection_ApplicationLayerAutomaticResponseConfiguration[any]) AWSCloudFormationType() string {
