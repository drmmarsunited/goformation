...
// ProactiveEngagement AWS CloudFormation Resource (AWS::Shield::ProactiveEngagement)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-shield-proactiveengagement.html
type ProactiveEngagement[T any] struct {

	// EmergencyContactList AWS CloudFormation Property
	// Required: true
	...
	EmergencyContactList []ProactiveEngagement_EmergencyContact[any] `json:"EmergencyContactList"`
...
func (r *ProactiveEngagement[any]) AWSCloudFormationType() string {
	return "AWS::Shield::ProactiveEngagement"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ProactiveEngagement[any]) MarshalJSON() ([]byte, error) {
	type Properties ProactiveEngagement[any]
...
func (r *ProactiveEngagement[any]) UnmarshalJSON(b []byte) error {
	type Properties ProactiveEngagement[any]
	...
	if res.Properties != nil {
		*r = ProactiveEngagement[any](*res.Properties)
	}
