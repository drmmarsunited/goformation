...
// DRTAccess AWS CloudFormation Resource (AWS::Shield::DRTAccess)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-shield-drtaccess.html
type DRTAccess[T any] struct {

	// LogBucketList AWS CloudFormation Property
	// Required: false
	...
	LogBucketList []T `json:"LogBucketList,omitempty"`
...
func (r *DRTAccess[any]) AWSCloudFormationType() string {
	return "AWS::Shield::DRTAccess"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DRTAccess[any]) MarshalJSON() ([]byte, error) {
	type Properties DRTAccess[any]
...
func (r *DRTAccess[any]) UnmarshalJSON(b []byte) error {
	type Properties DRTAccess[any]
	...
	if res.Properties != nil {
		*r = DRTAccess[any](*res.Properties)
	}
