...
type ExperimentTemplate_ExperimentTemplateLogConfiguration[T any] struct {
	...
	CloudWatchLogsConfiguration *ExperimentTemplate_CloudWatchLogsConfiguration[any] `json:"CloudWatchLogsConfiguration,omitempty"`
	...
	LogSchemaVersion T `json:"LogSchemaVersion"`
	...
	S3Configuration *ExperimentTemplate_S3Configuration[any] `json:"S3Configuration,omitempty"`
...
func (r *ExperimentTemplate_ExperimentTemplateLogConfiguration[any]) AWSCloudFormationType() string {
