...
type ImageRecipe_SystemsManagerAgent[T any] struct {
	...
	UninstallAfterBuild *T `json:"UninstallAfterBuild,omitempty"`
...
func (r *ImageRecipe_SystemsManagerAgent[any]) AWSCloudFormationType() string {
