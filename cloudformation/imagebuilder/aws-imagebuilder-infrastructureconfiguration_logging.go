...
type InfrastructureConfiguration_Logging[T any] struct {
	...
	S3Logs *InfrastructureConfiguration_S3Logs[any] `json:"S3Logs,omitempty"`
...
func (r *InfrastructureConfiguration_Logging[any]) AWSCloudFormationType() string {
