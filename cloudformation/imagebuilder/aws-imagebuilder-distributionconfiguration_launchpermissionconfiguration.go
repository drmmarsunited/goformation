...
type DistributionConfiguration_LaunchPermissionConfiguration[T any] struct {
	...
	OrganizationArns []T `json:"OrganizationArns,omitempty"`
	...
	OrganizationalUnitArns []T `json:"OrganizationalUnitArns,omitempty"`
	...
	UserGroups []T `json:"UserGroups,omitempty"`
	...
	UserIds []T `json:"UserIds,omitempty"`
