...
type CostCategory[T any] struct {
...
func (r *CostCategory[any]) AWSCloudFormationType() string {
	return "AWS::CE::CostCategory"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r CostCategory[any]) MarshalJSON() ([]byte, error) {
	type Properties CostCategory[any]
...
func (r *CostCategory[any]) UnmarshalJSON(b []byte) error {
	type Properties CostCategory[any]
	...
	if res.Properties != nil {
		*r = CostCategory[any](*res.Properties)
	}
