...
type StateMachineAlias[T any] struct {
	...
	DeploymentPreference *StateMachineAlias_DeploymentPreference[any] `json:"DeploymentPreference,omitempty"`
	...
	RoutingConfiguration []StateMachineAlias_RoutingConfigurationVersion[any] `json:"RoutingConfiguration,omitempty"`
...
func (r *StateMachineAlias[any]) AWSCloudFormationType() string {
	return "AWS::StepFunctions::StateMachineAlias"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r StateMachineAlias[any]) MarshalJSON() ([]byte, error) {
	type Properties StateMachineAlias[any]
...
func (r *StateMachineAlias[any]) UnmarshalJSON(b []byte) error {
	type Properties StateMachineAlias[any]
	...
	if res.Properties != nil {
		*r = StateMachineAlias[any](*res.Properties)
	}
