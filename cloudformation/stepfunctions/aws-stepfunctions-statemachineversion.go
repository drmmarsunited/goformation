...
// StateMachineVersion AWS CloudFormation Resource (AWS::StepFunctions::StateMachineVersion)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-stepfunctions-statemachineversion.html
type StateMachineVersion[T any] struct {
	...
	StateMachineArn T `json:"StateMachineArn"`

	// StateMachineRevisionId AWS CloudFormation Property
	// Required: false
	...
	StateMachineRevisionId *T `json:"StateMachineRevisionId,omitempty"`
...
func (r *StateMachineVersion[any]) AWSCloudFormationType() string {
	return "AWS::StepFunctions::StateMachineVersion"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r StateMachineVersion[any]) MarshalJSON() ([]byte, error) {
	type Properties StateMachineVersion[any]
...
func (r *StateMachineVersion[any]) UnmarshalJSON(b []byte) error {
	type Properties StateMachineVersion[any]
	...
	if res.Properties != nil {
		*r = StateMachineVersion[any](*res.Properties)
	}
