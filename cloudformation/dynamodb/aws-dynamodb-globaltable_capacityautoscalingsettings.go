...
type GlobalTable_CapacityAutoScalingSettings[T any] struct {
	...
	SeedCapacity *T `json:"SeedCapacity,omitempty"`
	...
	TargetTrackingScalingPolicyConfiguration *GlobalTable_TargetTrackingScalingPolicyConfiguration[any] `json:"TargetTrackingScalingPolicyConfiguration"`
...
func (r *GlobalTable_CapacityAutoScalingSettings[any]) AWSCloudFormationType() string {
