...
// Function_RouteSettings AWS CloudFormation Resource (AWS::Serverless::Function.RouteSettings)
// See: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apigatewayv2-stage-routesettings.html
type Function_RouteSettings[T any] struct {
...
func (r *Function_RouteSettings[any]) AWSCloudFormationType() string {
	return "AWS::Serverless::Function.RouteSettings"
}
