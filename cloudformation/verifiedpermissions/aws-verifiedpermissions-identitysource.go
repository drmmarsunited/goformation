...
type IdentitySource[T any] struct {
	...
	Configuration *IdentitySource_IdentitySourceConfiguration[any] `json:"Configuration"`
...
func (r *IdentitySource[any]) AWSCloudFormationType() string {
	return "AWS::VerifiedPermissions::IdentitySource"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r IdentitySource[any]) MarshalJSON() ([]byte, error) {
	type Properties IdentitySource[any]
...
func (r *IdentitySource[any]) UnmarshalJSON(b []byte) error {
	type Properties IdentitySource[any]
	...
	if res.Properties != nil {
		*r = IdentitySource[any](*res.Properties)
	}
