...
type PolicyTemplate[T any] struct {
...
func (r *PolicyTemplate[any]) AWSCloudFormationType() string {
	return "AWS::VerifiedPermissions::PolicyTemplate"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r PolicyTemplate[any]) MarshalJSON() ([]byte, error) {
	type Properties PolicyTemplate[any]
...
func (r *PolicyTemplate[any]) UnmarshalJSON(b []byte) error {
	type Properties PolicyTemplate[any]
	...
	if res.Properties != nil {
		*r = PolicyTemplate[any](*res.Properties)
	}
