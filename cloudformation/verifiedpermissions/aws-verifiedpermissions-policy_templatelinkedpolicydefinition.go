...
type Policy_TemplateLinkedPolicyDefinition[T any] struct {
	...
	Principal *Policy_EntityIdentifier[any] `json:"Principal,omitempty"`
	...
	Resource *Policy_EntityIdentifier[any] `json:"Resource,omitempty"`
...
func (r *Policy_TemplateLinkedPolicyDefinition[any]) AWSCloudFormationType() string {
