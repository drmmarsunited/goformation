...
type PolicyStore[T any] struct {
	...
	Schema *PolicyStore_SchemaDefinition[any] `json:"Schema,omitempty"`
	...
	ValidationSettings *PolicyStore_ValidationSettings[any] `json:"ValidationSettings"`
...
func (r *PolicyStore[any]) AWSCloudFormationType() string {
	return "AWS::VerifiedPermissions::PolicyStore"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r PolicyStore[any]) MarshalJSON() ([]byte, error) {
	type Properties PolicyStore[any]
...
func (r *PolicyStore[any]) UnmarshalJSON(b []byte) error {
	type Properties PolicyStore[any]
	...
	if res.Properties != nil {
		*r = PolicyStore[any](*res.Properties)
	}
