...
// PolicyStore_ValidationSettings AWS CloudFormation Resource (AWS::VerifiedPermissions::PolicyStore.ValidationSettings)
...
type PolicyStore_ValidationSettings[T any] struct {
...
func (r *PolicyStore_ValidationSettings[any]) AWSCloudFormationType() string {
	return "AWS::VerifiedPermissions::PolicyStore.ValidationSettings"
}
