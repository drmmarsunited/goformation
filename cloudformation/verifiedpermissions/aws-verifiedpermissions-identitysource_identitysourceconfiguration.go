...
type IdentitySource_IdentitySourceConfiguration[T any] struct {
	...
	CognitoUserPoolConfiguration *IdentitySource_CognitoUserPoolConfiguration[any] `json:"CognitoUserPoolConfiguration"`
...
func (r *IdentitySource_IdentitySourceConfiguration[any]) AWSCloudFormationType() string {
