...
type OriginEndpoint[T any] struct {
	...
	HlsManifests []OriginEndpoint_HlsManifestConfiguration[any] `json:"HlsManifests,omitempty"`
	...
	LowLatencyHlsManifests []OriginEndpoint_LowLatencyHlsManifestConfiguration[any] `json:"LowLatencyHlsManifests,omitempty"`
	...
	Segment *OriginEndpoint_Segment[any] `json:"Segment,omitempty"`
