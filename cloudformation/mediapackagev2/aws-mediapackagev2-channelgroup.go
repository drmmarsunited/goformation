...
// ChannelGroup AWS CloudFormation Resource (AWS::MediaPackageV2::ChannelGroup)
...
func (r *ChannelGroup[any]) AWSCloudFormationType() string {
	return "AWS::MediaPackageV2::ChannelGroup"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ChannelGroup[any]) MarshalJSON() ([]byte, error) {
	type Properties ChannelGroup[any]
...
func (r *ChannelGroup[any]) UnmarshalJSON(b []byte) error {
	type Properties ChannelGroup[any]
	...
	if res.Properties != nil {
		*r = ChannelGroup[any](*res.Properties)
	}
