...
type OriginEndpointPolicy[T any] struct {
...
func (r *OriginEndpointPolicy[any]) AWSCloudFormationType() string {
	return "AWS::MediaPackageV2::OriginEndpointPolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r OriginEndpointPolicy[any]) MarshalJSON() ([]byte, error) {
	type Properties OriginEndpointPolicy[any]
...
func (r *OriginEndpointPolicy[any]) UnmarshalJSON(b []byte) error {
	type Properties OriginEndpointPolicy[any]
	...
	if res.Properties != nil {
		*r = OriginEndpointPolicy[any](*res.Properties)
	}
