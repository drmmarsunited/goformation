...
func (r *ChannelPolicy[any]) AWSCloudFormationType() string {
	return "AWS::MediaPackageV2::ChannelPolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ChannelPolicy[any]) MarshalJSON() ([]byte, error) {
	type Properties ChannelPolicy[any]
...
func (r *ChannelPolicy[any]) UnmarshalJSON(b []byte) error {
	type Properties ChannelPolicy[any]
	...
	if res.Properties != nil {
		*r = ChannelPolicy[any](*res.Properties)
	}
