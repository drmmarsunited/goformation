...
type OriginEndpoint_LowLatencyHlsManifestConfiguration[T any] struct {
	...
	ScteHls *OriginEndpoint_ScteHls[any] `json:"ScteHls,omitempty"`
...
func (r *OriginEndpoint_LowLatencyHlsManifestConfiguration[any]) AWSCloudFormationType() string {
