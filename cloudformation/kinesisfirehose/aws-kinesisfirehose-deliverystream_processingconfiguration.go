...
type DeliveryStream_ProcessingConfiguration[T any] struct {
	...
	Processors []DeliveryStream_Processor[any] `json:"Processors,omitempty"`
...
func (r *DeliveryStream_ProcessingConfiguration[any]) AWSCloudFormationType() string {
