...
type DeliveryStream_MSKSourceConfiguration[T any] struct {
	...
	AuthenticationConfiguration *DeliveryStream_AuthenticationConfiguration[any] `json:"AuthenticationConfiguration"`
...
func (r *DeliveryStream_MSKSourceConfiguration[any]) AWSCloudFormationType() string {
