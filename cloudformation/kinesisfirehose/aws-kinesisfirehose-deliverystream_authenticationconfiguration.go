...
type DeliveryStream_AuthenticationConfiguration[T any] struct {
	...
	Connectivity T `json:"Connectivity"`
...
func (r *DeliveryStream_AuthenticationConfiguration[any]) AWSCloudFormationType() string {
