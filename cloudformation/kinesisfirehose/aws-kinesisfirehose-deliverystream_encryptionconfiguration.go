...
type DeliveryStream_EncryptionConfiguration[T any] struct {
	...
	KMSEncryptionConfig *DeliveryStream_KMSEncryptionConfig[any] `json:"KMSEncryptionConfig,omitempty"`
...
func (r *DeliveryStream_EncryptionConfiguration[any]) AWSCloudFormationType() string {
