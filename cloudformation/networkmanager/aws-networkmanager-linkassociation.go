...
type LinkAssociation[T any] struct {
...
func (r *LinkAssociation[any]) AWSCloudFormationType() string {
	return "AWS::NetworkManager::LinkAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LinkAssociation[any]) MarshalJSON() ([]byte, error) {
	type Properties LinkAssociation[any]
...
func (r *LinkAssociation[any]) UnmarshalJSON(b []byte) error {
	type Properties LinkAssociation[any]
	...
	if res.Properties != nil {
		*r = LinkAssociation[any](*res.Properties)
	}
