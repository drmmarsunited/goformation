...
type Device[T any] struct {
	...
	AWSLocation *Device_AWSLocation[any] `json:"AWSLocation,omitempty"`
	...
	Location *Device_Location[any] `json:"Location,omitempty"`
	...
	SiteId *T `json:"SiteId,omitempty"`
	...
	Vendor *T `json:"Vendor,omitempty"`
