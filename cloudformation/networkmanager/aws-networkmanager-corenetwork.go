...
func (r *CoreNetwork[any]) AWSCloudFormationType() string {
	return "AWS::NetworkManager::CoreNetwork"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r CoreNetwork[any]) MarshalJSON() ([]byte, error) {
	type Properties CoreNetwork[any]
...
func (r *CoreNetwork[any]) UnmarshalJSON(b []byte) error {
	type Properties CoreNetwork[any]
	...
	if res.Properties != nil {
		*r = CoreNetwork[any](*res.Properties)
	}
