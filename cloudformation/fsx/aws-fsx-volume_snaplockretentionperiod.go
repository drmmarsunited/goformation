...
type Volume_SnaplockRetentionPeriod[T any] struct {
	...
	DefaultRetention *Volume_RetentionPeriod[any] `json:"DefaultRetention"`
	...
	MaximumRetention *Volume_RetentionPeriod[any] `json:"MaximumRetention"`
	...
	MinimumRetention *Volume_RetentionPeriod[any] `json:"MinimumRetention"`
...
func (r *Volume_SnaplockRetentionPeriod[any]) AWSCloudFormationType() string {
