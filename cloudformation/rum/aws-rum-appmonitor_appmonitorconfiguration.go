...
type AppMonitor_AppMonitorConfiguration[T any] struct {
	...
	AllowCookies *T `json:"AllowCookies,omitempty"`
	...
	EnableXRay *T `json:"EnableXRay,omitempty"`
	...
	MetricDestinations []AppMonitor_MetricDestination[any] `json:"MetricDestinations,omitempty"`
	...
	SessionSampleRate *T `json:"SessionSampleRate,omitempty"`
...
func (r *AppMonitor_AppMonitorConfiguration[any]) AWSCloudFormationType() string {
