...
type Segment_Location[T any] struct {
	...
	Country *Segment_SetDimension[any] `json:"Country,omitempty"`
	...
	GPSPoint *Segment_GPSPoint[any] `json:"GPSPoint,omitempty"`
...
func (r *Segment_Location[any]) AWSCloudFormationType() string {
