...
type InAppTemplate_InAppMessageContent[T any] struct {
	...
	BodyConfig *InAppTemplate_BodyConfig[any] `json:"BodyConfig,omitempty"`
	...
	HeaderConfig *InAppTemplate_HeaderConfig[any] `json:"HeaderConfig,omitempty"`
	...
	PrimaryBtn *InAppTemplate_ButtonConfig[any] `json:"PrimaryBtn,omitempty"`
	...
	SecondaryBtn *InAppTemplate_ButtonConfig[any] `json:"SecondaryBtn,omitempty"`
...
func (r *InAppTemplate_InAppMessageContent[any]) AWSCloudFormationType() string {
