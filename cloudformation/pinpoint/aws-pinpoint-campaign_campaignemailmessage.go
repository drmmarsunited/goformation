...
type Campaign_CampaignEmailMessage[T any] struct {
	...
	FromAddress *T `json:"FromAddress,omitempty"`
	...
	HtmlBody *T `json:"HtmlBody,omitempty"`
...
func (r *Campaign_CampaignEmailMessage[any]) AWSCloudFormationType() string {
