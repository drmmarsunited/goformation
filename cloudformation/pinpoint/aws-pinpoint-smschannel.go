...
func (r *SMSChannel[any]) AWSCloudFormationType() string {
	return "AWS::Pinpoint::SMSChannel"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r SMSChannel[any]) MarshalJSON() ([]byte, error) {
	type Properties SMSChannel[any]
...
func (r *SMSChannel[any]) UnmarshalJSON(b []byte) error {
	type Properties SMSChannel[any]
	...
	if res.Properties != nil {
		*r = SMSChannel[any](*res.Properties)
	}
