...
// SyncJob AWS CloudFormation Resource (AWS::IoTTwinMaker::SyncJob)
...
type SyncJob[T any] struct {
	...
	// SyncRole AWS CloudFormation Property
	// Required: true
...
func (r *SyncJob[any]) AWSCloudFormationType() string {
	return "AWS::IoTTwinMaker::SyncJob"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r SyncJob[any]) MarshalJSON() ([]byte, error) {
	type Properties SyncJob[any]
...
func (r *SyncJob[any]) UnmarshalJSON(b []byte) error {
	type Properties SyncJob[any]
