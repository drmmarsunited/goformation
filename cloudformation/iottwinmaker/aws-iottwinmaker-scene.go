...
type Scene[T any] struct {
	...
	ContentLocation T `json:"ContentLocation"`
	...
	SceneId T `json:"SceneId"`

	// SceneMetadata AWS CloudFormation Property
	// Required: false
	...
	SceneMetadata map[string]T `json:"SceneMetadata,omitempty"`
