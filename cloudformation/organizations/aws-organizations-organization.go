...
// Organization AWS CloudFormation Resource (AWS::Organizations::Organization)
...
func (r *Organization[any]) AWSCloudFormationType() string {
	return "AWS::Organizations::Organization"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Organization[any]) MarshalJSON() ([]byte, error) {
	type Properties Organization[any]
...
func (r *Organization[any]) UnmarshalJSON(b []byte) error {
	type Properties Organization[any]
	...
	if res.Properties != nil {
		*r = Organization[any](*res.Properties)
	}
