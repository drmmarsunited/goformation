...
type Grant[T any] struct {
	...
	AllowedOperations []T `json:"AllowedOperations,omitempty"`
	...
	GrantName *T `json:"GrantName,omitempty"`
	...
	HomeRegion *T `json:"HomeRegion,omitempty"`
	...
	LicenseArn *T `json:"LicenseArn,omitempty"`
