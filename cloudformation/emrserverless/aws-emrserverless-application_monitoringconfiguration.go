...
type Application_MonitoringConfiguration[T any] struct {
	...
	ManagedPersistenceMonitoringConfiguration *Application_ManagedPersistenceMonitoringConfiguration[any] `json:"ManagedPersistenceMonitoringConfiguration,omitempty"`
	...
	S3MonitoringConfiguration *Application_S3MonitoringConfiguration[any] `json:"S3MonitoringConfiguration,omitempty"`
