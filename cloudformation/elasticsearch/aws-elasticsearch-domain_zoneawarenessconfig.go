...
type Domain_ZoneAwarenessConfig[T any] struct {
	...
	AvailabilityZoneCount *T `json:"AvailabilityZoneCount,omitempty"`
...
func (r *Domain_ZoneAwarenessConfig[any]) AWSCloudFormationType() string {
