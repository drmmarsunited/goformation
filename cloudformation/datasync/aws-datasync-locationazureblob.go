...
type LocationAzureBlob[T any] struct {
	...
	AzureBlobSasConfiguration *LocationAzureBlob_AzureBlobSasConfiguration[any] `json:"AzureBlobSasConfiguration,omitempty"`
...
func (r *LocationAzureBlob[any]) AWSCloudFormationType() string {
	return "AWS::DataSync::LocationAzureBlob"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LocationAzureBlob[any]) MarshalJSON() ([]byte, error) {
	type Properties LocationAzureBlob[any]
...
func (r *LocationAzureBlob[any]) UnmarshalJSON(b []byte) error {
	type Properties LocationAzureBlob[any]
	...
	if res.Properties != nil {
		*r = LocationAzureBlob[any](*res.Properties)
	}
