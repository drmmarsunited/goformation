...
type LocationFSxLustre[T any] struct {
...
func (r *LocationFSxLustre[any]) AWSCloudFormationType() string {
	return "AWS::DataSync::LocationFSxLustre"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LocationFSxLustre[any]) MarshalJSON() ([]byte, error) {
	type Properties LocationFSxLustre[any]
...
func (r *LocationFSxLustre[any]) UnmarshalJSON(b []byte) error {
	type Properties LocationFSxLustre[any]
	...
	if res.Properties != nil {
		*r = LocationFSxLustre[any](*res.Properties)
	}
