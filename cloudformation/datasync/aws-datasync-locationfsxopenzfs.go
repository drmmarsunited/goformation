...
// LocationFSxOpenZFS AWS CloudFormation Resource (AWS::DataSync::LocationFSxOpenZFS)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-datasync-locationfsxopenzfs.html
type LocationFSxOpenZFS[T any] struct {
	...
	Protocol *LocationFSxOpenZFS_Protocol[any] `json:"Protocol"`
...
func (r *LocationFSxOpenZFS[any]) AWSCloudFormationType() string {
	return "AWS::DataSync::LocationFSxOpenZFS"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LocationFSxOpenZFS[any]) MarshalJSON() ([]byte, error) {
	type Properties LocationFSxOpenZFS[any]
...
func (r *LocationFSxOpenZFS[any]) UnmarshalJSON(b []byte) error {
	type Properties LocationFSxOpenZFS[any]
	...
	if res.Properties != nil {
		*r = LocationFSxOpenZFS[any](*res.Properties)
	}
