...
type LocationFSxOpenZFS struct {
	...
	Protocol *LocationFSxOpenZFS_Protocol `json:"Protocol"`
...
func (r *LocationFSxOpenZFS) AWSCloudFormationType() string {
	return "AWS::DataSync::LocationFSxOpenZFS"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LocationFSxOpenZFS) MarshalJSON() ([]byte, error) {
	type Properties LocationFSxOpenZFS
...
func (r *LocationFSxOpenZFS) UnmarshalJSON(b []byte) error {
	type Properties LocationFSxOpenZFS
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = LocationFSxOpenZFS(*res.Properties)
	}
