...
type Task_TaskReportConfig[T any] struct {
	...
	Destination *Task_Destination[any] `json:"Destination"`
	...
	Overrides *Task_Overrides[any] `json:"Overrides,omitempty"`
...
func (r *Task_TaskReportConfig[any]) AWSCloudFormationType() string {
