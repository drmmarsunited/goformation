...
type LocationEFS[T any] struct {
	...
	EfsFilesystemArn *T `json:"EfsFilesystemArn,omitempty"`
	...
	FileSystemAccessRoleArn *T `json:"FileSystemAccessRoleArn,omitempty"`
	...
	InTransitEncryption *T `json:"InTransitEncryption,omitempty"`
