...
type LocationFSxWindows[T any] struct {
...
func (r *LocationFSxWindows[any]) AWSCloudFormationType() string {
	return "AWS::DataSync::LocationFSxWindows"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LocationFSxWindows[any]) MarshalJSON() ([]byte, error) {
	type Properties LocationFSxWindows[any]
...
func (r *LocationFSxWindows[any]) UnmarshalJSON(b []byte) error {
	type Properties LocationFSxWindows[any]
	...
	if res.Properties != nil {
		*r = LocationFSxWindows[any](*res.Properties)
	}
