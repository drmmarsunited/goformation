...
type LogGroup[T any] struct {
	...
	RetentionInDays *T `json:"RetentionInDays,omitempty"`
...
func (r *LogGroup[any]) AWSCloudFormationType() string {
	return "AWS::Logs::LogGroup"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LogGroup[any]) MarshalJSON() ([]byte, error) {
	type Properties LogGroup[any]
...
func (r *LogGroup[any]) UnmarshalJSON(b []byte) error {
	type Properties LogGroup[any]
