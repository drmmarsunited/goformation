...
type MetricFilter[T any] struct {
	...
	MetricTransformations []MetricFilter_MetricTransformation[any] `json:"MetricTransformations"`
...
func (r *MetricFilter[any]) AWSCloudFormationType() string {
	return "AWS::Logs::MetricFilter"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r MetricFilter[any]) MarshalJSON() ([]byte, error) {
	type Properties MetricFilter[any]
...
func (r *MetricFilter[any]) UnmarshalJSON(b []byte) error {
	type Properties MetricFilter[any]
	...
	if res.Properties != nil {
		*r = MetricFilter[any](*res.Properties)
	}
