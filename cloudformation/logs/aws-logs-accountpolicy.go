...
func (r *AccountPolicy[any]) AWSCloudFormationType() string {
	return "AWS::Logs::AccountPolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AccountPolicy[any]) MarshalJSON() ([]byte, error) {
	type Properties AccountPolicy[any]
...
func (r *AccountPolicy[any]) UnmarshalJSON(b []byte) error {
	type Properties AccountPolicy[any]
	...
	if res.Properties != nil {
		*r = AccountPolicy[any](*res.Properties)
	}
