...
// TopicInlinePolicy AWS CloudFormation Resource (AWS::SNS::TopicInlinePolicy)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sns-topicinlinepolicy.html
type TopicInlinePolicy[T any] struct {
...
func (r *TopicInlinePolicy[any]) AWSCloudFormationType() string {
	return "AWS::SNS::TopicInlinePolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r TopicInlinePolicy[any]) MarshalJSON() ([]byte, error) {
	type Properties TopicInlinePolicy[any]
...
func (r *TopicInlinePolicy[any]) UnmarshalJSON(b []byte) error {
	type Properties TopicInlinePolicy[any]
	...
	if res.Properties != nil {
		*r = TopicInlinePolicy[any](*res.Properties)
	}
