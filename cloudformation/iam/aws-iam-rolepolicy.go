...
func (r *RolePolicy[any]) AWSCloudFormationType() string {
	return "AWS::IAM::RolePolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r RolePolicy[any]) MarshalJSON() ([]byte, error) {
	type Properties RolePolicy[any]
...
func (r *RolePolicy[any]) UnmarshalJSON(b []byte) error {
	type Properties RolePolicy[any]
	...
	if res.Properties != nil {
		*r = RolePolicy[any](*res.Properties)
	}
