...
func (r *GroupPolicy[any]) AWSCloudFormationType() string {
	return "AWS::IAM::GroupPolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r GroupPolicy[any]) MarshalJSON() ([]byte, error) {
	type Properties GroupPolicy[any]
...
func (r *GroupPolicy[any]) UnmarshalJSON(b []byte) error {
	type Properties GroupPolicy[any]
	...
	if res.Properties != nil {
		*r = GroupPolicy[any](*res.Properties)
	}
