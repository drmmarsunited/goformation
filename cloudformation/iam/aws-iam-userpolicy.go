...
func (r *UserPolicy[any]) AWSCloudFormationType() string {
	return "AWS::IAM::UserPolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r UserPolicy[any]) MarshalJSON() ([]byte, error) {
	type Properties UserPolicy[any]
...
func (r *UserPolicy[any]) UnmarshalJSON(b []byte) error {
	type Properties UserPolicy[any]
	...
	if res.Properties != nil {
		*r = UserPolicy[any](*res.Properties)
	}
