...
// ResourcePolicy AWS CloudFormation Resource (AWS::XRay::ResourcePolicy)
...
type ResourcePolicy[T any] struct {
	...
	// BypassPolicyLockoutCheck AWS CloudFormation Property
	// Required: false
	...
	BypassPolicyLockoutCheck *T `json:"BypassPolicyLockoutCheck,omitempty"`
	...
	PolicyDocument T `json:"PolicyDocument"`
...
func (r *ResourcePolicy[any]) AWSCloudFormationType() string {
	return "AWS::XRay::ResourcePolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ResourcePolicy[any]) MarshalJSON() ([]byte, error) {
	type Properties ResourcePolicy[any]
...
func (r *ResourcePolicy[any]) UnmarshalJSON(b []byte) error {
	type Properties ResourcePolicy[any]
	...
	if res.Properties != nil {
		*r = ResourcePolicy[any](*res.Properties)
	}
