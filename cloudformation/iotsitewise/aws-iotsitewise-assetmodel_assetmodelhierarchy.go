...
type AssetModel_AssetModelHierarchy[T any] struct {
	...
	ChildAssetModelId T `json:"ChildAssetModelId"`
...
func (r *AssetModel_AssetModelHierarchy[any]) AWSCloudFormationType() string {
