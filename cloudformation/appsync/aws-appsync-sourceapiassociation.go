...
// SourceApiAssociation AWS CloudFormation Resource (AWS::AppSync::SourceApiAssociation)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appsync-sourceapiassociation.html
type SourceApiAssociation[T any] struct {
	...
	SourceApiAssociationConfig *SourceApiAssociation_SourceApiAssociationConfig[any] `json:"SourceApiAssociationConfig,omitempty"`
...
func (r *SourceApiAssociation[any]) AWSCloudFormationType() string {
	return "AWS::AppSync::SourceApiAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r SourceApiAssociation[any]) MarshalJSON() ([]byte, error) {
	type Properties SourceApiAssociation[any]
...
func (r *SourceApiAssociation[any]) UnmarshalJSON(b []byte) error {
	type Properties SourceApiAssociation[any]
	...
	if res.Properties != nil {
		*r = SourceApiAssociation[any](*res.Properties)
	}
