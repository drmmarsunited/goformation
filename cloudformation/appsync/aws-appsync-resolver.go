...
type Resolver[T any] struct {
	...
	CachingConfig *Resolver_CachingConfig[any] `json:"CachingConfig,omitempty"`
	...
	PipelineConfig *Resolver_PipelineConfig[any] `json:"PipelineConfig,omitempty"`
	...
	Runtime *Resolver_AppSyncRuntime[any] `json:"Runtime,omitempty"`
	...
	SyncConfig *Resolver_SyncConfig[any] `json:"SyncConfig,omitempty"`
...
func (r *Resolver[any]) AWSCloudFormationType() string {
	return "AWS::AppSync::Resolver"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Resolver[any]) MarshalJSON() ([]byte, error) {
	type Properties Resolver[any]
...
func (r *Resolver[any]) UnmarshalJSON(b []byte) error {
	type Properties Resolver[any]
