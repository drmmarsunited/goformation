...
type DomainNameApiAssociation[T any] struct {
...
func (r *DomainNameApiAssociation[any]) AWSCloudFormationType() string {
	return "AWS::AppSync::DomainNameApiAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DomainNameApiAssociation[any]) MarshalJSON() ([]byte, error) {
	type Properties DomainNameApiAssociation[any]
...
func (r *DomainNameApiAssociation[any]) UnmarshalJSON(b []byte) error {
	type Properties DomainNameApiAssociation[any]
	...
	if res.Properties != nil {
		*r = DomainNameApiAssociation[any](*res.Properties)
	}
