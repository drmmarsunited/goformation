...
type UserSettings[T any] struct {
	...
	CookieSynchronizationConfiguration *UserSettings_CookieSynchronizationConfiguration[any] `json:"CookieSynchronizationConfiguration,omitempty"`
	...
	DisconnectTimeoutInMinutes *T `json:"DisconnectTimeoutInMinutes,omitempty"`
	...
	IdleDisconnectTimeoutInMinutes *T `json:"IdleDisconnectTimeoutInMinutes,omitempty"`
...
func (r *UserSettings[any]) AWSCloudFormationType() string {
	return "AWS::WorkSpacesWeb::UserSettings"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r UserSettings[any]) MarshalJSON() ([]byte, error) {
	type Properties UserSettings[any]
...
func (r *UserSettings[any]) UnmarshalJSON(b []byte) error {
	type Properties UserSettings[any]
	...
	if res.Properties != nil {
		*r = UserSettings[any](*res.Properties)
	}
