...
type BrowserSettings[T any] struct {
...
func (r *BrowserSettings[any]) AWSCloudFormationType() string {
	return "AWS::WorkSpacesWeb::BrowserSettings"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r BrowserSettings[any]) MarshalJSON() ([]byte, error) {
	type Properties BrowserSettings[any]
...
func (r *BrowserSettings[any]) UnmarshalJSON(b []byte) error {
	type Properties BrowserSettings[any]
	...
	if res.Properties != nil {
		*r = BrowserSettings[any](*res.Properties)
	}
