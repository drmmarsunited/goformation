...
// IpAccessSettings AWS CloudFormation Resource (AWS::WorkSpacesWeb::IpAccessSettings)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-workspacesweb-ipaccesssettings.html
type IpAccessSettings[T any] struct {
	...
	IpRules []IpAccessSettings_IpRule[any] `json:"IpRules"`
...
func (r *IpAccessSettings[any]) AWSCloudFormationType() string {
	return "AWS::WorkSpacesWeb::IpAccessSettings"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r IpAccessSettings[any]) MarshalJSON() ([]byte, error) {
	type Properties IpAccessSettings[any]
...
func (r *IpAccessSettings[any]) UnmarshalJSON(b []byte) error {
	type Properties IpAccessSettings[any]
	...
	if res.Properties != nil {
		*r = IpAccessSettings[any](*res.Properties)
	}
