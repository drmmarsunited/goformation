...
func (r *NetworkSettings[any]) AWSCloudFormationType() string {
	return "AWS::WorkSpacesWeb::NetworkSettings"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r NetworkSettings[any]) MarshalJSON() ([]byte, error) {
	type Properties NetworkSettings[any]
...
func (r *NetworkSettings[any]) UnmarshalJSON(b []byte) error {
	type Properties NetworkSettings[any]
	...
	if res.Properties != nil {
		*r = NetworkSettings[any](*res.Properties)
	}
