...
func (r *TrustStore[any]) AWSCloudFormationType() string {
	return "AWS::WorkSpacesWeb::TrustStore"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r TrustStore[any]) MarshalJSON() ([]byte, error) {
	type Properties TrustStore[any]
...
func (r *TrustStore[any]) UnmarshalJSON(b []byte) error {
	type Properties TrustStore[any]
	...
	if res.Properties != nil {
		*r = TrustStore[any](*res.Properties)
	}
