...
// IdentityProvider AWS CloudFormation Resource (AWS::WorkSpacesWeb::IdentityProvider)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-workspacesweb-identityprovider.html
type IdentityProvider[T any] struct {
...
func (r *IdentityProvider[any]) AWSCloudFormationType() string {
	return "AWS::WorkSpacesWeb::IdentityProvider"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r IdentityProvider[any]) MarshalJSON() ([]byte, error) {
	type Properties IdentityProvider[any]
...
func (r *IdentityProvider[any]) UnmarshalJSON(b []byte) error {
	type Properties IdentityProvider[any]
	...
	if res.Properties != nil {
		*r = IdentityProvider[any](*res.Properties)
	}
