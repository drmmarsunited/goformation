...
type BridgeSource_BridgeFlowSource[T any] struct {
	...
	FlowVpcInterfaceAttachment *BridgeSource_VpcInterfaceAttachment[any] `json:"FlowVpcInterfaceAttachment,omitempty"`
...
func (r *BridgeSource_BridgeFlowSource[any]) AWSCloudFormationType() string {
