...
type BridgeOutput[T any] struct {
	...
	NetworkOutput *BridgeOutput_BridgeNetworkOutput[any] `json:"NetworkOutput"`
...
func (r *BridgeOutput[any]) AWSCloudFormationType() string {
	return "AWS::MediaConnect::BridgeOutput"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r BridgeOutput[any]) MarshalJSON() ([]byte, error) {
	type Properties BridgeOutput[any]
...
func (r *BridgeOutput[any]) UnmarshalJSON(b []byte) error {
	type Properties BridgeOutput[any]
	...
	if res.Properties != nil {
		*r = BridgeOutput[any](*res.Properties)
	}
