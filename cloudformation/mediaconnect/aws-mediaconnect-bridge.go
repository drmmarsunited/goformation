...
// Bridge AWS CloudFormation Resource (AWS::MediaConnect::Bridge)
...
type Bridge[T any] struct {
	...
	// EgressGatewayBridge AWS CloudFormation Property
	// Required: false
	...
	EgressGatewayBridge *Bridge_EgressGatewayBridge[any] `json:"EgressGatewayBridge,omitempty"`

	// IngressGatewayBridge AWS CloudFormation Property
	// Required: false
	...
	IngressGatewayBridge *Bridge_IngressGatewayBridge[any] `json:"IngressGatewayBridge,omitempty"`
	...
	Outputs []Bridge_BridgeOutput[any] `json:"Outputs,omitempty"`
	...
	SourceFailoverConfig *Bridge_FailoverConfig[any] `json:"SourceFailoverConfig,omitempty"`
	...
	Sources []Bridge_BridgeSource[any] `json:"Sources"`
...
func (r *Bridge[any]) AWSCloudFormationType() string {
	return "AWS::MediaConnect::Bridge"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Bridge[any]) MarshalJSON() ([]byte, error) {
	type Properties Bridge[any]
...
func (r *Bridge[any]) UnmarshalJSON(b []byte) error {
	type Properties Bridge[any]
