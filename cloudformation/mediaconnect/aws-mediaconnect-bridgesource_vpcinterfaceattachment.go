...
// BridgeSource_VpcInterfaceAttachment AWS CloudFormation Resource (AWS::MediaConnect::BridgeSource.VpcInterfaceAttachment)
...
type BridgeSource_VpcInterfaceAttachment[T any] struct {
...
func (r *BridgeSource_VpcInterfaceAttachment[any]) AWSCloudFormationType() string {
	return "AWS::MediaConnect::BridgeSource.VpcInterfaceAttachment"
}
