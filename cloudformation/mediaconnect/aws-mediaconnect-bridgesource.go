...
type BridgeSource[T any] struct {
	...
	FlowSource *BridgeSource_BridgeFlowSource[any] `json:"FlowSource,omitempty"`
	...
	NetworkSource *BridgeSource_BridgeNetworkSource[any] `json:"NetworkSource,omitempty"`
...
func (r *BridgeSource[any]) AWSCloudFormationType() string {
	return "AWS::MediaConnect::BridgeSource"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r BridgeSource[any]) MarshalJSON() ([]byte, error) {
	type Properties BridgeSource[any]
...
func (r *BridgeSource[any]) UnmarshalJSON(b []byte) error {
	type Properties BridgeSource[any]
	...
	if res.Properties != nil {
		*r = BridgeSource[any](*res.Properties)
	}
