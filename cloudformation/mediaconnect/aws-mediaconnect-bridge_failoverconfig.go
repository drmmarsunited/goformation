...
type Bridge_FailoverConfig[T any] struct {
	...
	SourcePriority *Bridge_SourcePriority[any] `json:"SourcePriority,omitempty"`
...
func (r *Bridge_FailoverConfig[any]) AWSCloudFormationType() string {
