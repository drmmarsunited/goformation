...
// BridgeOutput_BridgeNetworkOutput AWS CloudFormation Resource (AWS::MediaConnect::BridgeOutput.BridgeNetworkOutput)
...
type BridgeOutput_BridgeNetworkOutput[T any] struct {
...
func (r *BridgeOutput_BridgeNetworkOutput[any]) AWSCloudFormationType() string {
	return "AWS::MediaConnect::BridgeOutput.BridgeNetworkOutput"
}
