...
type ConfigurationRecorder_ExclusionByResourceTypes[T any] struct {
...
func (r *ConfigurationRecorder_ExclusionByResourceTypes[any]) AWSCloudFormationType() string {
