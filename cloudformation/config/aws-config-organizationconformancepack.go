...
type OrganizationConformancePack[T any] struct {
	...
	ConformancePackInputParameters []OrganizationConformancePack_ConformancePackInputParameter[any] `json:"ConformancePackInputParameters,omitempty"`
...
func (r *OrganizationConformancePack[any]) AWSCloudFormationType() string {
	return "AWS::Config::OrganizationConformancePack"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r OrganizationConformancePack[any]) MarshalJSON() ([]byte, error) {
	type Properties OrganizationConformancePack[any]
...
func (r *OrganizationConformancePack[any]) UnmarshalJSON(b []byte) error {
	type Properties OrganizationConformancePack[any]
	...
	if res.Properties != nil {
		*r = OrganizationConformancePack[any](*res.Properties)
	}
