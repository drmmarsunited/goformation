...
func (r *StoredQuery[any]) AWSCloudFormationType() string {
	return "AWS::Config::StoredQuery"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r StoredQuery[any]) MarshalJSON() ([]byte, error) {
	type Properties StoredQuery[any]
...
func (r *StoredQuery[any]) UnmarshalJSON(b []byte) error {
	type Properties StoredQuery[any]
	...
	if res.Properties != nil {
		*r = StoredQuery[any](*res.Properties)
	}
