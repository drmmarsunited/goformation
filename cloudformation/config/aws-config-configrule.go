...
type ConfigRule[T any] struct {
	...
	Compliance *ConfigRule_Compliance[any] `json:"Compliance,omitempty"`
	...
	ConfigRuleName *T `json:"ConfigRuleName,omitempty"`
	...
	EvaluationModes []ConfigRule_EvaluationModeConfiguration[any] `json:"EvaluationModes,omitempty"`
