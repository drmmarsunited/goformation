...
// ConfigRule_EvaluationModeConfiguration AWS CloudFormation Resource (AWS::Config::ConfigRule.EvaluationModeConfiguration)
...
type ConfigRule_EvaluationModeConfiguration[T any] struct {
...
func (r *ConfigRule_EvaluationModeConfiguration[any]) AWSCloudFormationType() string {
	return "AWS::Config::ConfigRule.EvaluationModeConfiguration"
}
