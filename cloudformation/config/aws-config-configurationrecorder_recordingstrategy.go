...
// ConfigurationRecorder_RecordingStrategy AWS CloudFormation Resource (AWS::Config::ConfigurationRecorder.RecordingStrategy)
...
type ConfigurationRecorder_RecordingStrategy[T any] struct {
...
func (r *ConfigurationRecorder_RecordingStrategy[any]) AWSCloudFormationType() string {
	return "AWS::Config::ConfigurationRecorder.RecordingStrategy"
}
