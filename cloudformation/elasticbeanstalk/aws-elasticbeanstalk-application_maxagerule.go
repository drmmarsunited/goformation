...
type Application_MaxAgeRule[T any] struct {
	...
	DeleteSourceFromS3 *T `json:"DeleteSourceFromS3,omitempty"`
	...
	MaxAgeInDays *T `json:"MaxAgeInDays,omitempty"`
...
func (r *Application_MaxAgeRule[any]) AWSCloudFormationType() string {
