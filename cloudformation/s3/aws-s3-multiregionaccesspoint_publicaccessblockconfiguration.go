...
type MultiRegionAccessPoint_PublicAccessBlockConfiguration[T any] struct {
...
func (r *MultiRegionAccessPoint_PublicAccessBlockConfiguration[any]) AWSCloudFormationType() string {
