...
type Bucket_RedirectRule[T any] struct {
	...
	HttpRedirectCode *T `json:"HttpRedirectCode,omitempty"`
	...
	ReplaceKeyPrefixWith *T `json:"ReplaceKeyPrefixWith,omitempty"`
	...
	ReplaceKeyWith *T `json:"ReplaceKeyWith,omitempty"`
