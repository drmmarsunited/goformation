...
type StorageLens_DataExport[T any] struct {
	...
	CloudWatchMetrics *StorageLens_CloudWatchMetrics[any] `json:"CloudWatchMetrics,omitempty"`
	...
	S3BucketDestination *StorageLens_S3BucketDestination[any] `json:"S3BucketDestination,omitempty"`
...
func (r *StorageLens_DataExport[any]) AWSCloudFormationType() string {
