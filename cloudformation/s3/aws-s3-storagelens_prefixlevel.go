...
type StorageLens_PrefixLevel[T any] struct {
	...
	StorageMetrics *StorageLens_PrefixLevelStorageMetrics[any] `json:"StorageMetrics"`
...
func (r *StorageLens_PrefixLevel[any]) AWSCloudFormationType() string {
