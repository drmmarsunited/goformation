...
type LifecyclePolicy_CrossRegionCopyAction[T any] struct {
	...
	EncryptionConfiguration *LifecyclePolicy_EncryptionConfiguration[any] `json:"EncryptionConfiguration"`
...
func (r *LifecyclePolicy_CrossRegionCopyAction[any]) AWSCloudFormationType() string {
