...
type LifecyclePolicy_ShareRule[T any] struct {
	...
	UnshareInterval *T `json:"UnshareInterval,omitempty"`
...
func (r *LifecyclePolicy_ShareRule[any]) AWSCloudFormationType() string {
