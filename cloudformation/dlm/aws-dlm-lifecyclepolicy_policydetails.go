...
type LifecyclePolicy_PolicyDetails[T any] struct {
	...
	Actions []LifecyclePolicy_Action[any] `json:"Actions,omitempty"`
	...
	EventSource *LifecyclePolicy_EventSource[any] `json:"EventSource,omitempty"`
	...
	Parameters *LifecyclePolicy_Parameters[any] `json:"Parameters,omitempty"`
	...
	ResourceLocations []T `json:"ResourceLocations,omitempty"`
	...
	Schedules []LifecyclePolicy_Schedule[any] `json:"Schedules,omitempty"`
...
func (r *LifecyclePolicy_PolicyDetails[any]) AWSCloudFormationType() string {
