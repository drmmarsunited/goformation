...
type NetworkInsightsAccessScope_AccessScopePathRequest[T any] struct {
	...
	Destination *NetworkInsightsAccessScope_PathStatementRequest[any] `json:"Destination,omitempty"`
	...
	Source *NetworkInsightsAccessScope_PathStatementRequest[any] `json:"Source,omitempty"`
	...
	ThroughResources []NetworkInsightsAccessScope_ThroughResourcesStatementRequest[any] `json:"ThroughResources,omitempty"`
...
func (r *NetworkInsightsAccessScope_AccessScopePathRequest[any]) AWSCloudFormationType() string {
