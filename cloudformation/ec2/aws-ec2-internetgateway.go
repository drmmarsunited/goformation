...
type InternetGateway[T any] struct {
...
func (r *InternetGateway[any]) AWSCloudFormationType() string {
	return "AWS::EC2::InternetGateway"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r InternetGateway[any]) MarshalJSON() ([]byte, error) {
	type Properties InternetGateway[any]
...
func (r *InternetGateway[any]) UnmarshalJSON(b []byte) error {
	type Properties InternetGateway[any]
	...
	if res.Properties != nil {
		*r = InternetGateway[any](*res.Properties)
	}
