...
type SubnetCidrBlock[T any] struct {
...
func (r *SubnetCidrBlock[any]) AWSCloudFormationType() string {
	return "AWS::EC2::SubnetCidrBlock"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r SubnetCidrBlock[any]) MarshalJSON() ([]byte, error) {
	type Properties SubnetCidrBlock[any]
...
func (r *SubnetCidrBlock[any]) UnmarshalJSON(b []byte) error {
	type Properties SubnetCidrBlock[any]
	...
	if res.Properties != nil {
		*r = SubnetCidrBlock[any](*res.Properties)
	}
