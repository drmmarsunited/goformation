...
type LocalGatewayRoute[T any] struct {
...
func (r *LocalGatewayRoute[any]) AWSCloudFormationType() string {
	return "AWS::EC2::LocalGatewayRoute"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LocalGatewayRoute[any]) MarshalJSON() ([]byte, error) {
	type Properties LocalGatewayRoute[any]
...
func (r *LocalGatewayRoute[any]) UnmarshalJSON(b []byte) error {
	type Properties LocalGatewayRoute[any]
	...
	if res.Properties != nil {
		*r = LocalGatewayRoute[any](*res.Properties)
	}
