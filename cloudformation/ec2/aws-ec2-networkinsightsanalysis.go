...
type NetworkInsightsAnalysis[T any] struct {
...
func (r *NetworkInsightsAnalysis[any]) AWSCloudFormationType() string {
	return "AWS::EC2::NetworkInsightsAnalysis"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r NetworkInsightsAnalysis[any]) MarshalJSON() ([]byte, error) {
	type Properties NetworkInsightsAnalysis[any]
...
func (r *NetworkInsightsAnalysis[any]) UnmarshalJSON(b []byte) error {
	type Properties NetworkInsightsAnalysis[any]
	...
	if res.Properties != nil {
		*r = NetworkInsightsAnalysis[any](*res.Properties)
	}
