...
type ClientVpnAuthorizationRule[T any] struct {
	...
	AuthorizeAllGroups *T `json:"AuthorizeAllGroups,omitempty"`
...
func (r *ClientVpnAuthorizationRule[any]) AWSCloudFormationType() string {
	return "AWS::EC2::ClientVpnAuthorizationRule"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ClientVpnAuthorizationRule[any]) MarshalJSON() ([]byte, error) {
	type Properties ClientVpnAuthorizationRule[any]
...
func (r *ClientVpnAuthorizationRule[any]) UnmarshalJSON(b []byte) error {
	type Properties ClientVpnAuthorizationRule[any]
	...
	if res.Properties != nil {
		*r = ClientVpnAuthorizationRule[any](*res.Properties)
	}
