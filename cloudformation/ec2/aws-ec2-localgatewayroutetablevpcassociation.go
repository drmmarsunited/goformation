...
type LocalGatewayRouteTableVPCAssociation[T any] struct {
...
func (r *LocalGatewayRouteTableVPCAssociation[any]) AWSCloudFormationType() string {
	return "AWS::EC2::LocalGatewayRouteTableVPCAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LocalGatewayRouteTableVPCAssociation[any]) MarshalJSON() ([]byte, error) {
	type Properties LocalGatewayRouteTableVPCAssociation[any]
...
func (r *LocalGatewayRouteTableVPCAssociation[any]) UnmarshalJSON(b []byte) error {
	type Properties LocalGatewayRouteTableVPCAssociation[any]
	...
	if res.Properties != nil {
		*r = LocalGatewayRouteTableVPCAssociation[any](*res.Properties)
	}
