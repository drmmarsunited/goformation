...
type Route[T any] struct {
	...
	CarrierGatewayId *T `json:"CarrierGatewayId,omitempty"`
	...
	DestinationIpv6CidrBlock *T `json:"DestinationIpv6CidrBlock,omitempty"`
	...
	LocalGatewayId *T `json:"LocalGatewayId,omitempty"`
	...
	RouteTableId T `json:"RouteTableId"`
