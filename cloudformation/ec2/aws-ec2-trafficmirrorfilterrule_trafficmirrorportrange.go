...
type TrafficMirrorFilterRule_TrafficMirrorPortRange[T any] struct {
...
func (r *TrafficMirrorFilterRule_TrafficMirrorPortRange[any]) AWSCloudFormationType() string {
