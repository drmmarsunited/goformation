...
type VPCEndpointService[T any] struct {
	...
	AcceptanceRequired *T `json:"AcceptanceRequired,omitempty"`
	...
	ContributorInsightsEnabled *T `json:"ContributorInsightsEnabled,omitempty"`
...
func (r *VPCEndpointService[any]) AWSCloudFormationType() string {
	return "AWS::EC2::VPCEndpointService"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r VPCEndpointService[any]) MarshalJSON() ([]byte, error) {
	type Properties VPCEndpointService[any]
...
func (r *VPCEndpointService[any]) UnmarshalJSON(b []byte) error {
	type Properties VPCEndpointService[any]
	...
	if res.Properties != nil {
		*r = VPCEndpointService[any](*res.Properties)
	}
