...
type LaunchTemplate_CapacityReservationSpecification[T any] struct {
	...
	CapacityReservationPreference *T `json:"CapacityReservationPreference,omitempty"`
	...
	CapacityReservationTarget *LaunchTemplate_CapacityReservationTarget[any] `json:"CapacityReservationTarget,omitempty"`
...
func (r *LaunchTemplate_CapacityReservationSpecification[any]) AWSCloudFormationType() string {
