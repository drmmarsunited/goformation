...
func (r *VPNGateway[any]) AWSCloudFormationType() string {
	return "AWS::EC2::VPNGateway"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r VPNGateway[any]) MarshalJSON() ([]byte, error) {
	type Properties VPNGateway[any]
...
func (r *VPNGateway[any]) UnmarshalJSON(b []byte) error {
	type Properties VPNGateway[any]
	...
	if res.Properties != nil {
		*r = VPNGateway[any](*res.Properties)
	}
