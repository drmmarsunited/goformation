...
type ClientVpnTargetNetworkAssociation[T any] struct {
...
func (r *ClientVpnTargetNetworkAssociation[any]) AWSCloudFormationType() string {
	return "AWS::EC2::ClientVpnTargetNetworkAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ClientVpnTargetNetworkAssociation[any]) MarshalJSON() ([]byte, error) {
	type Properties ClientVpnTargetNetworkAssociation[any]
...
func (r *ClientVpnTargetNetworkAssociation[any]) UnmarshalJSON(b []byte) error {
	type Properties ClientVpnTargetNetworkAssociation[any]
	...
	if res.Properties != nil {
		*r = ClientVpnTargetNetworkAssociation[any](*res.Properties)
	}
