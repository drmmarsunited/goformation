...
type TransitGatewayMulticastDomain[T any] struct {
	...
	Options *TransitGatewayMulticastDomain_Options[any] `json:"Options,omitempty"`
...
func (r *TransitGatewayMulticastDomain[any]) AWSCloudFormationType() string {
	return "AWS::EC2::TransitGatewayMulticastDomain"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r TransitGatewayMulticastDomain[any]) MarshalJSON() ([]byte, error) {
	type Properties TransitGatewayMulticastDomain[any]
...
func (r *TransitGatewayMulticastDomain[any]) UnmarshalJSON(b []byte) error {
	type Properties TransitGatewayMulticastDomain[any]
	...
	if res.Properties != nil {
		*r = TransitGatewayMulticastDomain[any](*res.Properties)
	}
