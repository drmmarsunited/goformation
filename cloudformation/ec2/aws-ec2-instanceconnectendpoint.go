...
// InstanceConnectEndpoint AWS CloudFormation Resource (AWS::EC2::InstanceConnectEndpoint)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-instanceconnectendpoint.html
type InstanceConnectEndpoint[T any] struct {
	...
	PreserveClientIp *T `json:"PreserveClientIp,omitempty"`
...
func (r *InstanceConnectEndpoint[any]) AWSCloudFormationType() string {
	return "AWS::EC2::InstanceConnectEndpoint"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r InstanceConnectEndpoint[any]) MarshalJSON() ([]byte, error) {
	type Properties InstanceConnectEndpoint[any]
...
func (r *InstanceConnectEndpoint[any]) UnmarshalJSON(b []byte) error {
	type Properties InstanceConnectEndpoint[any]
	...
	if res.Properties != nil {
		*r = InstanceConnectEndpoint[any](*res.Properties)
	}
