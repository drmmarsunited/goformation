...
// VerifiedAccessTrustProvider_SseSpecification AWS CloudFormation Resource (AWS::EC2::VerifiedAccessTrustProvider.SseSpecification)
...
type VerifiedAccessTrustProvider_SseSpecification[T any] struct {
	...
	CustomerManagedKeyEnabled *T `json:"CustomerManagedKeyEnabled,omitempty"`
...
func (r *VerifiedAccessTrustProvider_SseSpecification[any]) AWSCloudFormationType() string {
	return "AWS::EC2::VerifiedAccessTrustProvider.SseSpecification"
}
