...
type TrafficMirrorFilter[T any] struct {
	...
	NetworkServices []T `json:"NetworkServices,omitempty"`
...
func (r *TrafficMirrorFilter[any]) AWSCloudFormationType() string {
	return "AWS::EC2::TrafficMirrorFilter"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r TrafficMirrorFilter[any]) MarshalJSON() ([]byte, error) {
	type Properties TrafficMirrorFilter[any]
...
func (r *TrafficMirrorFilter[any]) UnmarshalJSON(b []byte) error {
	type Properties TrafficMirrorFilter[any]
	...
	if res.Properties != nil {
		*r = TrafficMirrorFilter[any](*res.Properties)
	}
