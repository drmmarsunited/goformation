...
type NetworkInterface[T any] struct {
	...
	Ipv4Prefixes []NetworkInterface_Ipv4PrefixSpecification[any] `json:"Ipv4Prefixes,omitempty"`
	...
	Ipv6Prefixes []NetworkInterface_Ipv6PrefixSpecification[any] `json:"Ipv6Prefixes,omitempty"`
