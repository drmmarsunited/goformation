...
type GatewayRouteTableAssociation[T any] struct {
...
func (r *GatewayRouteTableAssociation[any]) AWSCloudFormationType() string {
	return "AWS::EC2::GatewayRouteTableAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r GatewayRouteTableAssociation[any]) MarshalJSON() ([]byte, error) {
	type Properties GatewayRouteTableAssociation[any]
...
func (r *GatewayRouteTableAssociation[any]) UnmarshalJSON(b []byte) error {
	type Properties GatewayRouteTableAssociation[any]
	...
	if res.Properties != nil {
		*r = GatewayRouteTableAssociation[any](*res.Properties)
	}
