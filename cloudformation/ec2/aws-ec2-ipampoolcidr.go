...
func (r *IPAMPoolCidr[any]) AWSCloudFormationType() string {
	return "AWS::EC2::IPAMPoolCidr"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r IPAMPoolCidr[any]) MarshalJSON() ([]byte, error) {
	type Properties IPAMPoolCidr[any]
...
func (r *IPAMPoolCidr[any]) UnmarshalJSON(b []byte) error {
	type Properties IPAMPoolCidr[any]
	...
	if res.Properties != nil {
		*r = IPAMPoolCidr[any](*res.Properties)
	}
