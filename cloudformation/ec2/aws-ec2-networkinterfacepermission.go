...
type NetworkInterfacePermission[T any] struct {
...
func (r *NetworkInterfacePermission[any]) AWSCloudFormationType() string {
	return "AWS::EC2::NetworkInterfacePermission"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r NetworkInterfacePermission[any]) MarshalJSON() ([]byte, error) {
	type Properties NetworkInterfacePermission[any]
...
func (r *NetworkInterfacePermission[any]) UnmarshalJSON(b []byte) error {
	type Properties NetworkInterfacePermission[any]
	...
	if res.Properties != nil {
		*r = NetworkInterfacePermission[any](*res.Properties)
	}
