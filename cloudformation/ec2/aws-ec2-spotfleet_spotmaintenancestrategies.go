...
type SpotFleet_SpotMaintenanceStrategies[T any] struct {
	...
	CapacityRebalance *SpotFleet_SpotCapacityRebalance[any] `json:"CapacityRebalance,omitempty"`
...
func (r *SpotFleet_SpotMaintenanceStrategies[any]) AWSCloudFormationType() string {
