...
type EIPAssociation[T any] struct {
...
func (r *EIPAssociation[any]) AWSCloudFormationType() string {
	return "AWS::EC2::EIPAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r EIPAssociation[any]) MarshalJSON() ([]byte, error) {
	type Properties EIPAssociation[any]
...
func (r *EIPAssociation[any]) UnmarshalJSON(b []byte) error {
	type Properties EIPAssociation[any]
	...
	if res.Properties != nil {
		*r = EIPAssociation[any](*res.Properties)
	}
