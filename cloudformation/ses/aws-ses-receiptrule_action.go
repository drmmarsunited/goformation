...
type ReceiptRule_Action[T any] struct {
	...
	AddHeaderAction *ReceiptRule_AddHeaderAction[any] `json:"AddHeaderAction,omitempty"`
	...
	BounceAction *ReceiptRule_BounceAction[any] `json:"BounceAction,omitempty"`
	...
	LambdaAction *ReceiptRule_LambdaAction[any] `json:"LambdaAction,omitempty"`
	...
	S3Action *ReceiptRule_S3Action[any] `json:"S3Action,omitempty"`
	...
	SNSAction *ReceiptRule_SNSAction[any] `json:"SNSAction,omitempty"`
	...
	StopAction *ReceiptRule_StopAction[any] `json:"StopAction,omitempty"`
	...
	WorkmailAction *ReceiptRule_WorkmailAction[any] `json:"WorkmailAction,omitempty"`
...
func (r *ReceiptRule_Action[any]) AWSCloudFormationType() string {
