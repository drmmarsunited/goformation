...
type MicrosoftAD[T any] struct {
	...
	Edition *T `json:"Edition,omitempty"`
	...
	ShortName *T `json:"ShortName,omitempty"`
	...
	VpcSettings *MicrosoftAD_VpcSettings[any] `json:"VpcSettings"`
...
func (r *MicrosoftAD[any]) AWSCloudFormationType() string {
	return "AWS::DirectoryService::MicrosoftAD"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r MicrosoftAD[any]) MarshalJSON() ([]byte, error) {
	type Properties MicrosoftAD[any]
...
func (r *MicrosoftAD[any]) UnmarshalJSON(b []byte) error {
	type Properties MicrosoftAD[any]
	...
	if res.Properties != nil {
		*r = MicrosoftAD[any](*res.Properties)
	}
