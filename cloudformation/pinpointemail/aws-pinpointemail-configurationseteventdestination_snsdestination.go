...
type ConfigurationSetEventDestination_SnsDestination[T any] struct {
...
func (r *ConfigurationSetEventDestination_SnsDestination[any]) AWSCloudFormationType() string {
