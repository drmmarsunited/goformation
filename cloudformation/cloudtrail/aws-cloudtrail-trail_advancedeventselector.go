...
type Trail_AdvancedEventSelector[T any] struct {
	...
	FieldSelectors []Trail_AdvancedFieldSelector[any] `json:"FieldSelectors"`
...
func (r *Trail_AdvancedEventSelector[any]) AWSCloudFormationType() string {
