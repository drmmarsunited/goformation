...
type Contact[T any] struct {
	...
	Plan []Contact_Stage[any] `json:"Plan,omitempty"`
...
func (r *Contact[any]) AWSCloudFormationType() string {
	return "AWS::SSMContacts::Contact"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Contact[any]) MarshalJSON() ([]byte, error) {
	type Properties Contact[any]
...
func (r *Contact[any]) UnmarshalJSON(b []byte) error {
	type Properties Contact[any]
