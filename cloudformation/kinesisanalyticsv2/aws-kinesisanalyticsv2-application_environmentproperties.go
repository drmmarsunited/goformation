...
type Application_EnvironmentProperties[T any] struct {
	...
	PropertyGroups []Application_PropertyGroup[any] `json:"PropertyGroups,omitempty"`
...
func (r *Application_EnvironmentProperties[any]) AWSCloudFormationType() string {
