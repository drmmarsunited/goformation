...
type Application_SqlApplicationConfiguration[T any] struct {
	...
	Inputs []Application_Input[any] `json:"Inputs,omitempty"`
...
func (r *Application_SqlApplicationConfiguration[any]) AWSCloudFormationType() string {
