...
type WALWorkspace[T any] struct {
	...
	// WALWorkspaceName AWS CloudFormation Property
	// Required: false
	...
	WALWorkspaceName *T `json:"WALWorkspaceName,omitempty"`
...
func (r *WALWorkspace[any]) AWSCloudFormationType() string {
	return "AWS::EMR::WALWorkspace"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r WALWorkspace[any]) MarshalJSON() ([]byte, error) {
	type Properties WALWorkspace[any]
...
func (r *WALWorkspace[any]) UnmarshalJSON(b []byte) error {
	type Properties WALWorkspace[any]
	...
	if res.Properties != nil {
		*r = WALWorkspace[any](*res.Properties)
	}
