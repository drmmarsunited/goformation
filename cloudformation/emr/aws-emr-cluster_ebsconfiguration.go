...
type Cluster_EbsConfiguration[T any] struct {
	...
	EbsBlockDeviceConfigs []Cluster_EbsBlockDeviceConfig[any] `json:"EbsBlockDeviceConfigs,omitempty"`
...
func (r *Cluster_EbsConfiguration[any]) AWSCloudFormationType() string {
