...
type Step[T any] struct {
	...
	ActionOnFailure T `json:"ActionOnFailure"`
	...
	HadoopJarStep *Step_HadoopJarStepConfig[any] `json:"HadoopJarStep"`
...
func (r *Step[any]) AWSCloudFormationType() string {
	return "AWS::EMR::Step"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Step[any]) MarshalJSON() ([]byte, error) {
	type Properties Step[any]
...
func (r *Step[any]) UnmarshalJSON(b []byte) error {
	type Properties Step[any]
