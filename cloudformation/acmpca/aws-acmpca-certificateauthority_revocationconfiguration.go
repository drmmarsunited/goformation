...
type CertificateAuthority_RevocationConfiguration[T any] struct {
	...
	CrlConfiguration *CertificateAuthority_CrlConfiguration[any] `json:"CrlConfiguration,omitempty"`
	...
	OcspConfiguration *CertificateAuthority_OcspConfiguration[any] `json:"OcspConfiguration,omitempty"`
...
func (r *CertificateAuthority_RevocationConfiguration[any]) AWSCloudFormationType() string {
