...
type CertificateAuthority[T any] struct {
	...
	CsrExtensions *CertificateAuthority_CsrExtensions[any] `json:"CsrExtensions,omitempty"`
	...
	RevocationConfiguration *CertificateAuthority_RevocationConfiguration[any] `json:"RevocationConfiguration,omitempty"`
	...
	Subject *CertificateAuthority_Subject[any] `json:"Subject"`
...
func (r *CertificateAuthority[any]) AWSCloudFormationType() string {
	return "AWS::ACMPCA::CertificateAuthority"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r CertificateAuthority[any]) MarshalJSON() ([]byte, error) {
	type Properties CertificateAuthority[any]
...
func (r *CertificateAuthority[any]) UnmarshalJSON(b []byte) error {
	type Properties CertificateAuthority[any]
	...
	if res.Properties != nil {
		*r = CertificateAuthority[any](*res.Properties)
	}
