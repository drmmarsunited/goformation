...
type CertificateAuthority_CustomAttribute[T any] struct {
	...
	ObjectIdentifier T `json:"ObjectIdentifier"`
...
func (r *CertificateAuthority_CustomAttribute[any]) AWSCloudFormationType() string {
