...
type OutpostResolver[T any] struct {
...
func (r *OutpostResolver[any]) AWSCloudFormationType() string {
	return "AWS::Route53Resolver::OutpostResolver"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r OutpostResolver[any]) MarshalJSON() ([]byte, error) {
	type Properties OutpostResolver[any]
...
func (r *OutpostResolver[any]) UnmarshalJSON(b []byte) error {
	type Properties OutpostResolver[any]
	...
	if res.Properties != nil {
		*r = OutpostResolver[any](*res.Properties)
	}
