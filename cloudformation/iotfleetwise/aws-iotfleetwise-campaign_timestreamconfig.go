...
type Campaign_TimestreamConfig[T any] struct {
	...
	TimestreamTableArn T `json:"TimestreamTableArn"`
...
func (r *Campaign_TimestreamConfig[any]) AWSCloudFormationType() string {
