...
type Campaign_DataDestinationConfig[T any] struct {
	...
	S3Config *Campaign_S3Config[any] `json:"S3Config,omitempty"`
	...
	TimestreamConfig *Campaign_TimestreamConfig[any] `json:"TimestreamConfig,omitempty"`
...
func (r *Campaign_DataDestinationConfig[any]) AWSCloudFormationType() string {
