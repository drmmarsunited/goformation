...
type MetricStream_MetricStreamFilter[T any] struct {
	...
	MetricNames []T `json:"MetricNames,omitempty"`
...
func (r *MetricStream_MetricStreamFilter[any]) AWSCloudFormationType() string {
