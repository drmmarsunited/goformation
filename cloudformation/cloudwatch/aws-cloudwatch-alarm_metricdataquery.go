...
type Alarm_MetricDataQuery[T any] struct {
	...
	MetricStat *Alarm_MetricStat[any] `json:"MetricStat,omitempty"`
...
func (r *Alarm_MetricDataQuery[any]) AWSCloudFormationType() string {
