...
type GameSessionQueue_PlayerLatencyPolicy[T any] struct {
	...
	MaximumIndividualPlayerLatencyMilliseconds *T `json:"MaximumIndividualPlayerLatencyMilliseconds,omitempty"`
	...
	PolicyDurationSeconds *T `json:"PolicyDurationSeconds,omitempty"`
...
func (r *GameSessionQueue_PlayerLatencyPolicy[any]) AWSCloudFormationType() string {
