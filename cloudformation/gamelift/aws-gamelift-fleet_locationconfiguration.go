...
type Fleet_LocationConfiguration[T any] struct {
	...
	LocationCapacity *Fleet_LocationCapacity[any] `json:"LocationCapacity,omitempty"`
...
func (r *Fleet_LocationConfiguration[any]) AWSCloudFormationType() string {
