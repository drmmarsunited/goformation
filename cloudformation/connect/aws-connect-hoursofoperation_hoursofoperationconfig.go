...
type HoursOfOperation_HoursOfOperationConfig[T any] struct {
	...
	EndTime *HoursOfOperation_HoursOfOperationTimeSlice[any] `json:"EndTime"`
	...
	StartTime *HoursOfOperation_HoursOfOperationTimeSlice[any] `json:"StartTime"`
...
func (r *HoursOfOperation_HoursOfOperationConfig[any]) AWSCloudFormationType() string {
