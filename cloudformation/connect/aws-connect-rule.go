...
// Rule AWS CloudFormation Resource (AWS::Connect::Rule)
...
type Rule[T any] struct {
	...
	Actions *Rule_Actions[any] `json:"Actions"`
	...
	// PublishStatus AWS CloudFormation Property
	// Required: true
	...
	PublishStatus T `json:"PublishStatus"`
	...
	// TriggerEventSource AWS CloudFormation Property
	// Required: true
	...
	TriggerEventSource *Rule_RuleTriggerEventSource[any] `json:"TriggerEventSource"`
