...
// RoutingProfile_CrossChannelBehavior AWS CloudFormation Resource (AWS::Connect::RoutingProfile.CrossChannelBehavior)
...
type RoutingProfile_CrossChannelBehavior[T any] struct {
...
func (r *RoutingProfile_CrossChannelBehavior[any]) AWSCloudFormationType() string {
	return "AWS::Connect::RoutingProfile.CrossChannelBehavior"
}
