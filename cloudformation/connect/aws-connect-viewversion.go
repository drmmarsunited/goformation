...
func (r *ViewVersion[any]) AWSCloudFormationType() string {
	return "AWS::Connect::ViewVersion"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ViewVersion[any]) MarshalJSON() ([]byte, error) {
	type Properties ViewVersion[any]
...
func (r *ViewVersion[any]) UnmarshalJSON(b []byte) error {
	type Properties ViewVersion[any]
	...
	if res.Properties != nil {
		*r = ViewVersion[any](*res.Properties)
	}
