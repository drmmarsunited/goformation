...
// TrafficDistributionGroup AWS CloudFormation Resource (AWS::Connect::TrafficDistributionGroup)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-connect-trafficdistributiongroup.html
type TrafficDistributionGroup[T any] struct {
...
func (r *TrafficDistributionGroup[any]) AWSCloudFormationType() string {
	return "AWS::Connect::TrafficDistributionGroup"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r TrafficDistributionGroup[any]) MarshalJSON() ([]byte, error) {
	type Properties TrafficDistributionGroup[any]
...
func (r *TrafficDistributionGroup[any]) UnmarshalJSON(b []byte) error {
	type Properties TrafficDistributionGroup[any]
	...
	if res.Properties != nil {
		*r = TrafficDistributionGroup[any](*res.Properties)
	}
