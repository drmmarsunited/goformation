...
type Queue[T any] struct {
	...
	HoursOfOperationArn T `json:"HoursOfOperationArn"`
	...
	MaxContacts *T `json:"MaxContacts,omitempty"`
	...
	OutboundCallerConfig *Queue_OutboundCallerConfig[any] `json:"OutboundCallerConfig,omitempty"`
	...
	QuickConnectArns []T `json:"QuickConnectArns,omitempty"`
