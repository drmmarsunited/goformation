...
type RoutingProfile[T any] struct {
	...
	MediaConcurrencies []RoutingProfile_MediaConcurrency[any] `json:"MediaConcurrencies"`
	...
	QueueConfigs []RoutingProfile_RoutingProfileQueueConfig[any] `json:"QueueConfigs,omitempty"`
...
func (r *RoutingProfile[any]) AWSCloudFormationType() string {
	return "AWS::Connect::RoutingProfile"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r RoutingProfile[any]) MarshalJSON() ([]byte, error) {
	type Properties RoutingProfile[any]
...
func (r *RoutingProfile[any]) UnmarshalJSON(b []byte) error {
	type Properties RoutingProfile[any]
	...
	if res.Properties != nil {
		*r = RoutingProfile[any](*res.Properties)
	}
