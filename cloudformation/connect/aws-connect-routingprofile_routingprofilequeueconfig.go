...
type RoutingProfile_RoutingProfileQueueConfig[T any] struct {
	...
	QueueReference *RoutingProfile_RoutingProfileQueueReference[any] `json:"QueueReference"`
...
func (r *RoutingProfile_RoutingProfileQueueConfig[any]) AWSCloudFormationType() string {
