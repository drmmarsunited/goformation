...
type QuickConnect_QueueQuickConnectConfig[T any] struct {
	...
	ContactFlowArn T `json:"ContactFlowArn"`
...
func (r *QuickConnect_QueueQuickConnectConfig[any]) AWSCloudFormationType() string {
