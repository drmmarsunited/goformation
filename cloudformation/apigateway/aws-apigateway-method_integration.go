...
type Method_Integration[T any] struct {
	...
	CacheKeyParameters []T `json:"CacheKeyParameters,omitempty"`
	...
	CacheNamespace *T `json:"CacheNamespace,omitempty"`
	...
	ConnectionId *T `json:"ConnectionId,omitempty"`
	...
	ContentHandling *T `json:"ContentHandling,omitempty"`
	...
	IntegrationHttpMethod *T `json:"IntegrationHttpMethod,omitempty"`
	...
	PassthroughBehavior *T `json:"PassthroughBehavior,omitempty"`
	...
	RequestTemplates map[string]T `json:"RequestTemplates,omitempty"`
