...
type ClientCertificate[T any] struct {
...
func (r *ClientCertificate[any]) AWSCloudFormationType() string {
	return "AWS::ApiGateway::ClientCertificate"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ClientCertificate[any]) MarshalJSON() ([]byte, error) {
	type Properties ClientCertificate[any]
...
func (r *ClientCertificate[any]) UnmarshalJSON(b []byte) error {
	type Properties ClientCertificate[any]
	...
	if res.Properties != nil {
		*r = ClientCertificate[any](*res.Properties)
	}
