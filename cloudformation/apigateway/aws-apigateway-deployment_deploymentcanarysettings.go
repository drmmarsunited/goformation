...
type Deployment_DeploymentCanarySettings[T any] struct {
	...
	StageVariableOverrides map[string]T `json:"StageVariableOverrides,omitempty"`
...
func (r *Deployment_DeploymentCanarySettings[any]) AWSCloudFormationType() string {
