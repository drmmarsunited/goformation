...
type ReplicationConfig[T any] struct {
	...
	ComputeConfig *ReplicationConfig_ComputeConfig[any] `json:"ComputeConfig,omitempty"`
	...
	ReplicationConfigArn *T `json:"ReplicationConfigArn,omitempty"`
	...
	ReplicationConfigIdentifier *T `json:"ReplicationConfigIdentifier,omitempty"`
	...
	ReplicationType *T `json:"ReplicationType,omitempty"`
	...
	SourceEndpointArn *T `json:"SourceEndpointArn,omitempty"`
	...
	TargetEndpointArn *T `json:"TargetEndpointArn,omitempty"`
...
func (r *ReplicationConfig[any]) AWSCloudFormationType() string {
	return "AWS::DMS::ReplicationConfig"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ReplicationConfig[any]) MarshalJSON() ([]byte, error) {
	type Properties ReplicationConfig[any]
...
func (r *ReplicationConfig[any]) UnmarshalJSON(b []byte) error {
	type Properties ReplicationConfig[any]
	...
	if res.Properties != nil {
		*r = ReplicationConfig[any](*res.Properties)
	}
