...
type Table_IcebergInput[T any] struct {
	...
	MetadataOperation *Table_MetadataOperation[any] `json:"MetadataOperation,omitempty"`
...
func (r *Table_IcebergInput[any]) AWSCloudFormationType() string {
