...
type DevEndpoint[T any] struct {
	...
	ExtraJarsS3Path *T `json:"ExtraJarsS3Path,omitempty"`
	...
	ExtraPythonLibsS3Path *T `json:"ExtraPythonLibsS3Path,omitempty"`
	...
	PublicKey *T `json:"PublicKey,omitempty"`
	...
	PublicKeys []T `json:"PublicKeys,omitempty"`
