...
// DataQualityRuleset AWS CloudFormation Resource (AWS::Glue::DataQualityRuleset)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-glue-dataqualityruleset.html
type DataQualityRuleset[T any] struct {
	...
	Ruleset *T `json:"Ruleset,omitempty"`
	...
	TargetTable *DataQualityRuleset_DataQualityTargetTable[any] `json:"TargetTable,omitempty"`
...
func (r *DataQualityRuleset[any]) AWSCloudFormationType() string {
	return "AWS::Glue::DataQualityRuleset"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DataQualityRuleset[any]) MarshalJSON() ([]byte, error) {
	type Properties DataQualityRuleset[any]
...
func (r *DataQualityRuleset[any]) UnmarshalJSON(b []byte) error {
	type Properties DataQualityRuleset[any]
	...
	if res.Properties != nil {
		*r = DataQualityRuleset[any](*res.Properties)
	}
