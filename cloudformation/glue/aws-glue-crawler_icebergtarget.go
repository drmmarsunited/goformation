...
type Crawler_IcebergTarget[T any] struct {
	...
	MaximumTraversalDepth *T `json:"MaximumTraversalDepth,omitempty"`
...
func (r *Crawler_IcebergTarget[any]) AWSCloudFormationType() string {
