...
// WebACL_RateLimitCookie AWS CloudFormation Resource (AWS::WAFv2::WebACL.RateLimitCookie)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-webacl-ratelimitcookie.html
type WebACL_RateLimitCookie[T any] struct {
...
func (r *WebACL_RateLimitCookie[any]) AWSCloudFormationType() string {
	return "AWS::WAFv2::WebACL.RateLimitCookie"
}
