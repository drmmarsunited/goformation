...
// WebACL_RateLimitHeader AWS CloudFormation Resource (AWS::WAFv2::WebACL.RateLimitHeader)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-webacl-ratelimitheader.html
type WebACL_RateLimitHeader[T any] struct {
...
func (r *WebACL_RateLimitHeader[any]) AWSCloudFormationType() string {
	return "AWS::WAFv2::WebACL.RateLimitHeader"
}
