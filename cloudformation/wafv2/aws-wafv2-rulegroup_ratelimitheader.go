...
// RuleGroup_RateLimitHeader AWS CloudFormation Resource (AWS::WAFv2::RuleGroup.RateLimitHeader)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-ratelimitheader.html
type RuleGroup_RateLimitHeader[T any] struct {
...
func (r *RuleGroup_RateLimitHeader[any]) AWSCloudFormationType() string {
	return "AWS::WAFv2::RuleGroup.RateLimitHeader"
}
