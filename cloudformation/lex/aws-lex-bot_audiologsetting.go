...
type Bot_AudioLogSetting[T any] struct {
	...
	Destination *Bot_AudioLogDestination[any] `json:"Destination"`
...
func (r *Bot_AudioLogSetting[any]) AWSCloudFormationType() string {
