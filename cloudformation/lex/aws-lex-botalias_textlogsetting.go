...
type BotAlias_TextLogSetting[T any] struct {
	...
	Destination *BotAlias_TextLogDestination[any] `json:"Destination"`
...
func (r *BotAlias_TextLogSetting[any]) AWSCloudFormationType() string {
