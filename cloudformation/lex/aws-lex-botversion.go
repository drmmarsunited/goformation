...
type BotVersion[T any] struct {
	...
	BotVersionLocaleSpecification []BotVersion_BotVersionLocaleSpecification[any] `json:"BotVersionLocaleSpecification"`
...
func (r *BotVersion[any]) AWSCloudFormationType() string {
	return "AWS::Lex::BotVersion"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r BotVersion[any]) MarshalJSON() ([]byte, error) {
	type Properties BotVersion[any]
...
func (r *BotVersion[any]) UnmarshalJSON(b []byte) error {
	type Properties BotVersion[any]
	...
	if res.Properties != nil {
		*r = BotVersion[any](*res.Properties)
	}
