...
type Bot_FulfillmentStartResponseSpecification[T any] struct {
	...
	DelayInSeconds T `json:"DelayInSeconds"`
...
func (r *Bot_FulfillmentStartResponseSpecification[any]) AWSCloudFormationType() string {
