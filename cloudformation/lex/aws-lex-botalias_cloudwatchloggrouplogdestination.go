...
type BotAlias_CloudWatchLogGroupLogDestination[T any] struct {
	...
	CloudWatchLogGroupArn T `json:"CloudWatchLogGroupArn"`
...
func (r *BotAlias_CloudWatchLogGroupLogDestination[any]) AWSCloudFormationType() string {
