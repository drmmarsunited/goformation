...
type VirtualCluster[T any] struct {
	...
	ContainerProvider *VirtualCluster_ContainerProvider[any] `json:"ContainerProvider"`
...
func (r *VirtualCluster[any]) AWSCloudFormationType() string {
	return "AWS::EMRContainers::VirtualCluster"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r VirtualCluster[any]) MarshalJSON() ([]byte, error) {
	type Properties VirtualCluster[any]
...
func (r *VirtualCluster[any]) UnmarshalJSON(b []byte) error {
	type Properties VirtualCluster[any]
	...
	if res.Properties != nil {
		*r = VirtualCluster[any](*res.Properties)
	}
